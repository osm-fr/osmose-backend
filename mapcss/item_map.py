...
{'Rules_Brazilian-Specific': {'class': {'Brasil - Correções e melhorias': 9018006,
 ...
 'Seamark': {'class': {'In {0} {1}={2} require {3}={4}': 9012009,
             ...
             'prefix': 'Josm_',
             'tags': ['tag', 'seamark']},
 'SuspiciousSwimming_Pool': {'class': {'If this is a facility containing one or more swimming pools it should be tagged leisure=sports_centre + sport=swimming.': 30811},
                             'item': 3081,
                             'prefix': 'Josm_',
                             'tags': ['tag']},
