...
{'Rules_Brazilian-Specific': {'class': {'Brasil - Correções e melhorias': 9018006,
 ...
 'transport': {'class': {'Jungle : Est-ce un arrêt de bus ? (ajouter le tag highway=bus_stop)': 9014005,
                         ...
                         "Jungle : L'opérateur est manquant (ajouter un tag operator)": 9014016,
                         "Jungle : L'origine/destination est manquante (ajouter les tags from/to)": 9014018,
                         ...
                         'Jungle : Le numéro de ligne est manquant (ajouter un tag ref)': 9014017,
                         'Jungle : Le réseau devrait être porté par les lignes de transport et non par les arrêts': 9014007,
                         'Jungle : Le réseau est manquant (ajouter un tag network)': 9014015,
