...
{'FranceSpecificRules': {'class': {None: 0,
                                   'Missing tag operator with nat_ref': 8,
                                   'deprecated tagging': 1,
                                   'missing tag': 3,
                                   'validation rules nat_ref in France': 10,
                                   'validation rules nat_ref in france': 9,
                                   '{0} is invalid': 2,
                                   '{1} is not a valid reference': 6,
                                   '{1} is not a valid reference (Paris)': 7,
                                   '{1} is not a valid reference RIU': 4,
                                   '{1} must be a link road': 5},
                         'item': 9019,
                         'prefix': 'Josm_',
                         'tags': [],
