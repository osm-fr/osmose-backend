...
no_county('troms_og_finnmark', 10155507, 'NO-54')
no_county('troendelag', 406567, 'NO-23')
no_county('moere_og_romsdal', 406868, 'NO-15')
no_county('vestland', 10155543, 'NO-46')
no_county('rogaland', 405836, 'NO-11')
no_county('agder', 10155517, 'NO-42')
no_county('oslo', 406091, 'NO-03')
no_county('vestfold_og_telemark', 10487008, 'NO-38')
no_county('viken', 10155539, 'NO-30')
no_county('innlandet', 10155527, 'NO-34')
