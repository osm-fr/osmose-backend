...
france_departement = gen_country('europe', 'france', download_repo=OSMFR, language='fr', proj=2154, municipality_ref='ref:INSEE', phone_code='33', phone_len=9, phone_format=r'([+]%s ?([0-9] ?){9})|[0-9]{4}|[0-9]{6}', phone_international='00', include=[
...
france_departement_dom = gen_country('europe', 'france', language='fr', municipality_ref='ref:INSEE', phone_len=9, phone_format=r'([+]%s ?([0-9] ?){9})|[0-9]{4}|[0-9]{6}', phone_international='00', include=[
    'osmosis_building_geodesie_FR',
    'osmosis_natural_swimming-pool',
    'osmosis_fantoir',
    'osmosis_highway_motorway',
...
france_com = gen_country(None, country_base='france', download_repo=OSMFR, language='fr', municipality_ref='ref:INSEE', phone_len=6, phone_format=r'[+]%s ?([0-9] ?){6}', phone_international='00', include=[
    'merge_college_FR',
    'merge_service_public_FR',
    'merge_pitch_FR',
    'merge_police_FR_gn',
...
france_com(["australia-oceania", "new-caledonia"], 3407643, "NC", download_repo=GEOFABRIK, proj=3163, phone_code="687", phone_len=6, phone_format=r"[+]%s ?([0-9] ?){6}", phone_international='00', country="nouvellecaledonie")
