...
class Public_transport_route(Plugin):
    ...
    def init(self, logger):
        ...
        self.errors[9] = {"item": 8042, "level": 3, "tag": ["tag", "public_transport"], "desc": T_(
    ...
    def relation(self, data, tags, members):
        err = []
        if _is_public_transport_route(tags[u"type"], tags[u"route"]) and u"public_transport:version" not in tags:
            err.append({"class": 9, "subclass": 0})
        return err
