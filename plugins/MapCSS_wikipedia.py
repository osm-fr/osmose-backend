...
class MapCSS_wikipedia(Plugin):

    def init(self, logger):
        Plugin.init(self, logger)
        tags = capture_tags = {}
        self.errors[9011001] = {'item': 9011, 'level': 1, 'tag': [], 'desc': mapcss.tr(capture_tags, u'wikipedia tag has no language given, use \'\'wikipedia\'\'=\'\'language:page title\'\'')}
        self.errors[9011002] = {'item': 9011, 'level': 2, 'tag': [], 'desc': mapcss.tr(capture_tags, u'wikipedia tag has an unknown language prefix')}
        self.errors[9011003] = {'item': 9011, 'level': 2, 'tag': [], 'desc': mapcss.tr(capture_tags, u'deprecated tagging')}
        self.errors[9011004] = {'item': 9011, 'level': 2, 'tag': [], 'desc': mapcss.tr(capture_tags, u'wikipedia \'\'{0}\'\' language is obsolete, use \'\'{1}\'\' instead', u'be-x-old', u'be-tarask')}
        self.errors[9011005] = {'item': 9011, 'level': 2, 'tag': [], 'desc': mapcss.tr(capture_tags, u'wikipedia \'\'{0}\'\' language is invalid, use \'\'{1}\'\' instead', u'cz', u'cs')}
        self.errors[9011006] = {'item': 9011, 'level': 1, 'tag': [], 'desc': mapcss.tr(capture_tags, u'{0} tag should not have URL-encoded values like \'\'%27\'\'', u'{0.tag}')}
        self.errors[9011007] = {'item': 9011, 'level': 2, 'tag': [], 'desc': mapcss.tr(capture_tags, u'wikipedia title should not start with a space after language code')}
        self.errors[9011008] = {'item': 9011, 'level': 2, 'tag': [], 'desc': mapcss.tr(capture_tags, u'wikipedia title should not have \'\'{0}\'\' prefix', u'wiki/')}
        self.errors[9011009] = {'item': 9011, 'level': 2, 'tag': [], 'desc': mapcss.tr(capture_tags, u'wikipedia page title should have first letter capitalized')}
        self.errors[9011010] = {'item': 9011, 'level': 2, 'tag': [], 'desc': mapcss.tr(capture_tags, u'wikipedia page title should have spaces instead of underscores (\'\'_\'\'→\'\' \'\')')}
        self.errors[9011011] = {'item': 9011, 'level': 2, 'tag': [], 'desc': mapcss.tr(capture_tags, u'wikipedia language seems to be duplicated, e.g. en:en:Foo')}
        self.errors[9011012] = {'item': 9011, 'level': 1, 'tag': [], 'desc': mapcss.tr(capture_tags, u'wikidata tag must be in Qnnnn format, where n is a digit')}
        self.errors[9011013] = {'item': 9011, 'level': 3, 'tag': [], 'desc': mapcss.tr(capture_tags, u'missing tag')}
        self.errors[9011014] = {'item': 9011, 'level': 2, 'tag': [], 'desc': mapcss.tr(capture_tags, u'wikipedia tag is not set, but a \'\'{0}\'\' tag is. Make sure to use wikipedia=language:value together with wikidata tag.', u'{1.key}')}
    ...
    def node(self, data, tags, *args):
        ...
        if (u'wikipedia' in keys) and \
            ...
            err.append({'class': 9011003, 'subclass': 75691825, 'text': mapcss.tr(capture_tags, u'wikipedia tag format is deprecated')})
        ...
        if (u'wikipedia' in keys) and \
            ...
            err.append({'class': 9011011, 'subclass': 124114060, 'text': mapcss.tr(capture_tags, u'wikipedia language seems to be duplicated, e.g. en:en:Foo'), 'fix': {
                '+': dict([
        ...
        if (u'wikipedia' in keys) and \
            ...
            err.append({'class': 9011013, 'subclass': 52215017, 'text': mapcss.tr(capture_tags, u'wikipedia tag is set, but there is no wikidata tag. Wikipedia plugin might help with wikidata id lookups')})
        ...
        if ((not mapcss._tag_capture(capture_tags, 0, tags, u'wikipedia') and mapcss._tag_capture(capture_tags, 1, tags, self.re_79319bf9))):
            ...
            err.append({'class': 9011014, 'subclass': 153018468, 'text': mapcss.tr(capture_tags, u'wikipedia tag is not set, but a \'\'{0}\'\' tag is. Make sure to use wikipedia=language:value together with wikidata tag.', u'{1.key}')})
