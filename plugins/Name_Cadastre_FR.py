...
class Name_Cadastre_FR(Plugin):
    ...
    def init(self, logger):
        ...
        tags = capture_tags = {}
        self.errors[50801] = {'item': 5080, 'level': 1, 'tag': mapcss.list_(u'name'), 'desc': mapcss.tr(u'Hamlet or Locality name suffix Nord, Sud, Est, Ouest, Centre should be removed from Cadastre name. Place should be integrated only once.', capture_tags)}
