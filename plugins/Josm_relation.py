...
class Test(TestPluginCommon):
    def test(self):
        ...
        self.check_not_err(n.relation(data, {'name': 'Foo', 'type': 'route'}, []), expected={'class': 9007002, 'subclass': 1457279320}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.relation(data, {'boundary': 'administrative', 'type': 'boundary'}, []), expected={'class': 9007001, 'subclass': 93004660}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.relation(data, {'type': 'boundary'}, []), expected={'class': 9007001, 'subclass': 93004660}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.relation(data, {'enforcement': 'maxspeed', 'type': 'enforcement'}, []), expected={'class': 9007001, 'subclass': 93004660}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.relation(data, {'type': 'enforcement'}, []), expected={'class': 9007001, 'subclass': 93004660}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.relation(data, {'public_transport': 'stop_area', 'type': 'public_transport'}, []), expected={'class': 9007001, 'subclass': 93004660}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.relation(data, {'type': 'public_transport'}, []), expected={'class': 9007001, 'subclass': 93004660}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.relation(data, {'route': 'train', 'type': 'route'}, []), expected={'class': 9007001, 'subclass': 93004660}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.relation(data, {'type': 'route'}, []), expected={'class': 9007001, 'subclass': 93004660}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.relation(data, {'route_master': 'train', 'type': 'route_master'}, []), expected={'class': 9007001, 'subclass': 93004660}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.relation(data, {'type': 'route_master'}, []), expected={'class': 9007001, 'subclass': 93004660}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.relation(data, {'site': 'administrative', 'type': 'site'}, []), expected={'class': 9007001, 'subclass': 93004660}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.relation(data, {'type': 'waterway', 'waterway': 'river'}, []), expected={'class': 9007001, 'subclass': 93004660}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.relation(data, {'type': 'waterway'}, []), expected={'class': 9007001, 'subclass': 93004660}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.relation(data, {'restriction:hgv': 'no_left_turn', 'type': 'restriction'}, []), expected={'class': 9007001, 'subclass': 1097316614}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.relation(data, {'restriction': 'no_left_turn', 'type': 'restriction'}, []), expected={'class': 9007001, 'subclass': 1097316614}, disallowed_str_in_text = ['{', '}'])
