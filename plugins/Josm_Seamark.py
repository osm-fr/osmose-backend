...
class Josm_Seamark(PluginMapCSS):
    ...
    def init(self, logger):
        ...
        self.errors[9012004] = self.def_class(item = 9012, level = 3, tags = ["tag", "seamark"], title = mapcss.tr(u'Probably wrong category on {0}, {1} colour mean {2} in {3}', mapcss._tag_uncapture(capture_tags, u'{0.value}'), mapcss._tag_uncapture(capture_tags, u'{2.value}'), mapcss._tag_uncapture(capture_tags, u'{3.value}'), mapcss._tag_uncapture(capture_tags, u'{1.value}')))
        self.errors[9012005] = self.def_class(item = 9012, level = 3, tags = ["tag", "seamark"], title = mapcss.tr(u'Probably wrong category on {0}, the colour combination {1} usually mean {2}', mapcss._tag_uncapture(capture_tags, u'{0.value}'), mapcss._tag_uncapture(capture_tags, u'{1.value}'), mapcss._tag_uncapture(capture_tags, u'{2.value}')))
        self.errors[9012006] = self.def_class(item = 9012, level = 3, tags = ["tag", "seamark"], title = mapcss.tr(u'{0} have no {1}', mapcss._tag_uncapture(capture_tags, u'{0.value}'), mapcss._tag_uncapture(capture_tags, u'{1.key}')))
        self.errors[9012007] = self.def_class(item = 9012, level = 3, tags = ["tag", "seamark"], title = mapcss.tr(u'{0} set without {1}={2}', mapcss._tag_uncapture(capture_tags, u'{0.key}'), mapcss._tag_uncapture(capture_tags, u'{1.key}'), mapcss._tag_uncapture(capture_tags, u'{1.value}')))
        self.errors[9012008] = self.def_class(item = 9012, level = 3, tags = ["tag", "seamark"], title = mapcss.tr(u'{0} without {1}', mapcss._tag_uncapture(capture_tags, u'{0.key}'), mapcss._tag_uncapture(capture_tags, u'{1.key}')))
        self.errors[9012009] = self.def_class(item = 9012, level = 3, tags = ["tag", "seamark"], title = mapcss.tr(u'In {0} {1}={2} require {3}={4}', mapcss._tag_uncapture(capture_tags, u'{0.value}'), mapcss._tag_uncapture(capture_tags, u'{2.key}'), mapcss._tag_uncapture(capture_tags, u'{2.value}'), mapcss._tag_uncapture(capture_tags, u'{1.key}'), mapcss._tag_uncapture(capture_tags, u'{1.value}')))
        self.errors[9012010] = self.def_class(item = 9012, level = 3, tags = ["tag", "seamark"], title = mapcss.tr(u'{0} sign require {1} set to left or right', mapcss._tag_uncapture(capture_tags, u'{0.value}'), mapcss._tag_uncapture(capture_tags, u'{1.key}')))
    ...
    def node(self, data, tags):
        ...
        if (u'seamark:beacon_cardinal:colour_pattern' in keys) or (u'seamark:beacon_isolated_danger:colour_pattern' in keys) or (u'seamark:beacon_lateral:colour_pattern' in keys) or (u'seamark:beacon_safe_water:colour_pattern' in keys) or (u'seamark:beacon_special_purpose:colour_pattern' in keys) or (u'seamark:bridge:colour_pattern' in keys) or (u'seamark:building:colour_pattern' in keys) or (u'seamark:buoy_cardinal:colour_pattern' in keys) or (u'seamark:buoy_installation:colour_pattern' in keys) or (u'seamark:buoy_isolated_danger:colour_pattern' in keys) or (u'seamark:buoy_lateral:colour_pattern' in keys) or (u'seamark:buoy_safe_water:colour_pattern' in keys) or (u'seamark:buoy_special_purpose:colour_pattern' in keys) or (u'seamark:daymark:colour_pattern' in keys) or (u'seamark:landmark:colour_pattern' in keys) or (u'seamark:light_float:colour_pattern' in keys) or (u'seamark:light_vessel:colour_pattern' in keys) or (u'seamark:mooring:colour_pattern' in keys) or (u'seamark:notice:colour_pattern' in keys) or (u'seamark:pile:colour_pattern' in keys) or (u'seamark:platform:colour_pattern' in keys) or (u'seamark:topmark:colour_pattern' in keys):
            ...
            if not match:
                capture_tags = {}
                try: match = (mapcss._tag_capture(capture_tags, 0, tags, u'seamark:buoy_lateral:colour_pattern') and not mapcss.regexp_test(mapcss._value_const_capture(capture_tags, 1, self.re_141d4d2f, u'horizontal|vertical|diagonal|squared|stripes|border|cross|saltire'), mapcss._tag_capture(capture_tags, 1, tags, u'seamark:buoy_lateral:colour_pattern')))
                except mapcss.RuleAbort: pass
            if not match:
                capture_tags = {}
                try: match = (mapcss._tag_capture(capture_tags, 0, tags, u'seamark:beacon_lateral:colour_pattern') and not mapcss.regexp_test(mapcss._value_const_capture(capture_tags, 1, self.re_141d4d2f, u'horizontal|vertical|diagonal|squared|stripes|border|cross|saltire'), mapcss._tag_capture(capture_tags, 1, tags, u'seamark:beacon_lateral:colour_pattern')))
                except mapcss.RuleAbort: pass
            if not match:
                capture_tags = {}
                try: match = (mapcss._tag_capture(capture_tags, 0, tags, u'seamark:buoy_cardinal:colour_pattern') and not mapcss.regexp_test(mapcss._value_const_capture(capture_tags, 1, self.re_141d4d2f, u'horizontal|vertical|diagonal|squared|stripes|border|cross|saltire'), mapcss._tag_capture(capture_tags, 1, tags, u'seamark:buoy_cardinal:colour_pattern')))
                except mapcss.RuleAbort: pass
            if not match:
                capture_tags = {}
                try: match = (mapcss._tag_capture(capture_tags, 0, tags, u'seamark:beacon_cardinal:colour_pattern') and not mapcss.regexp_test(mapcss._value_const_capture(capture_tags, 1, self.re_141d4d2f, u'horizontal|vertical|diagonal|squared|stripes|border|cross|saltire'), mapcss._tag_capture(capture_tags, 1, tags, u'seamark:beacon_cardinal:colour_pattern')))
                except mapcss.RuleAbort: pass
            if not match:
                capture_tags = {}
                try: match = (mapcss._tag_capture(capture_tags, 0, tags, u'seamark:buoy_isolated_danger:colour_pattern') and not mapcss.regexp_test(mapcss._value_const_capture(capture_tags, 1, self.re_141d4d2f, u'horizontal|vertical|diagonal|squared|stripes|border|cross|saltire'), mapcss._tag_capture(capture_tags, 1, tags, u'seamark:buoy_isolated_danger:colour_pattern')))
                except mapcss.RuleAbort: pass
            if not match:
                capture_tags = {}
                try: match = (mapcss._tag_capture(capture_tags, 0, tags, u'seamark:beacon_isolated_danger:colour_pattern') and not mapcss.regexp_test(mapcss._value_const_capture(capture_tags, 1, self.re_141d4d2f, u'horizontal|vertical|diagonal|squared|stripes|border|cross|saltire'), mapcss._tag_capture(capture_tags, 1, tags, u'seamark:beacon_isolated_danger:colour_pattern')))
                except mapcss.RuleAbort: pass
            if not match:
                capture_tags = {}
                try: match = (mapcss._tag_capture(capture_tags, 0, tags, u'seamark:buoy_installation:colour_pattern') and not mapcss.regexp_test(mapcss._value_const_capture(capture_tags, 1, self.re_141d4d2f, u'horizontal|vertical|diagonal|squared|stripes|border|cross|saltire'), mapcss._tag_capture(capture_tags, 1, tags, u'seamark:buoy_installation:colour_pattern')))
                except mapcss.RuleAbort: pass
            if not match:
                capture_tags = {}
                try: match = (mapcss._tag_capture(capture_tags, 0, tags, u'seamark:buoy_safe_water:colour_pattern') and not mapcss.regexp_test(mapcss._value_const_capture(capture_tags, 1, self.re_141d4d2f, u'horizontal|vertical|diagonal|squared|stripes|border|cross|saltire'), mapcss._tag_capture(capture_tags, 1, tags, u'seamark:buoy_safe_water:colour_pattern')))
                except mapcss.RuleAbort: pass
            if not match:
                capture_tags = {}
                try: match = (mapcss._tag_capture(capture_tags, 0, tags, u'seamark:beacon_safe_water:colour_pattern') and not mapcss.regexp_test(mapcss._value_const_capture(capture_tags, 1, self.re_141d4d2f, u'horizontal|vertical|diagonal|squared|stripes|border|cross|saltire'), mapcss._tag_capture(capture_tags, 1, tags, u'seamark:beacon_safe_water:colour_pattern')))
                except mapcss.RuleAbort: pass
            if not match:
                capture_tags = {}
                try: match = (mapcss._tag_capture(capture_tags, 0, tags, u'seamark:buoy_special_purpose:colour_pattern') and not mapcss.regexp_test(mapcss._value_const_capture(capture_tags, 1, self.re_141d4d2f, u'horizontal|vertical|diagonal|squared|stripes|border|cross|saltire'), mapcss._tag_capture(capture_tags, 1, tags, u'seamark:buoy_special_purpose:colour_pattern')))
                except mapcss.RuleAbort: pass
            if not match:
                capture_tags = {}
                try: match = (mapcss._tag_capture(capture_tags, 0, tags, u'seamark:beacon_special_purpose:colour_pattern') and not mapcss.regexp_test(mapcss._value_const_capture(capture_tags, 1, self.re_141d4d2f, u'horizontal|vertical|diagonal|squared|stripes|border|cross|saltire'), mapcss._tag_capture(capture_tags, 1, tags, u'seamark:beacon_special_purpose:colour_pattern')))
                except mapcss.RuleAbort: pass
            if not match:
                capture_tags = {}
                try: match = (mapcss._tag_capture(capture_tags, 0, tags, u'seamark:topmark:colour_pattern') and not mapcss.regexp_test(mapcss._value_const_capture(capture_tags, 1, self.re_141d4d2f, u'horizontal|vertical|diagonal|squared|stripes|border|cross|saltire'), mapcss._tag_capture(capture_tags, 1, tags, u'seamark:topmark:colour_pattern')))
                except mapcss.RuleAbort: pass
            if not match:
                capture_tags = {}
                try: match = (mapcss._tag_capture(capture_tags, 0, tags, u'seamark:daymark:colour_pattern') and not mapcss.regexp_test(mapcss._value_const_capture(capture_tags, 1, self.re_141d4d2f, u'horizontal|vertical|diagonal|squared|stripes|border|cross|saltire'), mapcss._tag_capture(capture_tags, 1, tags, u'seamark:daymark:colour_pattern')))
                except mapcss.RuleAbort: pass
            if not match:
                capture_tags = {}
                try: match = (mapcss._tag_capture(capture_tags, 0, tags, u'seamark:bridge:colour_pattern') and not mapcss.regexp_test(mapcss._value_const_capture(capture_tags, 1, self.re_141d4d2f, u'horizontal|vertical|diagonal|squared|stripes|border|cross|saltire'), mapcss._tag_capture(capture_tags, 1, tags, u'seamark:bridge:colour_pattern')))
                except mapcss.RuleAbort: pass
            if not match:
                capture_tags = {}
                try: match = (mapcss._tag_capture(capture_tags, 0, tags, u'seamark:building:colour_pattern') and not mapcss.regexp_test(mapcss._value_const_capture(capture_tags, 1, self.re_141d4d2f, u'horizontal|vertical|diagonal|squared|stripes|border|cross|saltire'), mapcss._tag_capture(capture_tags, 1, tags, u'seamark:building:colour_pattern')))
                except mapcss.RuleAbort: pass
            if not match:
                capture_tags = {}
                try: match = (mapcss._tag_capture(capture_tags, 0, tags, u'seamark:landmark:colour_pattern') and not mapcss.regexp_test(mapcss._value_const_capture(capture_tags, 1, self.re_141d4d2f, u'horizontal|vertical|diagonal|squared|stripes|border|cross|saltire'), mapcss._tag_capture(capture_tags, 1, tags, u'seamark:landmark:colour_pattern')))
                except mapcss.RuleAbort: pass
            if not match:
                capture_tags = {}
                try: match = (mapcss._tag_capture(capture_tags, 0, tags, u'seamark:light_float:colour_pattern') and not mapcss.regexp_test(mapcss._value_const_capture(capture_tags, 1, self.re_141d4d2f, u'horizontal|vertical|diagonal|squared|stripes|border|cross|saltire'), mapcss._tag_capture(capture_tags, 1, tags, u'seamark:light_float:colour_pattern')))
                except mapcss.RuleAbort: pass
            if not match:
                capture_tags = {}
                try: match = (mapcss._tag_capture(capture_tags, 0, tags, u'seamark:light_vessel:colour_pattern') and not mapcss.regexp_test(mapcss._value_const_capture(capture_tags, 1, self.re_141d4d2f, u'horizontal|vertical|diagonal|squared|stripes|border|cross|saltire'), mapcss._tag_capture(capture_tags, 1, tags, u'seamark:light_vessel:colour_pattern')))
                except mapcss.RuleAbort: pass
            if not match:
                capture_tags = {}
                try: match = (mapcss._tag_capture(capture_tags, 0, tags, u'seamark:notice:colour_pattern') and not mapcss.regexp_test(mapcss._value_const_capture(capture_tags, 1, self.re_141d4d2f, u'horizontal|vertical|diagonal|squared|stripes|border|cross|saltire'), mapcss._tag_capture(capture_tags, 1, tags, u'seamark:notice:colour_pattern')))
                except mapcss.RuleAbort: pass
            if not match:
                capture_tags = {}
                try: match = (mapcss._tag_capture(capture_tags, 0, tags, u'seamark:pile:colour_pattern') and not mapcss.regexp_test(mapcss._value_const_capture(capture_tags, 1, self.re_141d4d2f, u'horizontal|vertical|diagonal|squared|stripes|border|cross|saltire'), mapcss._tag_capture(capture_tags, 1, tags, u'seamark:pile:colour_pattern')))
                except mapcss.RuleAbort: pass
            if not match:
                capture_tags = {}
                try: match = (mapcss._tag_capture(capture_tags, 0, tags, u'seamark:platform:colour_pattern') and not mapcss.regexp_test(mapcss._value_const_capture(capture_tags, 1, self.re_141d4d2f, u'horizontal|vertical|diagonal|squared|stripes|border|cross|saltire'), mapcss._tag_capture(capture_tags, 1, tags, u'seamark:platform:colour_pattern')))
                except mapcss.RuleAbort: pass
            if not match:
                capture_tags = {}
                try: match = (mapcss._tag_capture(capture_tags, 0, tags, u'seamark:mooring:colour_pattern') and not mapcss.regexp_test(mapcss._value_const_capture(capture_tags, 1, self.re_141d4d2f, u'horizontal|vertical|diagonal|squared|stripes|border|cross|saltire'), mapcss._tag_capture(capture_tags, 1, tags, u'seamark:mooring:colour_pattern')))
                except mapcss.RuleAbort: pass
            if match:
        ...
        if (u'seamark:beacon_lateral:colour' in keys and u'seamark:beacon_lateral:system' in keys and u'seamark:topmark:colour' in keys and u'seamark:type' in keys) or (u'seamark:beacon_lateral:colour' in keys and u'seamark:beacon_lateral:system' in keys and u'seamark:type' in keys) or (u'seamark:beacon_lateral:system' in keys and u'seamark:buoy_lateral:colour' in keys and u'seamark:type' in keys) or (u'seamark:buoy_lateral:colour' in keys and u'seamark:buoy_lateral:system' in keys and u'seamark:topmark:colour' in keys and u'seamark:type' in keys) or (u'seamark:buoy_lateral:colour' in keys and u'seamark:buoy_lateral:system' in keys and u'seamark:type' in keys):
            match = False
            if not match:
                capture_tags = {}
                try: match = (mapcss._tag_capture(capture_tags, 0, tags, u'seamark:type') == mapcss._value_capture(capture_tags, 0, u'buoy_lateral') and mapcss._tag_capture(capture_tags, 1, tags, u'seamark:buoy_lateral:system') == mapcss._value_capture(capture_tags, 1, u'iala-a') and mapcss._tag_capture(capture_tags, 2, tags, u'seamark:buoy_lateral:colour') == mapcss._value_capture(capture_tags, 2, u'red') and mapcss._tag_capture(capture_tags, 3, tags, u'seamark:buoy_lateral:category') != mapcss._value_const_capture(capture_tags, 3, u'port', u'port'))
                except mapcss.RuleAbort: pass
            if not match:
                capture_tags = {}
                try: match = (mapcss._tag_capture(capture_tags, 0, tags, u'seamark:type') == mapcss._value_capture(capture_tags, 0, u'beacon_lateral') and mapcss._tag_capture(capture_tags, 1, tags, u'seamark:beacon_lateral:system') == mapcss._value_capture(capture_tags, 1, u'iala-a') and mapcss._tag_capture(capture_tags, 2, tags, u'seamark:beacon_lateral:colour') == mapcss._value_capture(capture_tags, 2, u'red') and mapcss._tag_capture(capture_tags, 3, tags, u'seamark:beacon_lateral:category') != mapcss._value_const_capture(capture_tags, 3, u'port', u'port'))
                except mapcss.RuleAbort: pass
            if not match:
                capture_tags = {}
                try: match = (mapcss._tag_capture(capture_tags, 0, tags, u'seamark:type') == mapcss._value_capture(capture_tags, 0, u'buoy_lateral') and mapcss._tag_capture(capture_tags, 1, tags, u'seamark:buoy_lateral:system') == mapcss._value_capture(capture_tags, 1, u'iala-a') and mapcss._tag_capture(capture_tags, 2, tags, u'seamark:buoy_lateral:colour') == mapcss._value_capture(capture_tags, 2, u'green') and mapcss._tag_capture(capture_tags, 3, tags, u'seamark:buoy_lateral:category') != mapcss._value_const_capture(capture_tags, 3, u'starboard', u'starboard'))
                except mapcss.RuleAbort: pass
            if not match:
                capture_tags = {}
                try: match = (mapcss._tag_capture(capture_tags, 0, tags, u'seamark:type') == mapcss._value_capture(capture_tags, 0, u'beacon_lateral') and mapcss._tag_capture(capture_tags, 1, tags, u'seamark:beacon_lateral:system') == mapcss._value_capture(capture_tags, 1, u'iala-a') and mapcss._tag_capture(capture_tags, 2, tags, u'seamark:buoy_lateral:colour') == mapcss._value_capture(capture_tags, 2, u'green') and mapcss._tag_capture(capture_tags, 3, tags, u'seamark:beacon_lateral:category') != mapcss._value_const_capture(capture_tags, 3, u'starboard', u'starboard'))
                except mapcss.RuleAbort: pass
            if not match:
                capture_tags = {}
                try: match = (mapcss._tag_capture(capture_tags, 0, tags, u'seamark:type') == mapcss._value_capture(capture_tags, 0, u'buoy_lateral') and mapcss._tag_capture(capture_tags, 1, tags, u'seamark:buoy_lateral:system') == mapcss._value_capture(capture_tags, 1, u'iala-a') and mapcss._tag_capture(capture_tags, 2, tags, u'seamark:buoy_lateral:colour') == mapcss._value_capture(capture_tags, 2, u'green;red;green') and mapcss._tag_capture(capture_tags, 3, tags, u'seamark:buoy_lateral:category') != mapcss._value_const_capture(capture_tags, 3, u'preferred_channel_port', u'preferred_channel_port'))
                except mapcss.RuleAbort: pass
            if not match:
                capture_tags = {}
                try: match = (mapcss._tag_capture(capture_tags, 0, tags, u'seamark:type') == mapcss._value_capture(capture_tags, 0, u'beacon_lateral') and mapcss._tag_capture(capture_tags, 1, tags, u'seamark:beacon_lateral:system') == mapcss._value_capture(capture_tags, 1, u'iala-a') and mapcss._tag_capture(capture_tags, 2, tags, u'seamark:beacon_lateral:colour') == mapcss._value_capture(capture_tags, 2, u'green;red;green') and mapcss._tag_capture(capture_tags, 3, tags, u'seamark:beacon_lateral:category') != mapcss._value_const_capture(capture_tags, 3, u'preferred_channel_port', u'preferred_channel_port'))
                except mapcss.RuleAbort: pass
            if not match:
                capture_tags = {}
                try: match = (mapcss._tag_capture(capture_tags, 0, tags, u'seamark:type') == mapcss._value_capture(capture_tags, 0, u'buoy_lateral') and mapcss._tag_capture(capture_tags, 1, tags, u'seamark:buoy_lateral:system') == mapcss._value_capture(capture_tags, 1, u'iala-b') and mapcss._tag_capture(capture_tags, 2, tags, u'seamark:buoy_lateral:colour') == mapcss._value_capture(capture_tags, 2, u'green;red;green') and mapcss._tag_capture(capture_tags, 3, tags, u'seamark:buoy_lateral:category') != mapcss._value_const_capture(capture_tags, 3, u'preferred_channel_starboard', u'preferred_channel_starboard'))
                except mapcss.RuleAbort: pass
            if not match:
                capture_tags = {}
                try: match = (mapcss._tag_capture(capture_tags, 0, tags, u'seamark:type') == mapcss._value_capture(capture_tags, 0, u'beacon_lateral') and mapcss._tag_capture(capture_tags, 1, tags, u'seamark:beacon_lateral:system') == mapcss._value_capture(capture_tags, 1, u'iala-b') and mapcss._tag_capture(capture_tags, 2, tags, u'seamark:beacon_lateral:colour') == mapcss._value_capture(capture_tags, 2, u'green;red;green') and mapcss._tag_capture(capture_tags, 3, tags, u'seamark:beacon_lateral:category') != mapcss._value_const_capture(capture_tags, 3, u'preferred_channel_starbord', u'preferred_channel_starbord'))
                except mapcss.RuleAbort: pass
            if not match:
                capture_tags = {}
            ...
            if not match:
                capture_tags = {}
                try: match = (mapcss._tag_capture(capture_tags, 0, tags, u'seamark:type') == mapcss._value_capture(capture_tags, 0, u'beacon_lateral') and mapcss._tag_capture(capture_tags, 1, tags, u'seamark:beacon_lateral:system') == mapcss._value_capture(capture_tags, 1, u'iala-b') and mapcss._tag_capture(capture_tags, 2, tags, u'seamark:beacon_lateral:colour') == mapcss._value_capture(capture_tags, 2, u'red;green;red') and mapcss._tag_capture(capture_tags, 3, tags, u'seamark:beacon_lateral:category') != mapcss._value_const_capture(capture_tags, 3, u'preferred_channel_port', u'preferred_channel_port'))
                except mapcss.RuleAbort: pass
            if not match:
                capture_tags = {}
                try: match = (mapcss._tag_capture(capture_tags, 0, tags, u'seamark:type') == mapcss._value_capture(capture_tags, 0, u'buoy_lateral') and mapcss._tag_capture(capture_tags, 1, tags, u'seamark:buoy_lateral:system') == mapcss._value_capture(capture_tags, 1, u'iala-a') and mapcss._tag_capture(capture_tags, 2, tags, u'seamark:buoy_lateral:colour') == mapcss._value_capture(capture_tags, 2, u'red;green;red') and mapcss._tag_capture(capture_tags, 3, tags, u'seamark:buoy_lateral:category') != mapcss._value_const_capture(capture_tags, 3, u'preferred_channel_starboard', u'preferred_channel_starboard'))
            ...
            if not match:
                capture_tags = {}
                try: match = (mapcss._tag_capture(capture_tags, 0, tags, u'seamark:type') == mapcss._value_capture(capture_tags, 0, u'beacon_lateral') and mapcss._tag_capture(capture_tags, 1, tags, u'seamark:beacon_lateral:system') == mapcss._value_capture(capture_tags, 1, u'iala-a') and mapcss._tag_capture(capture_tags, 2, tags, u'seamark:beacon_lateral:colour') == mapcss._value_capture(capture_tags, 2, u'red;green;red') and mapcss._tag_capture(capture_tags, 3, tags, u'seamark:beacon_lateral:category') != mapcss._value_const_capture(capture_tags, 3, u'preferred_channel_starboard', u'preferred_channel_starboard'))
                except mapcss.RuleAbort: pass
            if not match:
                capture_tags = {}
                try: match = (mapcss._tag_capture(capture_tags, 0, tags, u'seamark:type') == mapcss._value_capture(capture_tags, 0, u'buoy_lateral') and mapcss._tag_capture(capture_tags, 1, tags, u'seamark:buoy_lateral:system') == mapcss._value_capture(capture_tags, 1, u'iala-b') and mapcss._tag_capture(capture_tags, 2, tags, u'seamark:buoy_lateral:colour') == mapcss._value_capture(capture_tags, 2, u'green') and mapcss._tag_capture(capture_tags, 3, tags, u'seamark:buoy_lateral:category') != mapcss._value_const_capture(capture_tags, 3, u'port', u'port'))
            ...
            if not match:
                capture_tags = {}
                try: match = (mapcss._tag_capture(capture_tags, 0, tags, u'seamark:type') == mapcss._value_capture(capture_tags, 0, u'beacon_lateral') and mapcss._tag_capture(capture_tags, 1, tags, u'seamark:beacon_lateral:system') == mapcss._value_capture(capture_tags, 1, u'iala-b') and mapcss._tag_capture(capture_tags, 2, tags, u'seamark:beacon_lateral:colour') == mapcss._value_capture(capture_tags, 2, u'green') and mapcss._tag_capture(capture_tags, 3, tags, u'seamark:beacon_lateral:category') != mapcss._value_const_capture(capture_tags, 3, u'port', u'port'))
                except mapcss.RuleAbort: pass
            if not match:
                capture_tags = {}
                try: match = (mapcss._tag_capture(capture_tags, 0, tags, u'seamark:type') == mapcss._value_capture(capture_tags, 0, u'buoy_lateral') and mapcss._tag_capture(capture_tags, 1, tags, u'seamark:buoy_lateral:system') == mapcss._value_capture(capture_tags, 1, u'iala-b') and mapcss._tag_capture(capture_tags, 2, tags, u'seamark:buoy_lateral:colour') == mapcss._value_capture(capture_tags, 2, u'red') and mapcss._tag_capture(capture_tags, 3, tags, u'seamark:buoy_lateral:category') != mapcss._value_const_capture(capture_tags, 3, u'starboard', u'starboard'))
            ...
            if not match:
                capture_tags = {}
                try: match = (mapcss._tag_capture(capture_tags, 0, tags, u'seamark:type') == mapcss._value_capture(capture_tags, 0, u'beacon_lateral') and mapcss._tag_capture(capture_tags, 1, tags, u'seamark:beacon_lateral:system') == mapcss._value_capture(capture_tags, 1, u'iala-b') and mapcss._tag_capture(capture_tags, 2, tags, u'seamark:buoy_lateral:colour') == mapcss._value_capture(capture_tags, 2, u'red') and mapcss._tag_capture(capture_tags, 3, tags, u'seamark:beacon_lateral:category') != mapcss._value_const_capture(capture_tags, 3, u'starboard', u'starboard'))
                except mapcss.RuleAbort: pass
            if not match:
                capture_tags = {}
                try: match = (mapcss._tag_capture(capture_tags, 0, tags, u'seamark:type') == mapcss._value_capture(capture_tags, 0, u'buoy_lateral') and mapcss._tag_capture(capture_tags, 1, tags, u'seamark:buoy_lateral:system') == mapcss._value_capture(capture_tags, 1, u'cevni') and mapcss._tag_capture(capture_tags, 2, tags, u'seamark:buoy_lateral:colour') == mapcss._value_capture(capture_tags, 2, u'green') and not mapcss.regexp_test(mapcss._value_const_capture(capture_tags, 3, self.re_32e3abb7, u'starboard|waterway_left|channel_left'), mapcss._tag_capture(capture_tags, 3, tags, u'seamark:buoy_lateral:category')))
                except mapcss.RuleAbort: pass
            if not match:
                capture_tags = {}
                try: match = (mapcss._tag_capture(capture_tags, 0, tags, u'seamark:type') == mapcss._value_capture(capture_tags, 0, u'buoy_lateral') and mapcss._tag_capture(capture_tags, 1, tags, u'seamark:buoy_lateral:system') == mapcss._value_capture(capture_tags, 1, u'cevni') and mapcss._tag_capture(capture_tags, 2, tags, u'seamark:buoy_lateral:colour') == mapcss._value_capture(capture_tags, 2, u'red') and not mapcss.regexp_test(mapcss._value_const_capture(capture_tags, 3, self.re_288a42ac, u'port|waterway_right|channel_right'), mapcss._tag_capture(capture_tags, 3, tags, u'seamark:buoy_lateral:category')))
                except mapcss.RuleAbort: pass
            if not match:
                capture_tags = {}
                try: match = (mapcss._tag_capture(capture_tags, 0, tags, u'seamark:type') == mapcss._value_capture(capture_tags, 0, u'buoy_lateral') and mapcss._tag_capture(capture_tags, 1, tags, u'seamark:buoy_lateral:system') == mapcss._value_capture(capture_tags, 1, u'cevni') and mapcss._tag_capture(capture_tags, 2, tags, u'seamark:buoy_lateral:colour') == mapcss._value_capture(capture_tags, 2, u'red;green;red;green') and not mapcss.regexp_test(mapcss._value_const_capture(capture_tags, 3, self.re_61629c48, u'preferred_channel_starboard|preferred_channel_port|waterway_separation|channel_separation'), mapcss._tag_capture(capture_tags, 3, tags, u'seamark:buoy_lateral:category')))
                except mapcss.RuleAbort: pass
            if not match:
                capture_tags = {}
                try: match = (mapcss._tag_capture(capture_tags, 0, tags, u'seamark:type') == mapcss._value_capture(capture_tags, 0, u'buoy_lateral') and mapcss._tag_capture(capture_tags, 1, tags, u'seamark:buoy_lateral:system') == mapcss._value_capture(capture_tags, 1, u'cevni') and mapcss._tag_capture(capture_tags, 2, tags, u'seamark:buoy_lateral:colour') == mapcss._value_capture(capture_tags, 2, u'red;green;red') and not mapcss.regexp_test(mapcss._value_const_capture(capture_tags, 3, self.re_281803e9, u'preferred_channel_starboard|turnoff_right'), mapcss._tag_capture(capture_tags, 3, tags, u'seamark:buoy_lateral:category')))
                except mapcss.RuleAbort: pass
            if not match:
                capture_tags = {}
                try: match = (mapcss._tag_capture(capture_tags, 0, tags, u'seamark:type') == mapcss._value_capture(capture_tags, 0, u'buoy_lateral') and mapcss._tag_capture(capture_tags, 1, tags, u'seamark:buoy_lateral:system') == mapcss._value_capture(capture_tags, 1, u'cevni') and mapcss._tag_capture(capture_tags, 2, tags, u'seamark:buoy_lateral:colour') == mapcss._value_capture(capture_tags, 2, u'green;red;green') and not mapcss.regexp_test(mapcss._value_const_capture(capture_tags, 3, self.re_637abe26, u'preferred_channel_port|turnoff_left'), mapcss._tag_capture(capture_tags, 3, tags, u'seamark:buoy_lateral:category')))
                except mapcss.RuleAbort: pass
            if not match:
                capture_tags = {}
                try: match = (mapcss._tag_capture(capture_tags, 0, tags, u'seamark:type') == mapcss._value_capture(capture_tags, 0, u'buoy_lateral') and mapcss._tag_capture(capture_tags, 1, tags, u'seamark:buoy_lateral:system') == mapcss._value_capture(capture_tags, 1, u'cevni') and mapcss._tag_capture(capture_tags, 2, tags, u'seamark:buoy_lateral:colour') == mapcss._value_capture(capture_tags, 2, u'red;white;red;white') and mapcss._tag_capture(capture_tags, 3, tags, u'seamark:buoy_lateral:category') != mapcss._value_const_capture(capture_tags, 3, u'danger_right', u'danger_right'))
                except mapcss.RuleAbort: pass
            if not match:
                capture_tags = {}
                try: match = (mapcss._tag_capture(capture_tags, 0, tags, u'seamark:type') == mapcss._value_capture(capture_tags, 0, u'buoy_lateral') and mapcss._tag_capture(capture_tags, 1, tags, u'seamark:buoy_lateral:system') == mapcss._value_capture(capture_tags, 1, u'cevni') and mapcss._tag_capture(capture_tags, 2, tags, u'seamark:buoy_lateral:colour') == mapcss._value_capture(capture_tags, 2, u'green;white;green;white') and mapcss._tag_capture(capture_tags, 3, tags, u'seamark:buoy_lateral:category') != mapcss._value_const_capture(capture_tags, 3, u'danger_left', u'danger_left'))
                except mapcss.RuleAbort: pass
            if not match:
                capture_tags = {}
                try: match = (mapcss._tag_capture(capture_tags, 0, tags, u'seamark:type') == mapcss._value_capture(capture_tags, 0, u'buoy_lateral') and mapcss._tag_capture(capture_tags, 1, tags, u'seamark:buoy_lateral:system') == mapcss._value_capture(capture_tags, 1, u'cevni') and mapcss._tag_capture(capture_tags, 2, tags, u'seamark:buoy_lateral:colour') == mapcss._value_capture(capture_tags, 2, u'white;red') and mapcss._tag_capture(capture_tags, 3, tags, u'seamark:buoy_lateral:category') != mapcss._value_const_capture(capture_tags, 3, u'turnoff_right', u'turnoff_right'))
                except mapcss.RuleAbort: pass
            if not match:
                capture_tags = {}
                try: match = (mapcss._tag_capture(capture_tags, 0, tags, u'seamark:type') == mapcss._value_capture(capture_tags, 0, u'buoy_lateral') and mapcss._tag_capture(capture_tags, 1, tags, u'seamark:buoy_lateral:system') == mapcss._value_capture(capture_tags, 1, u'cevni') and mapcss._tag_capture(capture_tags, 2, tags, u'seamark:buoy_lateral:colour') == mapcss._value_capture(capture_tags, 2, u'white;green') and mapcss._tag_capture(capture_tags, 3, tags, u'seamark:buoy_lateral:category') != mapcss._value_const_capture(capture_tags, 3, u'turnoff_left', u'turnoff_left'))
                except mapcss.RuleAbort: pass
            if not match:
                capture_tags = {}
                try: match = (mapcss._tag_capture(capture_tags, 0, tags, u'seamark:type') == mapcss._value_capture(capture_tags, 0, u'buoy_lateral') and mapcss._tag_capture(capture_tags, 1, tags, u'seamark:buoy_lateral:system') == mapcss._value_capture(capture_tags, 1, u'cevni') and mapcss._tag_capture(capture_tags, 2, tags, u'seamark:buoy_lateral:colour') == mapcss._value_capture(capture_tags, 2, u'red;white;red') and mapcss._tag_capture(capture_tags, 3, tags, u'seamark:buoy_lateral:category') != mapcss._value_const_capture(capture_tags, 3, u'junction_right', u'junction_right'))
                except mapcss.RuleAbort: pass
            if not match:
                capture_tags = {}
                try: match = (mapcss._tag_capture(capture_tags, 0, tags, u'seamark:type') == mapcss._value_capture(capture_tags, 0, u'buoy_lateral') and mapcss._tag_capture(capture_tags, 1, tags, u'seamark:buoy_lateral:system') == mapcss._value_capture(capture_tags, 1, u'cevni') and mapcss._tag_capture(capture_tags, 2, tags, u'seamark:buoy_lateral:colour') == mapcss._value_capture(capture_tags, 2, u'green;white;green') and mapcss._tag_capture(capture_tags, 3, tags, u'seamark:buoy_lateral:category') != mapcss._value_const_capture(capture_tags, 3, u'junction_left', u'junction_left'))
                except mapcss.RuleAbort: pass
            if not match:
                capture_tags = {}
                try: match = (mapcss._tag_capture(capture_tags, 0, tags, u'seamark:type') == mapcss._value_capture(capture_tags, 0, u'buoy_lateral') and mapcss._tag_capture(capture_tags, 1, tags, u'seamark:buoy_lateral:system') == mapcss._value_capture(capture_tags, 1, u'cevni') and mapcss._tag_capture(capture_tags, 2, tags, u'seamark:buoy_lateral:colour') == mapcss._value_capture(capture_tags, 2, u'red;white') and mapcss._tag_capture(capture_tags, 3, tags, u'seamark:buoy_lateral:category') != mapcss._value_const_capture(capture_tags, 3, u'harbour_right', u'harbour_right'))
                except mapcss.RuleAbort: pass
            if not match:
                capture_tags = {}
                try: match = (mapcss._tag_capture(capture_tags, 0, tags, u'seamark:type') == mapcss._value_capture(capture_tags, 0, u'buoy_lateral') and mapcss._tag_capture(capture_tags, 1, tags, u'seamark:buoy_lateral:system') == mapcss._value_capture(capture_tags, 1, u'cevni') and mapcss._tag_capture(capture_tags, 2, tags, u'seamark:buoy_lateral:colour') == mapcss._value_capture(capture_tags, 2, u'green;white') and mapcss._tag_capture(capture_tags, 3, tags, u'seamark:buoy_lateral:category') != mapcss._value_const_capture(capture_tags, 3, u'harbour_left', u'harbour_left'))
                except mapcss.RuleAbort: pass
            if not match:
                capture_tags = {}
                try: match = (mapcss._tag_capture(capture_tags, 0, tags, u'seamark:type') == mapcss._value_capture(capture_tags, 0, u'buoy_lateral') and mapcss._tag_capture(capture_tags, 1, tags, u'seamark:buoy_lateral:system') == mapcss._value_capture(capture_tags, 1, u'cevni') and mapcss._tag_capture(capture_tags, 2, tags, u'seamark:buoy_lateral:colour') == mapcss._value_capture(capture_tags, 2, u'yellow') and mapcss._tag_capture(capture_tags, 3, tags, u'seamark:buoy_lateral:category') != mapcss._value_const_capture(capture_tags, 3, u'harbour_right', u'harbour_right') and mapcss._tag_capture(capture_tags, 4, tags, u'seamark:topmark:colour') == mapcss._value_capture(capture_tags, 4, u'red'))
                except mapcss.RuleAbort: pass
            if not match:
                capture_tags = {}
                try: match = (mapcss._tag_capture(capture_tags, 0, tags, u'seamark:type') == mapcss._value_capture(capture_tags, 0, u'buoy_lateral') and mapcss._tag_capture(capture_tags, 1, tags, u'seamark:buoy_lateral:system') == mapcss._value_capture(capture_tags, 1, u'cevni') and mapcss._tag_capture(capture_tags, 2, tags, u'seamark:buoy_lateral:colour') == mapcss._value_capture(capture_tags, 2, u'yellow') and mapcss._tag_capture(capture_tags, 3, tags, u'seamark:buoy_lateral:category') != mapcss._value_const_capture(capture_tags, 3, u'harbour_left', u'harbour_left') and mapcss._tag_capture(capture_tags, 4, tags, u'seamark:topmark:colour') == mapcss._value_capture(capture_tags, 4, u'green'))
                except mapcss.RuleAbort: pass
            if not match:
                capture_tags = {}
                try: match = (mapcss._tag_capture(capture_tags, 0, tags, u'seamark:type') == mapcss._value_capture(capture_tags, 0, u'buoy_lateral') and mapcss._tag_capture(capture_tags, 1, tags, u'seamark:buoy_lateral:system') == mapcss._value_capture(capture_tags, 1, u'cevni') and mapcss._tag_capture(capture_tags, 2, tags, u'seamark:buoy_lateral:colour') == mapcss._value_capture(capture_tags, 2, u'yellow') and mapcss._tag_capture(capture_tags, 3, tags, u'seamark:buoy_lateral:category') != mapcss._value_const_capture(capture_tags, 3, u'bridge_pier', u'bridge_pier') and not mapcss._tag_capture(capture_tags, 4, tags, u'seamark:topmark:colour'))
                except mapcss.RuleAbort: pass
            if not match:
                capture_tags = {}
                try: match = (mapcss._tag_capture(capture_tags, 0, tags, u'seamark:type') == mapcss._value_capture(capture_tags, 0, u'beacon_lateral') and mapcss._tag_capture(capture_tags, 1, tags, u'seamark:beacon_lateral:system') == mapcss._value_capture(capture_tags, 1, u'cevni') and mapcss._tag_capture(capture_tags, 2, tags, u'seamark:beacon_lateral:colour') == mapcss._value_capture(capture_tags, 2, u'green') and not mapcss.regexp_test(mapcss._value_const_capture(capture_tags, 3, self.re_32e3abb7, u'starboard|waterway_left|channel_left'), mapcss._tag_capture(capture_tags, 3, tags, u'seamark:beacon_lateral:category')))
                except mapcss.RuleAbort: pass
            if not match:
                capture_tags = {}
                try: match = (mapcss._tag_capture(capture_tags, 0, tags, u'seamark:type') == mapcss._value_capture(capture_tags, 0, u'beacon_lateral') and mapcss._tag_capture(capture_tags, 1, tags, u'seamark:beacon_lateral:system') == mapcss._value_capture(capture_tags, 1, u'cevni') and mapcss._tag_capture(capture_tags, 2, tags, u'seamark:beacon_lateral:colour') == mapcss._value_capture(capture_tags, 2, u'red') and not mapcss.regexp_test(mapcss._value_const_capture(capture_tags, 3, self.re_288a42ac, u'port|waterway_right|channel_right'), mapcss._tag_capture(capture_tags, 3, tags, u'seamark:beacon_lateral:category')))
                except mapcss.RuleAbort: pass
            if not match:
                capture_tags = {}
                try: match = (mapcss._tag_capture(capture_tags, 0, tags, u'seamark:type') == mapcss._value_capture(capture_tags, 0, u'beacon_lateral') and mapcss._tag_capture(capture_tags, 1, tags, u'seamark:beacon_lateral:system') == mapcss._value_capture(capture_tags, 1, u'cevni') and mapcss._tag_capture(capture_tags, 2, tags, u'seamark:beacon_lateral:colour') == mapcss._value_capture(capture_tags, 2, u'red;green;red;green') and not mapcss.regexp_test(mapcss._value_const_capture(capture_tags, 3, self.re_61629c48, u'preferred_channel_starboard|preferred_channel_port|waterway_separation|channel_separation'), mapcss._tag_capture(capture_tags, 3, tags, u'seamark:beacon_lateral:category')))
                except mapcss.RuleAbort: pass
            if not match:
                capture_tags = {}
                try: match = (mapcss._tag_capture(capture_tags, 0, tags, u'seamark:type') == mapcss._value_capture(capture_tags, 0, u'beacon_lateral') and mapcss._tag_capture(capture_tags, 1, tags, u'seamark:beacon_lateral:system') == mapcss._value_capture(capture_tags, 1, u'cevni') and mapcss._tag_capture(capture_tags, 2, tags, u'seamark:beacon_lateral:colour') == mapcss._value_capture(capture_tags, 2, u'red;green;red') and not mapcss.regexp_test(mapcss._value_const_capture(capture_tags, 3, self.re_281803e9, u'preferred_channel_starboard|turnoff_right'), mapcss._tag_capture(capture_tags, 3, tags, u'seamark:beacon_lateral:category')))
                except mapcss.RuleAbort: pass
            if not match:
                capture_tags = {}
                try: match = (mapcss._tag_capture(capture_tags, 0, tags, u'seamark:type') == mapcss._value_capture(capture_tags, 0, u'beacon_lateral') and mapcss._tag_capture(capture_tags, 1, tags, u'seamark:beacon_lateral:system') == mapcss._value_capture(capture_tags, 1, u'cevni') and mapcss._tag_capture(capture_tags, 2, tags, u'seamark:beacon_lateral:colour') == mapcss._value_capture(capture_tags, 2, u'green;red;green') and not mapcss.regexp_test(mapcss._value_const_capture(capture_tags, 3, self.re_637abe26, u'preferred_channel_port|turnoff_left'), mapcss._tag_capture(capture_tags, 3, tags, u'seamark:beacon_lateral:category')))
                except mapcss.RuleAbort: pass
            if not match:
                capture_tags = {}
                try: match = (mapcss._tag_capture(capture_tags, 0, tags, u'seamark:type') == mapcss._value_capture(capture_tags, 0, u'beacon_lateral') and mapcss._tag_capture(capture_tags, 1, tags, u'seamark:beacon_lateral:system') == mapcss._value_capture(capture_tags, 1, u'cevni') and mapcss._tag_capture(capture_tags, 2, tags, u'seamark:beacon_lateral:colour') == mapcss._value_capture(capture_tags, 2, u'red;white;red;white') and mapcss._tag_capture(capture_tags, 3, tags, u'seamark:beacon_lateral:category') != mapcss._value_const_capture(capture_tags, 3, u'danger_right', u'danger_right'))
                except mapcss.RuleAbort: pass
            if not match:
                capture_tags = {}
                try: match = (mapcss._tag_capture(capture_tags, 0, tags, u'seamark:type') == mapcss._value_capture(capture_tags, 0, u'beacon_lateral') and mapcss._tag_capture(capture_tags, 1, tags, u'seamark:beacon_lateral:system') == mapcss._value_capture(capture_tags, 1, u'cevni') and mapcss._tag_capture(capture_tags, 2, tags, u'seamark:beacon_lateral:colour') == mapcss._value_capture(capture_tags, 2, u'green;white;green;white') and mapcss._tag_capture(capture_tags, 3, tags, u'seamark:beacon_lateral:category') != mapcss._value_const_capture(capture_tags, 3, u'danger_left', u'danger_left'))
                except mapcss.RuleAbort: pass
            if not match:
                capture_tags = {}
                try: match = (mapcss._tag_capture(capture_tags, 0, tags, u'seamark:type') == mapcss._value_capture(capture_tags, 0, u'beacon_lateral') and mapcss._tag_capture(capture_tags, 1, tags, u'seamark:beacon_lateral:system') == mapcss._value_capture(capture_tags, 1, u'cevni') and mapcss._tag_capture(capture_tags, 2, tags, u'seamark:beacon_lateral:colour') == mapcss._value_capture(capture_tags, 2, u'white;red') and mapcss._tag_capture(capture_tags, 3, tags, u'seamark:beacon_lateral:category') != mapcss._value_const_capture(capture_tags, 3, u'turnoff_right', u'turnoff_right'))
                except mapcss.RuleAbort: pass
            if not match:
                capture_tags = {}
                try: match = (mapcss._tag_capture(capture_tags, 0, tags, u'seamark:type') == mapcss._value_capture(capture_tags, 0, u'beacon_lateral') and mapcss._tag_capture(capture_tags, 1, tags, u'seamark:beacon_lateral:system') == mapcss._value_capture(capture_tags, 1, u'cevni') and mapcss._tag_capture(capture_tags, 2, tags, u'seamark:beacon_lateral:colour') == mapcss._value_capture(capture_tags, 2, u'white;green') and mapcss._tag_capture(capture_tags, 3, tags, u'seamark:beacon_lateral:category') != mapcss._value_const_capture(capture_tags, 3, u'turnoff_left', u'turnoff_left'))
                except mapcss.RuleAbort: pass
            if not match:
                capture_tags = {}
                try: match = (mapcss._tag_capture(capture_tags, 0, tags, u'seamark:type') == mapcss._value_capture(capture_tags, 0, u'beacon_lateral') and mapcss._tag_capture(capture_tags, 1, tags, u'seamark:beacon_lateral:system') == mapcss._value_capture(capture_tags, 1, u'cevni') and mapcss._tag_capture(capture_tags, 2, tags, u'seamark:beacon_lateral:colour') == mapcss._value_capture(capture_tags, 2, u'red;white;red') and mapcss._tag_capture(capture_tags, 3, tags, u'seamark:beacon_lateral:category') != mapcss._value_const_capture(capture_tags, 3, u'junction_right', u'junction_right'))
                except mapcss.RuleAbort: pass
            if not match:
                capture_tags = {}
                try: match = (mapcss._tag_capture(capture_tags, 0, tags, u'seamark:type') == mapcss._value_capture(capture_tags, 0, u'beacon_lateral') and mapcss._tag_capture(capture_tags, 1, tags, u'seamark:beacon_lateral:system') == mapcss._value_capture(capture_tags, 1, u'cevni') and mapcss._tag_capture(capture_tags, 2, tags, u'seamark:beacon_lateral:colour') == mapcss._value_capture(capture_tags, 2, u'green;white;green') and mapcss._tag_capture(capture_tags, 3, tags, u'seamark:beacon_lateral:category') != mapcss._value_const_capture(capture_tags, 3, u'junction_left', u'junction_left'))
                except mapcss.RuleAbort: pass
            if not match:
                capture_tags = {}
                try: match = (mapcss._tag_capture(capture_tags, 0, tags, u'seamark:type') == mapcss._value_capture(capture_tags, 0, u'beacon_lateral') and mapcss._tag_capture(capture_tags, 1, tags, u'seamark:beacon_lateral:system') == mapcss._value_capture(capture_tags, 1, u'cevni') and mapcss._tag_capture(capture_tags, 2, tags, u'seamark:beacon_lateral:colour') == mapcss._value_capture(capture_tags, 2, u'red;white') and mapcss._tag_capture(capture_tags, 3, tags, u'seamark:beacon_lateral:category') != mapcss._value_const_capture(capture_tags, 3, u'harbour_right', u'harbour_right'))
                except mapcss.RuleAbort: pass
            if not match:
                capture_tags = {}
                try: match = (mapcss._tag_capture(capture_tags, 0, tags, u'seamark:type') == mapcss._value_capture(capture_tags, 0, u'beacon_lateral') and mapcss._tag_capture(capture_tags, 1, tags, u'seamark:beacon_lateral:system') == mapcss._value_capture(capture_tags, 1, u'cevni') and mapcss._tag_capture(capture_tags, 2, tags, u'seamark:beacon_lateral:colour') == mapcss._value_capture(capture_tags, 2, u'green;white') and mapcss._tag_capture(capture_tags, 3, tags, u'seamark:beacon_lateral:category') != mapcss._value_const_capture(capture_tags, 3, u'harbour_left', u'harbour_left'))
                except mapcss.RuleAbort: pass
            if not match:
                capture_tags = {}
                try: match = (mapcss._tag_capture(capture_tags, 0, tags, u'seamark:type') == mapcss._value_capture(capture_tags, 0, u'beacon_lateral') and mapcss._tag_capture(capture_tags, 1, tags, u'seamark:beacon_lateral:system') == mapcss._value_capture(capture_tags, 1, u'cevni') and mapcss._tag_capture(capture_tags, 2, tags, u'seamark:beacon_lateral:colour') == mapcss._value_capture(capture_tags, 2, u'yellow') and mapcss._tag_capture(capture_tags, 3, tags, u'seamark:beacon_lateral:category') != mapcss._value_const_capture(capture_tags, 3, u'harbour_right', u'harbour_right') and mapcss._tag_capture(capture_tags, 4, tags, u'seamark:topmark:colour') == mapcss._value_capture(capture_tags, 4, u'red'))
                except mapcss.RuleAbort: pass
            if not match:
                capture_tags = {}
                try: match = (mapcss._tag_capture(capture_tags, 0, tags, u'seamark:type') == mapcss._value_capture(capture_tags, 0, u'beacon_lateral') and mapcss._tag_capture(capture_tags, 1, tags, u'seamark:beacon_lateral:system') == mapcss._value_capture(capture_tags, 1, u'cevni') and mapcss._tag_capture(capture_tags, 2, tags, u'seamark:beacon_lateral:colour') == mapcss._value_capture(capture_tags, 2, u'yellow') and mapcss._tag_capture(capture_tags, 3, tags, u'seamark:beacon_lateral:category') != mapcss._value_const_capture(capture_tags, 3, u'harbour_left', u'harbour_left') and mapcss._tag_capture(capture_tags, 4, tags, u'seamark:topmark:colour') == mapcss._value_capture(capture_tags, 4, u'green'))
                except mapcss.RuleAbort: pass
            if not match:
                capture_tags = {}
                try: match = (mapcss._tag_capture(capture_tags, 0, tags, u'seamark:type') == mapcss._value_capture(capture_tags, 0, u'beacon_lateral') and mapcss._tag_capture(capture_tags, 1, tags, u'seamark:beacon_lateral:system') == mapcss._value_capture(capture_tags, 1, u'cevni') and mapcss._tag_capture(capture_tags, 2, tags, u'seamark:beacon_lateral:colour') == mapcss._value_capture(capture_tags, 2, u'yellow') and mapcss._tag_capture(capture_tags, 3, tags, u'seamark:beacon_lateral:category') != mapcss._value_const_capture(capture_tags, 3, u'bridge_pier', u'bridge_pier') and not mapcss._tag_capture(capture_tags, 4, tags, u'seamark:topmark:colour'))
                except mapcss.RuleAbort: pass
            if match:
        ...
        if (u'seamark:beacon:cardinal:colour' in keys and u'seamark:type' in keys) or (u'seamark:buoy_cardinal:colour' in keys and u'seamark:type' in keys):
            ...
            if not match:
                capture_tags = {}
                try: match = (mapcss._tag_capture(capture_tags, 0, tags, u'seamark:type') == mapcss._value_capture(capture_tags, 0, u'buoy_cardinal') and mapcss._tag_capture(capture_tags, 1, tags, u'seamark:buoy_cardinal:colour') == mapcss._value_capture(capture_tags, 1, u'black;yellow') and mapcss._tag_capture(capture_tags, 2, tags, u'seamark:buoy_cardinal:category') != mapcss._value_const_capture(capture_tags, 2, u'north', u'north'))
                except mapcss.RuleAbort: pass
            if not match:
                capture_tags = {}
                try: match = (mapcss._tag_capture(capture_tags, 0, tags, u'seamark:type') == mapcss._value_capture(capture_tags, 0, u'beacon_cardinal') and mapcss._tag_capture(capture_tags, 1, tags, u'seamark:beacon:cardinal:colour') == mapcss._value_capture(capture_tags, 1, u'black;yellow') and mapcss._tag_capture(capture_tags, 2, tags, u'seamark:beacon_cardinal:category') != mapcss._value_const_capture(capture_tags, 2, u'north', u'north'))
                except mapcss.RuleAbort: pass
            if not match:
                capture_tags = {}
                try: match = (mapcss._tag_capture(capture_tags, 0, tags, u'seamark:type') == mapcss._value_capture(capture_tags, 0, u'buoy_cardinal') and mapcss._tag_capture(capture_tags, 1, tags, u'seamark:buoy_cardinal:colour') == mapcss._value_capture(capture_tags, 1, u'black;yellow;black') and mapcss._tag_capture(capture_tags, 2, tags, u'seamark:buoy_cardinal:category') != mapcss._value_const_capture(capture_tags, 2, u'east', u'east'))
                except mapcss.RuleAbort: pass
            if not match:
                capture_tags = {}
                try: match = (mapcss._tag_capture(capture_tags, 0, tags, u'seamark:type') == mapcss._value_capture(capture_tags, 0, u'beacon_cardinal') and mapcss._tag_capture(capture_tags, 1, tags, u'seamark:beacon:cardinal:colour') == mapcss._value_capture(capture_tags, 1, u'black;yellow;black') and mapcss._tag_capture(capture_tags, 2, tags, u'seamark:beacon_cardinal:category') != mapcss._value_const_capture(capture_tags, 2, u'east', u'east'))
                except mapcss.RuleAbort: pass
            if not match:
                capture_tags = {}
                try: match = (mapcss._tag_capture(capture_tags, 0, tags, u'seamark:type') == mapcss._value_capture(capture_tags, 0, u'buoy_cardinal') and mapcss._tag_capture(capture_tags, 1, tags, u'seamark:buoy_cardinal:colour') == mapcss._value_capture(capture_tags, 1, u'yellow;black') and mapcss._tag_capture(capture_tags, 2, tags, u'seamark:buoy_cardinal:category') != mapcss._value_const_capture(capture_tags, 2, u'south', u'south'))
                except mapcss.RuleAbort: pass
            if not match:
                capture_tags = {}
                try: match = (mapcss._tag_capture(capture_tags, 0, tags, u'seamark:type') == mapcss._value_capture(capture_tags, 0, u'beacon_cardinal') and mapcss._tag_capture(capture_tags, 1, tags, u'seamark:beacon:cardinal:colour') == mapcss._value_capture(capture_tags, 1, u'yellow;black') and mapcss._tag_capture(capture_tags, 2, tags, u'seamark:beacon_cardinal:category') != mapcss._value_const_capture(capture_tags, 2, u'south', u'south'))
                except mapcss.RuleAbort: pass
            if not match:
                capture_tags = {}
                try: match = (mapcss._tag_capture(capture_tags, 0, tags, u'seamark:type') == mapcss._value_capture(capture_tags, 0, u'buoy_cardinal') and mapcss._tag_capture(capture_tags, 1, tags, u'seamark:buoy_cardinal:colour') == mapcss._value_capture(capture_tags, 1, u'yellow;black;yellow') and mapcss._tag_capture(capture_tags, 2, tags, u'seamark:buoy_cardinal:category') != mapcss._value_const_capture(capture_tags, 2, u'west', u'west'))
                except mapcss.RuleAbort: pass
            if not match:
                capture_tags = {}
                try: match = (mapcss._tag_capture(capture_tags, 0, tags, u'seamark:type') == mapcss._value_capture(capture_tags, 0, u'beacon_cardinal') and mapcss._tag_capture(capture_tags, 1, tags, u'seamark:beacon:cardinal:colour') == mapcss._value_capture(capture_tags, 1, u'yellow;black;yellow') and mapcss._tag_capture(capture_tags, 2, tags, u'seamark:beacon_cardinal:category') != mapcss._value_const_capture(capture_tags, 2, u'west', u'west'))
                except mapcss.RuleAbort: pass
            if match:
        ...
        if (u'seamark:wreck:category' in keys):
            ...
            if not match:
                capture_tags = {}
                try: match = (mapcss._tag_capture(capture_tags, 0, tags, u'seamark:wreck:category') and mapcss._tag_capture(capture_tags, 1, tags, u'seamark:type') != mapcss._value_const_capture(capture_tags, 1, u'wreck', u'wreck'))
                except mapcss.RuleAbort: pass
            if match:
        ...
        if (u'seamark:notice:1:category' in keys and u'seamark:notice:1:system' in keys) or (u'seamark:notice:2:category' in keys and u'seamark:notice:2:system' in keys) or (u'seamark:notice:3:category' in keys and u'seamark:notice:3:system' in keys) or (u'seamark:notice:4:category' in keys and u'seamark:notice:4:system' in keys) or (u'seamark:notice:5:category' in keys and u'seamark:notice:5:system' in keys) or (u'seamark:notice:6:category' in keys and u'seamark:notice:6:system' in keys) or (u'seamark:notice:7:category' in keys and u'seamark:notice:7:system' in keys) or (u'seamark:notice:8:category' in keys and u'seamark:notice:8:system' in keys) or (u'seamark:notice:9:category' in keys and u'seamark:notice:9:system' in keys) or (u'seamark:notice:category' in keys and u'seamark:notice:system' in keys):
            ...
            if not match:
                capture_tags = {}
                try: match = (mapcss._tag_capture(capture_tags, 0, tags, u'seamark:notice:system') == mapcss._value_capture(capture_tags, 0, u'cevni') and mapcss._tag_capture(capture_tags, 1, tags, u'seamark:notice:function') != mapcss._value_const_capture(capture_tags, 1, u'prohibition', u'prohibition') and mapcss.regexp_test(mapcss._value_capture(capture_tags, 2, self.re_0e3e01fc), mapcss._tag_capture(capture_tags, 2, tags, u'seamark:notice:category')))
                except mapcss.RuleAbort: pass
            if not match:
                capture_tags = {}
                try: match = (mapcss._tag_capture(capture_tags, 0, tags, u'seamark:notice:1:system') == mapcss._value_capture(capture_tags, 0, u'cevni') and mapcss._tag_capture(capture_tags, 1, tags, u'seamark:notice:1:function') != mapcss._value_const_capture(capture_tags, 1, u'prohibition', u'prohibition') and mapcss.regexp_test(mapcss._value_capture(capture_tags, 2, self.re_0e3e01fc), mapcss._tag_capture(capture_tags, 2, tags, u'seamark:notice:1:category')))
                except mapcss.RuleAbort: pass
            if not match:
                capture_tags = {}
                try: match = (mapcss._tag_capture(capture_tags, 0, tags, u'seamark:notice:2:system') == mapcss._value_capture(capture_tags, 0, u'cevni') and mapcss._tag_capture(capture_tags, 1, tags, u'seamark:notice:2:function') != mapcss._value_const_capture(capture_tags, 1, u'prohibition', u'prohibition') and mapcss.regexp_test(mapcss._value_capture(capture_tags, 2, self.re_0e3e01fc), mapcss._tag_capture(capture_tags, 2, tags, u'seamark:notice:2:category')))
                except mapcss.RuleAbort: pass
            if not match:
                capture_tags = {}
                try: match = (mapcss._tag_capture(capture_tags, 0, tags, u'seamark:notice:3:system') == mapcss._value_capture(capture_tags, 0, u'cevni') and mapcss._tag_capture(capture_tags, 1, tags, u'seamark:notice:3:function') != mapcss._value_const_capture(capture_tags, 1, u'prohibition', u'prohibition') and mapcss.regexp_test(mapcss._value_capture(capture_tags, 2, self.re_0e3e01fc), mapcss._tag_capture(capture_tags, 2, tags, u'seamark:notice:3:category')))
                except mapcss.RuleAbort: pass
            if not match:
                capture_tags = {}
                try: match = (mapcss._tag_capture(capture_tags, 0, tags, u'seamark:notice:4:system') == mapcss._value_capture(capture_tags, 0, u'cevni') and mapcss._tag_capture(capture_tags, 1, tags, u'seamark:notice:4:function') != mapcss._value_const_capture(capture_tags, 1, u'prohibition', u'prohibition') and mapcss.regexp_test(mapcss._value_capture(capture_tags, 2, self.re_0e3e01fc), mapcss._tag_capture(capture_tags, 2, tags, u'seamark:notice:4:category')))
                except mapcss.RuleAbort: pass
            if not match:
                capture_tags = {}
                try: match = (mapcss._tag_capture(capture_tags, 0, tags, u'seamark:notice:5:system') == mapcss._value_capture(capture_tags, 0, u'cevni') and mapcss._tag_capture(capture_tags, 1, tags, u'seamark:notice:5:function') != mapcss._value_const_capture(capture_tags, 1, u'prohibition', u'prohibition') and mapcss.regexp_test(mapcss._value_capture(capture_tags, 2, self.re_0e3e01fc), mapcss._tag_capture(capture_tags, 2, tags, u'seamark:notice:5:category')))
                except mapcss.RuleAbort: pass
            if not match:
                capture_tags = {}
                try: match = (mapcss._tag_capture(capture_tags, 0, tags, u'seamark:notice:6:system') == mapcss._value_capture(capture_tags, 0, u'cevni') and mapcss._tag_capture(capture_tags, 1, tags, u'seamark:notice:6:function') != mapcss._value_const_capture(capture_tags, 1, u'prohibition', u'prohibition') and mapcss.regexp_test(mapcss._value_capture(capture_tags, 2, self.re_0e3e01fc), mapcss._tag_capture(capture_tags, 2, tags, u'seamark:notice:6:category')))
                except mapcss.RuleAbort: pass
            if not match:
                capture_tags = {}
                try: match = (mapcss._tag_capture(capture_tags, 0, tags, u'seamark:notice:7:system') == mapcss._value_capture(capture_tags, 0, u'cevni') and mapcss._tag_capture(capture_tags, 1, tags, u'seamark:notice:7:function') != mapcss._value_const_capture(capture_tags, 1, u'prohibition', u'prohibition') and mapcss.regexp_test(mapcss._value_capture(capture_tags, 2, self.re_0e3e01fc), mapcss._tag_capture(capture_tags, 2, tags, u'seamark:notice:7:category')))
                except mapcss.RuleAbort: pass
            if not match:
                capture_tags = {}
                try: match = (mapcss._tag_capture(capture_tags, 0, tags, u'seamark:notice:8:system') == mapcss._value_capture(capture_tags, 0, u'cevni') and mapcss._tag_capture(capture_tags, 1, tags, u'seamark:notice:8:function') != mapcss._value_const_capture(capture_tags, 1, u'prohibition', u'prohibition') and mapcss.regexp_test(mapcss._value_capture(capture_tags, 2, self.re_0e3e01fc), mapcss._tag_capture(capture_tags, 2, tags, u'seamark:notice:8:category')))
                except mapcss.RuleAbort: pass
            if not match:
                capture_tags = {}
                try: match = (mapcss._tag_capture(capture_tags, 0, tags, u'seamark:notice:9:system') == mapcss._value_capture(capture_tags, 0, u'cevni') and mapcss._tag_capture(capture_tags, 1, tags, u'seamark:notice:9:function') != mapcss._value_const_capture(capture_tags, 1, u'prohibition', u'prohibition') and mapcss.regexp_test(mapcss._value_capture(capture_tags, 2, self.re_0e3e01fc), mapcss._tag_capture(capture_tags, 2, tags, u'seamark:notice:9:category')))
                except mapcss.RuleAbort: pass
            if not match:
                capture_tags = {}
                try: match = (mapcss._tag_capture(capture_tags, 0, tags, u'seamark:notice:system') == mapcss._value_capture(capture_tags, 0, u'cevni') and mapcss._tag_capture(capture_tags, 1, tags, u'seamark:notice:function') != mapcss._value_const_capture(capture_tags, 1, u'regulation', u'regulation') and mapcss.regexp_test(mapcss._value_capture(capture_tags, 2, self.re_1389a933), mapcss._tag_capture(capture_tags, 2, tags, u'seamark:notice:category')))
                except mapcss.RuleAbort: pass
            if not match:
                capture_tags = {}
                try: match = (mapcss._tag_capture(capture_tags, 0, tags, u'seamark:notice:1:system') == mapcss._value_capture(capture_tags, 0, u'cevni') and mapcss._tag_capture(capture_tags, 1, tags, u'seamark:notice:1:function') != mapcss._value_const_capture(capture_tags, 1, u'regulation', u'regulation') and mapcss.regexp_test(mapcss._value_capture(capture_tags, 2, self.re_1389a933), mapcss._tag_capture(capture_tags, 2, tags, u'seamark:notice:1:category')))
                except mapcss.RuleAbort: pass
            if not match:
                capture_tags = {}
                try: match = (mapcss._tag_capture(capture_tags, 0, tags, u'seamark:notice:2:system') == mapcss._value_capture(capture_tags, 0, u'cevni') and mapcss._tag_capture(capture_tags, 1, tags, u'seamark:notice:2:function') != mapcss._value_const_capture(capture_tags, 1, u'regulation', u'regulation') and mapcss.regexp_test(mapcss._value_capture(capture_tags, 2, self.re_1389a933), mapcss._tag_capture(capture_tags, 2, tags, u'seamark:notice:2:category')))
                except mapcss.RuleAbort: pass
            if not match:
                capture_tags = {}
                try: match = (mapcss._tag_capture(capture_tags, 0, tags, u'seamark:notice:3:system') == mapcss._value_capture(capture_tags, 0, u'cevni') and mapcss._tag_capture(capture_tags, 1, tags, u'seamark:notice:3:function') != mapcss._value_const_capture(capture_tags, 1, u'regulation', u'regulation') and mapcss.regexp_test(mapcss._value_capture(capture_tags, 2, self.re_1389a933), mapcss._tag_capture(capture_tags, 2, tags, u'seamark:notice:3:category')))
                except mapcss.RuleAbort: pass
            if not match:
                capture_tags = {}
                try: match = (mapcss._tag_capture(capture_tags, 0, tags, u'seamark:notice:4:system') == mapcss._value_capture(capture_tags, 0, u'cevni') and mapcss._tag_capture(capture_tags, 1, tags, u'seamark:notice:4:function') != mapcss._value_const_capture(capture_tags, 1, u'regulation', u'regulation') and mapcss.regexp_test(mapcss._value_capture(capture_tags, 2, self.re_1389a933), mapcss._tag_capture(capture_tags, 2, tags, u'seamark:notice:4:category')))
                except mapcss.RuleAbort: pass
            if not match:
                capture_tags = {}
                try: match = (mapcss._tag_capture(capture_tags, 0, tags, u'seamark:notice:5:system') == mapcss._value_capture(capture_tags, 0, u'cevni') and mapcss._tag_capture(capture_tags, 1, tags, u'seamark:notice:5:function') != mapcss._value_const_capture(capture_tags, 1, u'regulation', u'regulation') and mapcss.regexp_test(mapcss._value_capture(capture_tags, 2, self.re_1389a933), mapcss._tag_capture(capture_tags, 2, tags, u'seamark:notice:5:category')))
                except mapcss.RuleAbort: pass
            if not match:
                capture_tags = {}
                try: match = (mapcss._tag_capture(capture_tags, 0, tags, u'seamark:notice:6:system') == mapcss._value_capture(capture_tags, 0, u'cevni') and mapcss._tag_capture(capture_tags, 1, tags, u'seamark:notice:6:function') != mapcss._value_const_capture(capture_tags, 1, u'regulation', u'regulation') and mapcss.regexp_test(mapcss._value_capture(capture_tags, 2, self.re_1389a933), mapcss._tag_capture(capture_tags, 2, tags, u'seamark:notice:6:category')))
                except mapcss.RuleAbort: pass
            if not match:
                capture_tags = {}
                try: match = (mapcss._tag_capture(capture_tags, 0, tags, u'seamark:notice:7:system') == mapcss._value_capture(capture_tags, 0, u'cevni') and mapcss._tag_capture(capture_tags, 1, tags, u'seamark:notice:7:function') != mapcss._value_const_capture(capture_tags, 1, u'regulation', u'regulation') and mapcss.regexp_test(mapcss._value_capture(capture_tags, 2, self.re_1389a933), mapcss._tag_capture(capture_tags, 2, tags, u'seamark:notice:7:category')))
                except mapcss.RuleAbort: pass
            if not match:
                capture_tags = {}
                try: match = (mapcss._tag_capture(capture_tags, 0, tags, u'seamark:notice:8:system') == mapcss._value_capture(capture_tags, 0, u'cevni') and mapcss._tag_capture(capture_tags, 1, tags, u'seamark:notice:8:function') != mapcss._value_const_capture(capture_tags, 1, u'regulation', u'regulation') and mapcss.regexp_test(mapcss._value_capture(capture_tags, 2, self.re_1389a933), mapcss._tag_capture(capture_tags, 2, tags, u'seamark:notice:8:category')))
                except mapcss.RuleAbort: pass
            if not match:
                capture_tags = {}
                try: match = (mapcss._tag_capture(capture_tags, 0, tags, u'seamark:notice:9:system') == mapcss._value_capture(capture_tags, 0, u'cevni') and mapcss._tag_capture(capture_tags, 1, tags, u'seamark:notice:9:function') != mapcss._value_const_capture(capture_tags, 1, u'regulation', u'regulation') and mapcss.regexp_test(mapcss._value_capture(capture_tags, 2, self.re_1389a933), mapcss._tag_capture(capture_tags, 2, tags, u'seamark:notice:9:category')))
                except mapcss.RuleAbort: pass
            if not match:
                capture_tags = {}
                try: match = (mapcss._tag_capture(capture_tags, 0, tags, u'seamark:notice:system') == mapcss._value_capture(capture_tags, 0, u'cevni') and mapcss._tag_capture(capture_tags, 1, tags, u'seamark:notice:function') != mapcss._value_const_capture(capture_tags, 1, u'restriction', u'restriction') and mapcss.regexp_test(mapcss._value_capture(capture_tags, 2, self.re_336a6c28), mapcss._tag_capture(capture_tags, 2, tags, u'seamark:notice:category')))
                except mapcss.RuleAbort: pass
            if not match:
                capture_tags = {}
                try: match = (mapcss._tag_capture(capture_tags, 0, tags, u'seamark:notice:1:system') == mapcss._value_capture(capture_tags, 0, u'cevni') and mapcss._tag_capture(capture_tags, 1, tags, u'seamark:notice:1:function') != mapcss._value_const_capture(capture_tags, 1, u'restriction', u'restriction') and mapcss.regexp_test(mapcss._value_capture(capture_tags, 2, self.re_336a6c28), mapcss._tag_capture(capture_tags, 2, tags, u'seamark:notice:1:category')))
                except mapcss.RuleAbort: pass
            if not match:
                capture_tags = {}
                try: match = (mapcss._tag_capture(capture_tags, 0, tags, u'seamark:notice:2:system') == mapcss._value_capture(capture_tags, 0, u'cevni') and mapcss._tag_capture(capture_tags, 1, tags, u'seamark:notice:2:function') != mapcss._value_const_capture(capture_tags, 1, u'restriction', u'restriction') and mapcss.regexp_test(mapcss._value_capture(capture_tags, 2, self.re_336a6c28), mapcss._tag_capture(capture_tags, 2, tags, u'seamark:notice:2:category')))
                except mapcss.RuleAbort: pass
            if not match:
                capture_tags = {}
                try: match = (mapcss._tag_capture(capture_tags, 0, tags, u'seamark:notice:3:system') == mapcss._value_capture(capture_tags, 0, u'cevni') and mapcss._tag_capture(capture_tags, 1, tags, u'seamark:notice:3:function') != mapcss._value_const_capture(capture_tags, 1, u'restriction', u'restriction') and mapcss.regexp_test(mapcss._value_capture(capture_tags, 2, self.re_336a6c28), mapcss._tag_capture(capture_tags, 2, tags, u'seamark:notice:3:category')))
                except mapcss.RuleAbort: pass
            if not match:
                capture_tags = {}
                try: match = (mapcss._tag_capture(capture_tags, 0, tags, u'seamark:notice:4:system') == mapcss._value_capture(capture_tags, 0, u'cevni') and mapcss._tag_capture(capture_tags, 1, tags, u'seamark:notice:4:function') != mapcss._value_const_capture(capture_tags, 1, u'restriction', u'restriction') and mapcss.regexp_test(mapcss._value_capture(capture_tags, 2, self.re_336a6c28), mapcss._tag_capture(capture_tags, 2, tags, u'seamark:notice:4:category')))
                except mapcss.RuleAbort: pass
            if not match:
                capture_tags = {}
                try: match = (mapcss._tag_capture(capture_tags, 0, tags, u'seamark:notice:5:system') == mapcss._value_capture(capture_tags, 0, u'cevni') and mapcss._tag_capture(capture_tags, 1, tags, u'seamark:notice:5:function') != mapcss._value_const_capture(capture_tags, 1, u'restriction', u'restriction') and mapcss.regexp_test(mapcss._value_capture(capture_tags, 2, self.re_336a6c28), mapcss._tag_capture(capture_tags, 2, tags, u'seamark:notice:5:category')))
                except mapcss.RuleAbort: pass
            if not match:
                capture_tags = {}
                try: match = (mapcss._tag_capture(capture_tags, 0, tags, u'seamark:notice:6:system') == mapcss._value_capture(capture_tags, 0, u'cevni') and mapcss._tag_capture(capture_tags, 1, tags, u'seamark:notice:6:function') != mapcss._value_const_capture(capture_tags, 1, u'restriction', u'restriction') and mapcss.regexp_test(mapcss._value_capture(capture_tags, 2, self.re_336a6c28), mapcss._tag_capture(capture_tags, 2, tags, u'seamark:notice:6:category')))
                except mapcss.RuleAbort: pass
            if not match:
                capture_tags = {}
                try: match = (mapcss._tag_capture(capture_tags, 0, tags, u'seamark:notice:7:system') == mapcss._value_capture(capture_tags, 0, u'cevni') and mapcss._tag_capture(capture_tags, 1, tags, u'seamark:notice:7:function') != mapcss._value_const_capture(capture_tags, 1, u'restriction', u'restriction') and mapcss.regexp_test(mapcss._value_capture(capture_tags, 2, self.re_336a6c28), mapcss._tag_capture(capture_tags, 2, tags, u'seamark:notice:7:category')))
                except mapcss.RuleAbort: pass
            if not match:
                capture_tags = {}
                try: match = (mapcss._tag_capture(capture_tags, 0, tags, u'seamark:notice:8:system') == mapcss._value_capture(capture_tags, 0, u'cevni') and mapcss._tag_capture(capture_tags, 1, tags, u'seamark:notice:8:function') != mapcss._value_const_capture(capture_tags, 1, u'restriction', u'restriction') and mapcss.regexp_test(mapcss._value_capture(capture_tags, 2, self.re_336a6c28), mapcss._tag_capture(capture_tags, 2, tags, u'seamark:notice:8:category')))
                except mapcss.RuleAbort: pass
            if not match:
                capture_tags = {}
                try: match = (mapcss._tag_capture(capture_tags, 0, tags, u'seamark:notice:9:system') == mapcss._value_capture(capture_tags, 0, u'cevni') and mapcss._tag_capture(capture_tags, 1, tags, u'seamark:notice:9:function') != mapcss._value_const_capture(capture_tags, 1, u'restriction', u'restriction') and mapcss.regexp_test(mapcss._value_capture(capture_tags, 2, self.re_336a6c28), mapcss._tag_capture(capture_tags, 2, tags, u'seamark:notice:9:category')))
                except mapcss.RuleAbort: pass
            if not match:
                capture_tags = {}
                try: match = (mapcss._tag_capture(capture_tags, 0, tags, u'seamark:notice:system') == mapcss._value_capture(capture_tags, 0, u'cevni') and mapcss._tag_capture(capture_tags, 1, tags, u'seamark:notice:function') != mapcss._value_const_capture(capture_tags, 1, u'recommendation', u'recommendation') and mapcss.regexp_test(mapcss._value_capture(capture_tags, 2, self.re_253b0e7a), mapcss._tag_capture(capture_tags, 2, tags, u'seamark:notice:category')))
                except mapcss.RuleAbort: pass
            if not match:
                capture_tags = {}
                try: match = (mapcss._tag_capture(capture_tags, 0, tags, u'seamark:notice:1:system') == mapcss._value_capture(capture_tags, 0, u'cevni') and mapcss._tag_capture(capture_tags, 1, tags, u'seamark:notice:1:function') != mapcss._value_const_capture(capture_tags, 1, u'recommendation', u'recommendation') and mapcss.regexp_test(mapcss._value_capture(capture_tags, 2, self.re_253b0e7a), mapcss._tag_capture(capture_tags, 2, tags, u'seamark:notice:1:category')))
                except mapcss.RuleAbort: pass
            if not match:
                capture_tags = {}
                try: match = (mapcss._tag_capture(capture_tags, 0, tags, u'seamark:notice:2:system') == mapcss._value_capture(capture_tags, 0, u'cevni') and mapcss._tag_capture(capture_tags, 1, tags, u'seamark:notice:2:function') != mapcss._value_const_capture(capture_tags, 1, u'recommendation', u'recommendation') and mapcss.regexp_test(mapcss._value_capture(capture_tags, 2, self.re_253b0e7a), mapcss._tag_capture(capture_tags, 2, tags, u'seamark:notice:2:category')))
                except mapcss.RuleAbort: pass
            if not match:
                capture_tags = {}
                try: match = (mapcss._tag_capture(capture_tags, 0, tags, u'seamark:notice:3:system') == mapcss._value_capture(capture_tags, 0, u'cevni') and mapcss._tag_capture(capture_tags, 1, tags, u'seamark:notice:3:function') != mapcss._value_const_capture(capture_tags, 1, u'recommendation', u'recommendation') and mapcss.regexp_test(mapcss._value_capture(capture_tags, 2, self.re_253b0e7a), mapcss._tag_capture(capture_tags, 2, tags, u'seamark:notice:3:category')))
                except mapcss.RuleAbort: pass
            if not match:
                capture_tags = {}
                try: match = (mapcss._tag_capture(capture_tags, 0, tags, u'seamark:notice:4:system') == mapcss._value_capture(capture_tags, 0, u'cevni') and mapcss._tag_capture(capture_tags, 1, tags, u'seamark:notice:4:function') != mapcss._value_const_capture(capture_tags, 1, u'recommendation', u'recommendation') and mapcss.regexp_test(mapcss._value_capture(capture_tags, 2, self.re_253b0e7a), mapcss._tag_capture(capture_tags, 2, tags, u'seamark:notice:4:category')))
                except mapcss.RuleAbort: pass
            if not match:
                capture_tags = {}
                try: match = (mapcss._tag_capture(capture_tags, 0, tags, u'seamark:notice:5:system') == mapcss._value_capture(capture_tags, 0, u'cevni') and mapcss._tag_capture(capture_tags, 1, tags, u'seamark:notice:5:function') != mapcss._value_const_capture(capture_tags, 1, u'recommendation', u'recommendation') and mapcss.regexp_test(mapcss._value_capture(capture_tags, 2, self.re_253b0e7a), mapcss._tag_capture(capture_tags, 2, tags, u'seamark:notice:5:category')))
                except mapcss.RuleAbort: pass
            if not match:
                capture_tags = {}
                try: match = (mapcss._tag_capture(capture_tags, 0, tags, u'seamark:notice:6:system') == mapcss._value_capture(capture_tags, 0, u'cevni') and mapcss._tag_capture(capture_tags, 1, tags, u'seamark:notice:6:function') != mapcss._value_const_capture(capture_tags, 1, u'recommendation', u'recommendation') and mapcss.regexp_test(mapcss._value_capture(capture_tags, 2, self.re_253b0e7a), mapcss._tag_capture(capture_tags, 2, tags, u'seamark:notice:6:category')))
                except mapcss.RuleAbort: pass
            if not match:
                capture_tags = {}
                try: match = (mapcss._tag_capture(capture_tags, 0, tags, u'seamark:notice:7:system') == mapcss._value_capture(capture_tags, 0, u'cevni') and mapcss._tag_capture(capture_tags, 1, tags, u'seamark:notice:7:function') != mapcss._value_const_capture(capture_tags, 1, u'recommendation', u'recommendation') and mapcss.regexp_test(mapcss._value_capture(capture_tags, 2, self.re_253b0e7a), mapcss._tag_capture(capture_tags, 2, tags, u'seamark:notice:7:category')))
                except mapcss.RuleAbort: pass
            if not match:
                capture_tags = {}
                try: match = (mapcss._tag_capture(capture_tags, 0, tags, u'seamark:notice:8:system') == mapcss._value_capture(capture_tags, 0, u'cevni') and mapcss._tag_capture(capture_tags, 1, tags, u'seamark:notice:8:function') != mapcss._value_const_capture(capture_tags, 1, u'recommendation', u'recommendation') and mapcss.regexp_test(mapcss._value_capture(capture_tags, 2, self.re_253b0e7a), mapcss._tag_capture(capture_tags, 2, tags, u'seamark:notice:8:category')))
                except mapcss.RuleAbort: pass
            if not match:
                capture_tags = {}
                try: match = (mapcss._tag_capture(capture_tags, 0, tags, u'seamark:notice:9:system') == mapcss._value_capture(capture_tags, 0, u'cevni') and mapcss._tag_capture(capture_tags, 1, tags, u'seamark:notice:9:function') != mapcss._value_const_capture(capture_tags, 1, u'recommendation', u'recommendation') and mapcss.regexp_test(mapcss._value_capture(capture_tags, 2, self.re_253b0e7a), mapcss._tag_capture(capture_tags, 2, tags, u'seamark:notice:9:category')))
                except mapcss.RuleAbort: pass
            if not match:
                capture_tags = {}
                try: match = (mapcss._tag_capture(capture_tags, 0, tags, u'seamark:notice:system') == mapcss._value_capture(capture_tags, 0, u'cevni') and mapcss._tag_capture(capture_tags, 1, tags, u'seamark:notice:function') != mapcss._value_const_capture(capture_tags, 1, u'information', u'information') and mapcss.regexp_test(mapcss._value_capture(capture_tags, 2, self.re_0c508f2a), mapcss._tag_capture(capture_tags, 2, tags, u'seamark:notice:category')))
                except mapcss.RuleAbort: pass
            if not match:
                capture_tags = {}
                try: match = (mapcss._tag_capture(capture_tags, 0, tags, u'seamark:notice:1:system') == mapcss._value_capture(capture_tags, 0, u'cevni') and mapcss._tag_capture(capture_tags, 1, tags, u'seamark:notice:1:function') != mapcss._value_const_capture(capture_tags, 1, u'information', u'information') and mapcss.regexp_test(mapcss._value_capture(capture_tags, 2, self.re_0c508f2a), mapcss._tag_capture(capture_tags, 2, tags, u'seamark:notice:1:category')))
                except mapcss.RuleAbort: pass
            if not match:
                capture_tags = {}
                try: match = (mapcss._tag_capture(capture_tags, 0, tags, u'seamark:notice:2:system') == mapcss._value_capture(capture_tags, 0, u'cevni') and mapcss._tag_capture(capture_tags, 1, tags, u'seamark:notice:2:function') != mapcss._value_const_capture(capture_tags, 1, u'information', u'information') and mapcss.regexp_test(mapcss._value_capture(capture_tags, 2, self.re_0c508f2a), mapcss._tag_capture(capture_tags, 2, tags, u'seamark:notice:2:category')))
                except mapcss.RuleAbort: pass
            if not match:
                capture_tags = {}
                try: match = (mapcss._tag_capture(capture_tags, 0, tags, u'seamark:notice:3:system') == mapcss._value_capture(capture_tags, 0, u'cevni') and mapcss._tag_capture(capture_tags, 1, tags, u'seamark:notice:3:function') != mapcss._value_const_capture(capture_tags, 1, u'information', u'information') and mapcss.regexp_test(mapcss._value_capture(capture_tags, 2, self.re_0c508f2a), mapcss._tag_capture(capture_tags, 2, tags, u'seamark:notice:3:category')))
                except mapcss.RuleAbort: pass
            if not match:
                capture_tags = {}
                try: match = (mapcss._tag_capture(capture_tags, 0, tags, u'seamark:notice:4:system') == mapcss._value_capture(capture_tags, 0, u'cevni') and mapcss._tag_capture(capture_tags, 1, tags, u'seamark:notice:4:function') != mapcss._value_const_capture(capture_tags, 1, u'information', u'information') and mapcss.regexp_test(mapcss._value_capture(capture_tags, 2, self.re_0c508f2a), mapcss._tag_capture(capture_tags, 2, tags, u'seamark:notice:4:category')))
                except mapcss.RuleAbort: pass
            if not match:
                capture_tags = {}
                try: match = (mapcss._tag_capture(capture_tags, 0, tags, u'seamark:notice:5:system') == mapcss._value_capture(capture_tags, 0, u'cevni') and mapcss._tag_capture(capture_tags, 1, tags, u'seamark:notice:5:function') != mapcss._value_const_capture(capture_tags, 1, u'information', u'information') and mapcss.regexp_test(mapcss._value_capture(capture_tags, 2, self.re_0c508f2a), mapcss._tag_capture(capture_tags, 2, tags, u'seamark:notice:5:category')))
                except mapcss.RuleAbort: pass
            if not match:
                capture_tags = {}
                try: match = (mapcss._tag_capture(capture_tags, 0, tags, u'seamark:notice:6:system') == mapcss._value_capture(capture_tags, 0, u'cevni') and mapcss._tag_capture(capture_tags, 1, tags, u'seamark:notice:6:function') != mapcss._value_const_capture(capture_tags, 1, u'information', u'information') and mapcss.regexp_test(mapcss._value_capture(capture_tags, 2, self.re_0c508f2a), mapcss._tag_capture(capture_tags, 2, tags, u'seamark:notice:6:category')))
                except mapcss.RuleAbort: pass
            if not match:
                capture_tags = {}
                try: match = (mapcss._tag_capture(capture_tags, 0, tags, u'seamark:notice:7:system') == mapcss._value_capture(capture_tags, 0, u'cevni') and mapcss._tag_capture(capture_tags, 1, tags, u'seamark:notice:7:function') != mapcss._value_const_capture(capture_tags, 1, u'information', u'information') and mapcss.regexp_test(mapcss._value_capture(capture_tags, 2, self.re_0c508f2a), mapcss._tag_capture(capture_tags, 2, tags, u'seamark:notice:7:category')))
                except mapcss.RuleAbort: pass
            if not match:
                capture_tags = {}
                try: match = (mapcss._tag_capture(capture_tags, 0, tags, u'seamark:notice:8:system') == mapcss._value_capture(capture_tags, 0, u'cevni') and mapcss._tag_capture(capture_tags, 1, tags, u'seamark:notice:8:function') != mapcss._value_const_capture(capture_tags, 1, u'information', u'information') and mapcss.regexp_test(mapcss._value_capture(capture_tags, 2, self.re_0c508f2a), mapcss._tag_capture(capture_tags, 2, tags, u'seamark:notice:8:category')))
                except mapcss.RuleAbort: pass
            if not match:
                capture_tags = {}
                try: match = (mapcss._tag_capture(capture_tags, 0, tags, u'seamark:notice:9:system') == mapcss._value_capture(capture_tags, 0, u'cevni') and mapcss._tag_capture(capture_tags, 1, tags, u'seamark:notice:9:function') != mapcss._value_const_capture(capture_tags, 1, u'information', u'information') and mapcss.regexp_test(mapcss._value_capture(capture_tags, 2, self.re_0c508f2a), mapcss._tag_capture(capture_tags, 2, tags, u'seamark:notice:9:category')))
                except mapcss.RuleAbort: pass
            if not match:
                capture_tags = {}
                try: match = (mapcss._tag_capture(capture_tags, 0, tags, u'seamark:notice:system') == mapcss._value_capture(capture_tags, 0, u'cevni') and mapcss._tag_capture(capture_tags, 1, tags, u'seamark:notice:function') != mapcss._value_const_capture(capture_tags, 1, u'information', u'information') and mapcss.regexp_test(mapcss._value_capture(capture_tags, 2, self.re_0c508f2a), mapcss._tag_capture(capture_tags, 2, tags, u'seamark:notice:category')))
            ...
            if not match:
                capture_tags = {}
                try: match = (mapcss._tag_capture(capture_tags, 0, tags, u'seamark:notice:1:system') == mapcss._value_capture(capture_tags, 0, u'cevni') and mapcss._tag_capture(capture_tags, 1, tags, u'seamark:notice:1:function') != mapcss._value_const_capture(capture_tags, 1, u'information', u'information') and mapcss._tag_capture(capture_tags, 2, tags, u'seamark:notice:1:category') == mapcss._value_capture(capture_tags, 2, u'berthing_lateral_limit'))
                except mapcss.RuleAbort: pass
            if not match:
                capture_tags = {}
                try: match = (mapcss._tag_capture(capture_tags, 0, tags, u'seamark:notice:2:system') == mapcss._value_capture(capture_tags, 0, u'cevni') and mapcss._tag_capture(capture_tags, 1, tags, u'seamark:notice:2:function') != mapcss._value_const_capture(capture_tags, 1, u'information', u'information') and mapcss._tag_capture(capture_tags, 2, tags, u'seamark:notice:2:category') == mapcss._value_capture(capture_tags, 2, u'berthing_lateral_limit'))
                except mapcss.RuleAbort: pass
            if not match:
                capture_tags = {}
                try: match = (mapcss._tag_capture(capture_tags, 0, tags, u'seamark:notice:3:system') == mapcss._value_capture(capture_tags, 0, u'cevni') and mapcss._tag_capture(capture_tags, 1, tags, u'seamark:notice:3:function') != mapcss._value_const_capture(capture_tags, 1, u'information', u'information') and mapcss._tag_capture(capture_tags, 2, tags, u'seamark:notice:3:category') == mapcss._value_capture(capture_tags, 2, u'berthing_lateral_limit'))
                except mapcss.RuleAbort: pass
            if not match:
                capture_tags = {}
                try: match = (mapcss._tag_capture(capture_tags, 0, tags, u'seamark:notice:4:system') == mapcss._value_capture(capture_tags, 0, u'cevni') and mapcss._tag_capture(capture_tags, 1, tags, u'seamark:notice:4:function') != mapcss._value_const_capture(capture_tags, 1, u'information', u'information') and mapcss._tag_capture(capture_tags, 2, tags, u'seamark:notice:4:category') == mapcss._value_capture(capture_tags, 2, u'berthing_lateral_limit'))
                except mapcss.RuleAbort: pass
            if not match:
                capture_tags = {}
                try: match = (mapcss._tag_capture(capture_tags, 0, tags, u'seamark:notice:5:system') == mapcss._value_capture(capture_tags, 0, u'cevni') and mapcss._tag_capture(capture_tags, 1, tags, u'seamark:notice:5:function') != mapcss._value_const_capture(capture_tags, 1, u'information', u'information') and mapcss._tag_capture(capture_tags, 2, tags, u'seamark:notice:5:category') == mapcss._value_capture(capture_tags, 2, u'berthing_lateral_limit'))
                except mapcss.RuleAbort: pass
            if not match:
                capture_tags = {}
                try: match = (mapcss._tag_capture(capture_tags, 0, tags, u'seamark:notice:6:system') == mapcss._value_capture(capture_tags, 0, u'cevni') and mapcss._tag_capture(capture_tags, 1, tags, u'seamark:notice:6:function') != mapcss._value_const_capture(capture_tags, 1, u'information', u'information') and mapcss._tag_capture(capture_tags, 2, tags, u'seamark:notice:6:category') == mapcss._value_capture(capture_tags, 2, u'berthing_lateral_limit'))
                except mapcss.RuleAbort: pass
            if not match:
                capture_tags = {}
                try: match = (mapcss._tag_capture(capture_tags, 0, tags, u'seamark:notice:7:system') == mapcss._value_capture(capture_tags, 0, u'cevni') and mapcss._tag_capture(capture_tags, 1, tags, u'seamark:notice:7:function') != mapcss._value_const_capture(capture_tags, 1, u'information', u'information') and mapcss._tag_capture(capture_tags, 2, tags, u'seamark:notice:7:category') == mapcss._value_capture(capture_tags, 2, u'berthing_lateral_limit'))
                except mapcss.RuleAbort: pass
            if not match:
                capture_tags = {}
                try: match = (mapcss._tag_capture(capture_tags, 0, tags, u'seamark:notice:8:system') == mapcss._value_capture(capture_tags, 0, u'cevni') and mapcss._tag_capture(capture_tags, 1, tags, u'seamark:notice:8:function') != mapcss._value_const_capture(capture_tags, 1, u'information', u'information') and mapcss._tag_capture(capture_tags, 2, tags, u'seamark:notice:8:category') == mapcss._value_capture(capture_tags, 2, u'berthing_lateral_limit'))
                except mapcss.RuleAbort: pass
            if not match:
                capture_tags = {}
                try: match = (mapcss._tag_capture(capture_tags, 0, tags, u'seamark:notice:9:system') == mapcss._value_capture(capture_tags, 0, u'cevni') and mapcss._tag_capture(capture_tags, 1, tags, u'seamark:notice:9:function') != mapcss._value_const_capture(capture_tags, 1, u'information', u'information') and mapcss._tag_capture(capture_tags, 2, tags, u'seamark:notice:9:category') == mapcss._value_capture(capture_tags, 2, u'berthing_lateral_limit'))
                except mapcss.RuleAbort: pass
            if not match:
                capture_tags = {}
                try: match = (mapcss._tag_capture(capture_tags, 0, tags, u'seamark:notice:system') == mapcss._value_capture(capture_tags, 0, u'bniwr') and mapcss._tag_capture(capture_tags, 1, tags, u'seamark:notice:system') != mapcss._value_const_capture(capture_tags, 1, u'prohibition', u'prohibition') and mapcss.regexp_test(mapcss._value_capture(capture_tags, 2, self.re_7c5430c7), mapcss._tag_capture(capture_tags, 2, tags, u'seamark:notice:category')))
                except mapcss.RuleAbort: pass
            if not match:
                capture_tags = {}
            ...
            if not match:
                capture_tags = {}
                try: match = (mapcss._tag_capture(capture_tags, 0, tags, u'seamark:notice:1:system') == mapcss._value_capture(capture_tags, 0, u'bniwr') and mapcss._tag_capture(capture_tags, 1, tags, u'seamark:notice:1:system') != mapcss._value_const_capture(capture_tags, 1, u'prohibition', u'prohibition') and mapcss.regexp_test(mapcss._value_capture(capture_tags, 2, self.re_7c5430c7), mapcss._tag_capture(capture_tags, 2, tags, u'seamark:notice:1:category')))
                except mapcss.RuleAbort: pass
            if not match:
                capture_tags = {}
            ...
            if not match:
                capture_tags = {}
                try: match = (mapcss._tag_capture(capture_tags, 0, tags, u'seamark:notice:2:system') == mapcss._value_capture(capture_tags, 0, u'bniwr') and mapcss._tag_capture(capture_tags, 1, tags, u'seamark:notice:2:system') != mapcss._value_const_capture(capture_tags, 1, u'prohibition', u'prohibition') and mapcss.regexp_test(mapcss._value_capture(capture_tags, 2, self.re_7c5430c7), mapcss._tag_capture(capture_tags, 2, tags, u'seamark:notice:2:category')))
                except mapcss.RuleAbort: pass
            if not match:
                capture_tags = {}
            ...
            if not match:
                capture_tags = {}
                try: match = (mapcss._tag_capture(capture_tags, 0, tags, u'seamark:notice:system') == mapcss._value_capture(capture_tags, 0, u'bniwr') and mapcss._tag_capture(capture_tags, 1, tags, u'seamark:notice:system') != mapcss._value_const_capture(capture_tags, 1, u'regulation', u'regulation') and mapcss.regexp_test(mapcss._value_capture(capture_tags, 2, self.re_09200db5), mapcss._tag_capture(capture_tags, 2, tags, u'seamark:notice:category')))
                except mapcss.RuleAbort: pass
            if not match:
                capture_tags = {}
                try: match = (mapcss._tag_capture(capture_tags, 0, tags, u'seamark:notice:system') == mapcss._value_capture(capture_tags, 0, u'bniwr2') and mapcss._tag_capture(capture_tags, 1, tags, u'seamark:notice:system') != mapcss._value_const_capture(capture_tags, 1, u'regulation', u'regulation') and mapcss.regexp_test(mapcss._value_capture(capture_tags, 2, self.re_09200db5), mapcss._tag_capture(capture_tags, 2, tags, u'seamark:notice:category')))
            ...
            if not match:
                capture_tags = {}
                try: match = (mapcss._tag_capture(capture_tags, 0, tags, u'seamark:notice:1:system') == mapcss._value_capture(capture_tags, 0, u'bniwr') and mapcss._tag_capture(capture_tags, 1, tags, u'seamark:notice:1:system') != mapcss._value_const_capture(capture_tags, 1, u'regulation', u'regulation') and mapcss.regexp_test(mapcss._value_capture(capture_tags, 2, self.re_09200db5), mapcss._tag_capture(capture_tags, 2, tags, u'seamark:notice:1:category')))
                except mapcss.RuleAbort: pass
            if not match:
                capture_tags = {}
                try: match = (mapcss._tag_capture(capture_tags, 0, tags, u'seamark:notice:1:system') == mapcss._value_capture(capture_tags, 0, u'bniwr2') and mapcss._tag_capture(capture_tags, 1, tags, u'seamark:notice:1:system') != mapcss._value_const_capture(capture_tags, 1, u'regulation', u'regulation') and mapcss.regexp_test(mapcss._value_capture(capture_tags, 2, self.re_09200db5), mapcss._tag_capture(capture_tags, 2, tags, u'seamark:notice:1:category')))
            ...
            if not match:
                capture_tags = {}
                try: match = (mapcss._tag_capture(capture_tags, 0, tags, u'seamark:notice:2:system') == mapcss._value_capture(capture_tags, 0, u'bniwr') and mapcss._tag_capture(capture_tags, 1, tags, u'seamark:notice:2:system') != mapcss._value_const_capture(capture_tags, 1, u'regulation', u'regulation') and mapcss.regexp_test(mapcss._value_capture(capture_tags, 2, self.re_09200db5), mapcss._tag_capture(capture_tags, 2, tags, u'seamark:notice:2:category')))
                except mapcss.RuleAbort: pass
            if not match:
                capture_tags = {}
                try: match = (mapcss._tag_capture(capture_tags, 0, tags, u'seamark:notice:2:system') == mapcss._value_capture(capture_tags, 0, u'bniwr2') and mapcss._tag_capture(capture_tags, 1, tags, u'seamark:notice:2:system') != mapcss._value_const_capture(capture_tags, 1, u'regulation', u'regulation') and mapcss.regexp_test(mapcss._value_capture(capture_tags, 2, self.re_09200db5), mapcss._tag_capture(capture_tags, 2, tags, u'seamark:notice:2:category')))
            ...
            if not match:
                capture_tags = {}
                try: match = (mapcss._tag_capture(capture_tags, 0, tags, u'seamark:notice:system') == mapcss._value_capture(capture_tags, 0, u'bniwr') and mapcss._tag_capture(capture_tags, 1, tags, u'seamark:notice:system') != mapcss._value_const_capture(capture_tags, 1, u'restriction', u'restriction') and mapcss.regexp_test(mapcss._value_capture(capture_tags, 2, self.re_39084725), mapcss._tag_capture(capture_tags, 2, tags, u'seamark:notice:category')))
                except mapcss.RuleAbort: pass
            if not match:
                capture_tags = {}
                try: match = (mapcss._tag_capture(capture_tags, 0, tags, u'seamark:notice:system') == mapcss._value_capture(capture_tags, 0, u'bniwr2') and mapcss._tag_capture(capture_tags, 1, tags, u'seamark:notice:system') != mapcss._value_const_capture(capture_tags, 1, u'restriction', u'restriction') and mapcss.regexp_test(mapcss._value_capture(capture_tags, 2, self.re_39084725), mapcss._tag_capture(capture_tags, 2, tags, u'seamark:notice:category')))
            ...
            if not match:
                capture_tags = {}
                try: match = (mapcss._tag_capture(capture_tags, 0, tags, u'seamark:notice:1:system') == mapcss._value_capture(capture_tags, 0, u'bniwr') and mapcss._tag_capture(capture_tags, 1, tags, u'seamark:notice:1:system') != mapcss._value_const_capture(capture_tags, 1, u'restriction', u'restriction') and mapcss.regexp_test(mapcss._value_capture(capture_tags, 2, self.re_39084725), mapcss._tag_capture(capture_tags, 2, tags, u'seamark:notice:1:category')))
                except mapcss.RuleAbort: pass
            if not match:
                capture_tags = {}
                try: match = (mapcss._tag_capture(capture_tags, 0, tags, u'seamark:notice:1:system') == mapcss._value_capture(capture_tags, 0, u'bniwr2') and mapcss._tag_capture(capture_tags, 1, tags, u'seamark:notice:1:system') != mapcss._value_const_capture(capture_tags, 1, u'restriction', u'restriction') and mapcss.regexp_test(mapcss._value_capture(capture_tags, 2, self.re_39084725), mapcss._tag_capture(capture_tags, 2, tags, u'seamark:notice:1:category')))
            ...
            if not match:
                capture_tags = {}
                try: match = (mapcss._tag_capture(capture_tags, 0, tags, u'seamark:notice:2:system') == mapcss._value_capture(capture_tags, 0, u'bniwr') and mapcss._tag_capture(capture_tags, 1, tags, u'seamark:notice:2:system') != mapcss._value_const_capture(capture_tags, 1, u'restriction', u'restriction') and mapcss.regexp_test(mapcss._value_capture(capture_tags, 2, self.re_39084725), mapcss._tag_capture(capture_tags, 2, tags, u'seamark:notice:2:category')))
                except mapcss.RuleAbort: pass
            if not match:
                capture_tags = {}
                try: match = (mapcss._tag_capture(capture_tags, 0, tags, u'seamark:notice:2:system') == mapcss._value_capture(capture_tags, 0, u'bniwr2') and mapcss._tag_capture(capture_tags, 1, tags, u'seamark:notice:2:system') != mapcss._value_const_capture(capture_tags, 1, u'restriction', u'restriction') and mapcss.regexp_test(mapcss._value_capture(capture_tags, 2, self.re_39084725), mapcss._tag_capture(capture_tags, 2, tags, u'seamark:notice:2:category')))
            ...
            if not match:
                capture_tags = {}
                try: match = (mapcss._tag_capture(capture_tags, 0, tags, u'seamark:notice:system') == mapcss._value_capture(capture_tags, 0, u'bniwr') and mapcss._tag_capture(capture_tags, 1, tags, u'seamark:notice:system') != mapcss._value_const_capture(capture_tags, 1, u'recommendation', u'recommendation') and mapcss.regexp_test(mapcss._value_capture(capture_tags, 2, self.re_09c0bae9), mapcss._tag_capture(capture_tags, 2, tags, u'seamark:notice:category')))
                except mapcss.RuleAbort: pass
            if not match:
                capture_tags = {}
                try: match = (mapcss._tag_capture(capture_tags, 0, tags, u'seamark:notice:system') == mapcss._value_capture(capture_tags, 0, u'bniwr2') and mapcss._tag_capture(capture_tags, 1, tags, u'seamark:notice:system') != mapcss._value_const_capture(capture_tags, 1, u'recommendation', u'recommendation') and mapcss.regexp_test(mapcss._value_capture(capture_tags, 2, self.re_09c0bae9), mapcss._tag_capture(capture_tags, 2, tags, u'seamark:notice:category')))
            ...
            if not match:
                capture_tags = {}
                try: match = (mapcss._tag_capture(capture_tags, 0, tags, u'seamark:notice:1:system') == mapcss._value_capture(capture_tags, 0, u'bniwr') and mapcss._tag_capture(capture_tags, 1, tags, u'seamark:notice:1:system') != mapcss._value_const_capture(capture_tags, 1, u'recommendation', u'recommendation') and mapcss.regexp_test(mapcss._value_capture(capture_tags, 2, self.re_09c0bae9), mapcss._tag_capture(capture_tags, 2, tags, u'seamark:notice:1:category')))
                except mapcss.RuleAbort: pass
            if not match:
                capture_tags = {}
                try: match = (mapcss._tag_capture(capture_tags, 0, tags, u'seamark:notice:1:system') == mapcss._value_capture(capture_tags, 0, u'bniwr2') and mapcss._tag_capture(capture_tags, 1, tags, u'seamark:notice:1:system') != mapcss._value_const_capture(capture_tags, 1, u'recommendation', u'recommendation') and mapcss.regexp_test(mapcss._value_capture(capture_tags, 2, self.re_09c0bae9), mapcss._tag_capture(capture_tags, 2, tags, u'seamark:notice:1:category')))
            ...
            if not match:
                capture_tags = {}
                try: match = (mapcss._tag_capture(capture_tags, 0, tags, u'seamark:notice:2:system') == mapcss._value_capture(capture_tags, 0, u'bniwr') and mapcss._tag_capture(capture_tags, 1, tags, u'seamark:notice:2:system') != mapcss._value_const_capture(capture_tags, 1, u'recommendation', u'recommendation') and mapcss.regexp_test(mapcss._value_capture(capture_tags, 2, self.re_09c0bae9), mapcss._tag_capture(capture_tags, 2, tags, u'seamark:notice:2:category')))
                except mapcss.RuleAbort: pass
            if not match:
                capture_tags = {}
                try: match = (mapcss._tag_capture(capture_tags, 0, tags, u'seamark:notice:2:system') == mapcss._value_capture(capture_tags, 0, u'bniwr2') and mapcss._tag_capture(capture_tags, 1, tags, u'seamark:notice:2:system') != mapcss._value_const_capture(capture_tags, 1, u'recommendation', u'recommendation') and mapcss.regexp_test(mapcss._value_capture(capture_tags, 2, self.re_09c0bae9), mapcss._tag_capture(capture_tags, 2, tags, u'seamark:notice:2:category')))
            ...
            if not match:
                capture_tags = {}
                try: match = (mapcss._tag_capture(capture_tags, 0, tags, u'seamark:notice:system') == mapcss._value_capture(capture_tags, 0, u'bniwr') and mapcss._tag_capture(capture_tags, 1, tags, u'seamark:notice:system') != mapcss._value_const_capture(capture_tags, 1, u'information', u'information') and mapcss.regexp_test(mapcss._value_capture(capture_tags, 2, self.re_430e795b), mapcss._tag_capture(capture_tags, 2, tags, u'seamark:notice:category')))
                except mapcss.RuleAbort: pass
            if not match:
                capture_tags = {}
                try: match = (mapcss._tag_capture(capture_tags, 0, tags, u'seamark:notice:system') == mapcss._value_capture(capture_tags, 0, u'bniwr2') and mapcss._tag_capture(capture_tags, 1, tags, u'seamark:notice:system') != mapcss._value_const_capture(capture_tags, 1, u'information', u'information') and mapcss.regexp_test(mapcss._value_capture(capture_tags, 2, self.re_430e795b), mapcss._tag_capture(capture_tags, 2, tags, u'seamark:notice:category')))
            ...
            if not match:
                capture_tags = {}
                try: match = (mapcss._tag_capture(capture_tags, 0, tags, u'seamark:notice:1:system') == mapcss._value_capture(capture_tags, 0, u'bniwr') and mapcss._tag_capture(capture_tags, 1, tags, u'seamark:notice:1:system') != mapcss._value_const_capture(capture_tags, 1, u'information', u'information') and mapcss.regexp_test(mapcss._value_capture(capture_tags, 2, self.re_430e795b), mapcss._tag_capture(capture_tags, 2, tags, u'seamark:notice:1:category')))
                except mapcss.RuleAbort: pass
            if not match:
                capture_tags = {}
                try: match = (mapcss._tag_capture(capture_tags, 0, tags, u'seamark:notice:1:system') == mapcss._value_capture(capture_tags, 0, u'bniwr2') and mapcss._tag_capture(capture_tags, 1, tags, u'seamark:notice:1:system') != mapcss._value_const_capture(capture_tags, 1, u'information', u'information') and mapcss.regexp_test(mapcss._value_capture(capture_tags, 2, self.re_430e795b), mapcss._tag_capture(capture_tags, 2, tags, u'seamark:notice:1:category')))
            ...
            if not match:
                capture_tags = {}
                try: match = (mapcss._tag_capture(capture_tags, 0, tags, u'seamark:notice:2:system') == mapcss._value_capture(capture_tags, 0, u'bniwr') and mapcss._tag_capture(capture_tags, 1, tags, u'seamark:notice:2:system') != mapcss._value_const_capture(capture_tags, 1, u'information', u'information') and mapcss.regexp_test(mapcss._value_capture(capture_tags, 2, self.re_430e795b), mapcss._tag_capture(capture_tags, 2, tags, u'seamark:notice:2:category')))
                except mapcss.RuleAbort: pass
            if not match:
                capture_tags = {}
                try: match = (mapcss._tag_capture(capture_tags, 0, tags, u'seamark:notice:2:system') == mapcss._value_capture(capture_tags, 0, u'bniwr2') and mapcss._tag_capture(capture_tags, 1, tags, u'seamark:notice:2:system') != mapcss._value_const_capture(capture_tags, 1, u'information', u'information') and mapcss.regexp_test(mapcss._value_capture(capture_tags, 2, self.re_430e795b), mapcss._tag_capture(capture_tags, 2, tags, u'seamark:notice:2:category')))
            ...
            if not match:
                capture_tags = {}
                try: match = (mapcss._tag_capture(capture_tags, 0, tags, u'seamark:notice:system') == mapcss._value_capture(capture_tags, 0, u'ppwbc') and mapcss._tag_capture(capture_tags, 1, tags, u'seamark:notice:system') != mapcss._value_const_capture(capture_tags, 1, u'regulation', u'regulation') and mapcss.regexp_test(mapcss._value_capture(capture_tags, 2, self.re_0b7ab6fc), mapcss._tag_capture(capture_tags, 2, tags, u'seamark:notice:category')))
                except mapcss.RuleAbort: pass
            if not match:
                capture_tags = {}
                try: match = (mapcss._tag_capture(capture_tags, 0, tags, u'seamark:notice:1:system') == mapcss._value_capture(capture_tags, 0, u'ppwbc') and mapcss._tag_capture(capture_tags, 1, tags, u'seamark:notice:1:system') != mapcss._value_const_capture(capture_tags, 1, u'regulation', u'regulation') and mapcss.regexp_test(mapcss._value_capture(capture_tags, 2, self.re_0b7ab6fc), mapcss._tag_capture(capture_tags, 2, tags, u'seamark:notice:1:category')))
                except mapcss.RuleAbort: pass
            if not match:
                capture_tags = {}
                try: match = (mapcss._tag_capture(capture_tags, 0, tags, u'seamark:notice:2:system') == mapcss._value_capture(capture_tags, 0, u'ppwbc') and mapcss._tag_capture(capture_tags, 1, tags, u'seamark:notice:2:system') != mapcss._value_const_capture(capture_tags, 1, u'regulation', u'regulation') and mapcss.regexp_test(mapcss._value_capture(capture_tags, 2, self.re_0b7ab6fc), mapcss._tag_capture(capture_tags, 2, tags, u'seamark:notice:2:category')))
                except mapcss.RuleAbort: pass
            if not match:
                capture_tags = {}
                try: match = (mapcss._tag_capture(capture_tags, 0, tags, u'seamark:notice:system') == mapcss._value_capture(capture_tags, 0, u'ppwbc') and mapcss._tag_capture(capture_tags, 1, tags, u'seamark:notice:system') != mapcss._value_const_capture(capture_tags, 1, u'information', u'information') and mapcss.regexp_test(mapcss._value_capture(capture_tags, 2, self.re_2a269778), mapcss._tag_capture(capture_tags, 2, tags, u'seamark:notice:category')))
                except mapcss.RuleAbort: pass
            if not match:
                capture_tags = {}
                try: match = (mapcss._tag_capture(capture_tags, 0, tags, u'seamark:notice:1:system') == mapcss._value_capture(capture_tags, 0, u'ppwbc') and mapcss._tag_capture(capture_tags, 1, tags, u'seamark:notice:1:system') != mapcss._value_const_capture(capture_tags, 1, u'information', u'information') and mapcss.regexp_test(mapcss._value_capture(capture_tags, 2, self.re_2a269778), mapcss._tag_capture(capture_tags, 2, tags, u'seamark:notice:1:category')))
                except mapcss.RuleAbort: pass
            if not match:
                capture_tags = {}
                try: match = (mapcss._tag_capture(capture_tags, 0, tags, u'seamark:notice:2:system') == mapcss._value_capture(capture_tags, 0, u'ppwbc') and mapcss._tag_capture(capture_tags, 1, tags, u'seamark:notice:2:system') != mapcss._value_const_capture(capture_tags, 1, u'information', u'information') and mapcss.regexp_test(mapcss._value_capture(capture_tags, 2, self.re_2a269778), mapcss._tag_capture(capture_tags, 2, tags, u'seamark:notice:2:category')))
                except mapcss.RuleAbort: pass
            if match:
                # throwWarning:tr("In {0} {1}={2} require {3}={4}","{0.value}","{2.key}","{2.value}","{1.key}","{1.value}")
                err.append({'class': 9012009, 'subclass': 196951708, 'text': mapcss.tr(u'In {0} {1}={2} require {3}={4}', mapcss._tag_uncapture(capture_tags, u'{0.value}'), mapcss._tag_uncapture(capture_tags, u'{2.key}'), mapcss._tag_uncapture(capture_tags, u'{2.value}'), mapcss._tag_uncapture(capture_tags, u'{1.key}'), mapcss._tag_uncapture(capture_tags, u'{1.value}'))})
        ...
        if (u'seamark:notice:1:system' in keys) or (u'seamark:notice:2:system' in keys) or (u'seamark:notice:system' in keys):
            ...
            if not match:
                capture_tags = {}
                try: match = (mapcss.regexp_test(mapcss._value_capture(capture_tags, 0, self.re_0e114cad), mapcss._tag_capture(capture_tags, 0, tags, u'seamark:notice:system')) and not mapcss.regexp_test(mapcss._value_const_capture(capture_tags, 1, self.re_01dd9715, u'right|left'), mapcss._tag_capture(capture_tags, 1, tags, u'seamark:notice:bank')))
                except mapcss.RuleAbort: pass
            if not match:
                capture_tags = {}
