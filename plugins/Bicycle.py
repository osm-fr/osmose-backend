...
class Test(TestPluginCommon):
    def test(self):
        ...
        self.check_err(n.way(data, {'cycleway': 'a', 'cycleway:left': 'c', 'cycleway:right': 'b'}, [0]), expected={'class': 40301, 'subclass': 0}, disallowed_str_in_text = ['{', '}'])
        ...
        self.check_err(n.way(data, {'footway': 'sidewalk', 'highway': 'path'}, [0]), expected={'class': 20805, 'subclass': 0}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.way(data, {'highway': 'service', 'psv': 'no', 'service': 'psv'}, [0]), expected={'class': 40101, 'subclass': 0}, disallowed_str_in_text = ['{', '}'])
        ...
        self.check_err(n.way(data, {'bicycle': 'no', 'cycleway': 'track'}, [0]), expected={'class': 30329, 'subclass': 0}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.way(data, {'bicycle': 'use_sidepath', 'cycleway:left': 'lane'}, [0]), expected={'class': 30329, 'subclass': 0}, disallowed_str_in_text = ['{', '}'])
        ...
        self.check_err(n.way(data, {'cycleway': 'opposite'}, [0]), expected={'class': 20301, 'subclass': 0}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.way(data, {'cycleway:right': 'opposite', 'oneway': 'yes'}, [0]), expected={'class': 20302, 'subclass': 0}, disallowed_str_in_text = ['{', '}'])
