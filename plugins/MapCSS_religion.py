...
class MapCSS_religion(Plugin):

    def init(self, logger):
        Plugin.init(self, logger)
        tags = capture_tags = {}
        self.errors[9008001] = {'item': 9008, 'level': 3, 'tag': [], 'desc': mapcss.tr(capture_tags, u'missing tag')}
        self.errors[9008002] = {'item': 9008, 'level': 3, 'tag': [], 'desc': mapcss.tr(capture_tags, u'unknown christian denomination')}
        self.errors[9008003] = {'item': 9008, 'level': 3, 'tag': [], 'desc': mapcss.tr(capture_tags, u'unknown muslim denomination')}
        self.errors[9008004] = {'item': 9008, 'level': 3, 'tag': [], 'desc': mapcss.tr(capture_tags, u'unknown jewish denomination')}
