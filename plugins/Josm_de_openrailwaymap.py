...
class Test(TestPluginCommon):
    def test(self):
        ...
        self.check_not_err(n.node(data, {'railway': 'signal', 'railway:signal:main': 'DE-ESO:hl', 'railway:signal:main:form': 'light'}), expected={'class': 9016030, 'subclass': 64936959}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.node(data, {'railway': 'signal', 'railway:signal:main': 'DE-ESO:hl', 'railway:signal:main:form': 'semaphore'}), expected={'class': 9016030, 'subclass': 64936959}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.node(data, {'railway': 'signal', 'railway:signal:main': 'DE-ESO:hl'}), expected={'class': 9016030, 'subclass': 64936959}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.node(data, {'railway': 'signal', 'railway:signal:main': 'DE-ESO:ks', 'railway:signal:main:form': 'light'}), expected={'class': 9016030, 'subclass': 64936959}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.node(data, {'railway': 'signal', 'railway:signal:main': 'DE-ESO:ks', 'railway:signal:main:form': 'semaphore'}), expected={'class': 9016030, 'subclass': 64936959}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.node(data, {'railway': 'signal', 'railway:signal:main': 'DE-ESO:ks'}), expected={'class': 9016030, 'subclass': 64936959}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.node(data, {'railway': 'signal', 'railway:signal:main': 'DE-ESO:hp', 'railway:signal:main:form': 'light'}), expected={'class': 9016002, 'subclass': 1455678760}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.node(data, {'railway': 'signal', 'railway:signal:main': 'DE-ESO:hp', 'railway:signal:main:form': 'semaphore'}), expected={'class': 9016002, 'subclass': 1455678760}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.node(data, {'railway': 'signal', 'railway:signal:main': 'DE-ESO:hp', 'railway:signal:main:form': 'typo'}), expected={'class': 9016002, 'subclass': 1455678760}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.node(data, {'railway': 'signal', 'railway:signal:main': 'DE-ESO:hp'}), expected={'class': 9016002, 'subclass': 1455678760}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.node(data, {'railway': 'signal', 'railway:signal:combined': 'DE-KVB:hp', 'railway:signal:combined:form': 'light'}), expected={'class': 9016003, 'subclass': 1610282655}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.node(data, {'railway': 'signal', 'railway:signal:combined': 'DE-KVB:hp', 'railway:signal:combined:form': 'light'}), expected={'class': 9016003, 'subclass': 1610282655}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.node(data, {'railway': 'signal', 'railway:signal:combined': 'DE-KVB:hp', 'railway:signal:combined:form': 'semaphore'}), expected={'class': 9016003, 'subclass': 1610282655}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.node(data, {'railway': 'signal', 'railway:signal:combined': 'DE-KVB:hp', 'railway:signal:combined:form': 'typo'}), expected={'class': 9016003, 'subclass': 1610282655}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.node(data, {'railway': 'signal', 'railway:signal:combined': 'DE-KVB:hp'}), expected={'class': 9016003, 'subclass': 1610282655}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.node(data, {'railway': 'signal', 'railway:signal:distant': 'DE-ESO:vr', 'railway:signal:distant:form': 'light', 'railway:signal:distant:repeated': 'yes'}), expected={'class': 9016004, 'subclass': 377147416}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.node(data, {'railway': 'signal', 'railway:signal:distant': 'DE-ESO:vr', 'railway:signal:distant:form': 'semaphore', 'railway:signal:distant:repeated': 'yes'}), expected={'class': 9016004, 'subclass': 377147416}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.node(data, {'railway': 'signal', 'railway:signal:distant': 'DE-ESO:vr', 'railway:signal:distant:repeated': 'yes'}), expected={'class': 9016004, 'subclass': 377147416}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.node(data, {'railway': 'derail', 'railway:signal:minor:states': 'DE-ESO:sh0;DE-ESO:gsp2'}), expected={'class': 9016005, 'subclass': 931682141}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.node(data, {'railway': 'derail', 'railway:signal:minor:states': 'DE-ESO:sh0;DE-ESO:sh1'}), expected={'class': 9016005, 'subclass': 931682141}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.node(data, {'railway': 'derail', 'railway:signal:minor:states': 'DE-ESO:sh0;DE-ESO:wn7'}), expected={'class': 9016005, 'subclass': 931682141}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.node(data, {'railway': 'signal', 'railway:signal:minor:states': 'sh0;gsp2'}), expected={'class': 9016005, 'subclass': 931682141}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.node(data, {'railway': 'signal', 'railway:signal:main': 'DE-ESO:hp'}), expected={'class': 9016006, 'subclass': 1157239794}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.node(data, {'railway': 'signal', 'railway:signal:train_protection': 'DE-ESO:ne14', 'railway:signal:train_protection:type': 'block_marker'}), expected={'class': 9016006, 'subclass': 1157239794}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.node(data, {'railway': 'signal', 'railway:signal:train_protection': 'DE-ESO:ne14'}), expected={'class': 9016006, 'subclass': 1157239794}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.node(data, {'railway': 'signal', 'railway:signal:distant': 'DE-ESO:vr', 'railway:signal:distant:repeated': 'yes'}), expected={'class': 9016007, 'subclass': 1775285105}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.node(data, {'railway': 'signal', 'railway:signal:distant': 'DE-ESO:vr', 'railway:signal:distant:repeated': 'no', 'railway:signal:main': 'DE-ESO:hp'}), expected={'class': 9016007, 'subclass': 1775285105}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.node(data, {'railway': 'signal', 'railway:signal:distant': 'DE-ESO:vr', 'railway:signal:distant:repeated': 'yes', 'railway:signal:main': 'DE-ESO:hp', 'railway:signal:main:states': 'DE-ESO:hp0;DE-ESO:hp1'}), expected={'class': 9016007, 'subclass': 1775285105}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.node(data, {'railway': 'signal', 'railway:signal:distant': 'DE-ESO:vr', 'railway:signal:distant:repeated': 'yes', 'railway:signal:distant:shortened': 'yes', 'railway:signal:main': 'DE-ESO:hp', 'railway:signal:main:states': 'DE-ESO:hp0;DE-ESO:kennlicht'}), expected={'class': 9016007, 'subclass': 1775285105}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.node(data, {'railway': 'signal', 'railway:signal:distant': 'DE-ESO:vr', 'railway:signal:distant:repeated': 'yes', 'railway:signal:main': 'DE-ESO:hp'}), expected={'class': 9016007, 'subclass': 1775285105}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.node(data, {'railway': 'signal', 'railway:signal:distant': 'DE-ESO:vr', 'railway:signal:main': 'DE-ESO:hp'}), expected={'class': 9016007, 'subclass': 1775285105}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.node(data, {'railway': 'signal', 'railway:signal:distant': 'DE-ESO:ks', 'railway:signal:distant:repeated': 'yes', 'railway:signal:distant:shortened': 'yes'}), expected={'class': 9016008, 'subclass': 331861787}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.node(data, {'railway': 'signal', 'railway:signal:distant': 'DE-ESO:vr', 'railway:signal:distant:repeated': 'yes', 'railway:signal:distant:shortened': 'yes', 'railway:signal:main': 'DE-ESO:hp', 'railway:signal:main:states': 'DE-ESO:hp0;DE-ESO:hp1'}), expected={'class': 9016008, 'subclass': 331861787}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.node(data, {'railway': 'signal', 'railway:signal:distant': 'DE-ESO:vr', 'railway:signal:distant:repeated': 'yes', 'railway:signal:distant:shortened': 'yes', 'railway:signal:main': 'DE-ESO:hp'}), expected={'class': 9016008, 'subclass': 331861787}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.node(data, {'railway': 'signal', 'railway:signal:distant': 'DE-ESO:vr', 'railway:signal:distant:repeated': 'yes', 'railway:signal:distant:shortened': 'yes'}), expected={'class': 9016008, 'subclass': 331861787}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.node(data, {'railway': 'signal', 'railway:signal:distant:repeated': 'yes', 'railway:signal:distant:shortened': 'yes', 'railway:signal:main': 'DE-ESO:hl'}), expected={'class': 9016008, 'subclass': 331861787}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.node(data, {'railway': 'signal', 'railway:signal:distant': 'DE-ESO:ks', 'railway:signal:distant:repeated': 'yes'}), expected={'class': 9016008, 'subclass': 331861787}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.node(data, {'railway': 'signal', 'railway:signal:distant': 'DE-ESO:ks', 'railway:signal:distant:shortened': 'yes'}), expected={'class': 9016008, 'subclass': 331861787}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.node(data, {'railway': 'signal', 'railway:signal:distant': 'DE-ESO:vr', 'railway:signal:distant:repeated': 'yes', 'railway:signal:distant:shortened': 'yes', 'railway:signal:main': 'DE-ESO:hp', 'railway:signal:main:states': 'DE-ESO:kennlicht;DE-ESO:hp1'}), expected={'class': 9016008, 'subclass': 331861787}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.node(data, {'railway': 'signal', 'railway:signal:distant': 'DE-ESO:vr', 'railway:signal:distant:repeated': 'yes'}), expected={'class': 9016008, 'subclass': 331861787}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.node(data, {'railway': 'signal', 'railway:signal:distant': 'DE-ESO:vr', 'railway:signal:distant:shortened': 'yes'}), expected={'class': 9016008, 'subclass': 331861787}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.node(data, {'railway': 'signal', 'railway:signal:combined': 'DE-ESO:ks', 'railway:signal:minor': 'DE-ESO:sh1'}), expected={'class': 9016009, 'subclass': 832014689}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.node(data, {'railway': 'signal', 'railway:signal:distant': 'DE-ESO:vr', 'railway:signal:main': 'DE-ESO:hp'}), expected={'class': 9016009, 'subclass': 832014689}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.node(data, {'railway': 'signal', 'railway:signal:distant': 'DE-ESO:ks', 'railway:signal:main': 'DE-ESO:hp'}), expected={'class': 9016009, 'subclass': 832014689}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.node(data, {'railway': 'signal', 'railway:signal:distant': 'DE-ESO:vr', 'railway:signal:main': 'DE-ESO:ks'}), expected={'class': 9016009, 'subclass': 832014689}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.node(data, {'railway': 'signal', 'railway:signal:minor': 'DE-ESO:sh', 'railway:signal:minor:form': 'light', 'railway:signal:minor:states': 'DE-ESO:hp0'}), expected={'class': 9016010, 'subclass': 1342331763}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.node(data, {'railway': 'signal', 'railway:signal:minor': 'DE-ESO:sh', 'railway:signal:minor:form': 'light', 'railway:signal:minor:states': 'DE-ESO:hp0;DE-ESO:sh1'}), expected={'class': 9016010, 'subclass': 1342331763}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.node(data, {'railway': 'signal', 'railway:signal:minor': 'DE-ESO:sh', 'railway:signal:minor:form': 'semaphore', 'railway:signal:minor:states': 'DE-ESO:hp0'}), expected={'class': 9016010, 'subclass': 1342331763}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.node(data, {'railway': 'signal', 'railway:signal:minor': 'DE-ESO:sh', 'railway:signal:minor:form': 'semaphore', 'railway:signal:minor:states': 'DE-ESO:hp0;DE-ESO:sh1'}), expected={'class': 9016010, 'subclass': 1342331763}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.node(data, {'railway': 'signal', 'railway:signal:minor': 'DE-ESO:sh', 'railway:signal:minor:form': 'semaphore', 'railway:signal:minor:states': 'DE-ESO:sh0'}), expected={'class': 9016010, 'subclass': 1342331763}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.node(data, {'railway': 'signal', 'railway:signal:minor': 'DE-ESO:sh', 'railway:signal:minor:form': 'semaphore', 'railway:signal:minor:states': 'DE-ESO:sh0;DE-ESO:sh1'}), expected={'class': 9016010, 'subclass': 1342331763}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.node(data, {'railway': 'signal', 'railway:signal:minor': 'DE-ESO:sh', 'railway:signal:minor:form': 'light', 'railway:signal:minor:states': 'DE-ESO:hp0'}), expected={'class': 9016011, 'subclass': 1627617188}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.node(data, {'railway': 'signal', 'railway:signal:minor': 'DE-ESO:sh', 'railway:signal:minor:form': 'light', 'railway:signal:minor:states': 'DE-ESO:hp0;DE-ESO:sh1'}), expected={'class': 9016011, 'subclass': 1627617188}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.node(data, {'railway': 'signal', 'railway:signal:minor': 'DE-ESO:sh', 'railway:signal:minor:form': 'light', 'railway:signal:minor:states': 'DE-ESO:sh0'}), expected={'class': 9016011, 'subclass': 1627617188}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.node(data, {'railway': 'signal', 'railway:signal:minor': 'DE-ESO:sh', 'railway:signal:minor:form': 'light', 'railway:signal:minor:states': 'DE-ESO:sh0;DE-ESO:sh1'}), expected={'class': 9016011, 'subclass': 1627617188}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.node(data, {'railway': 'signal', 'railway:signal:minor': 'DE-ESO:sh', 'railway:signal:minor:form': 'semaphore', 'railway:signal:minor:states': 'DE-ESO:sh0'}), expected={'class': 9016011, 'subclass': 1627617188}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.node(data, {'railway': 'signal', 'railway:signal:minor': 'DE-ESO:sh', 'railway:signal:minor:form': 'semaphore', 'railway:signal:minor:states': 'DE-ESO:sh0;DE-ESO:sh1'}), expected={'class': 9016011, 'subclass': 1627617188}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.node(data, {'railway': 'signal', 'railway:signal:speed_limit_distant': 'DE-ESO:zs3v', 'railway:signal:speed_limit_distant:form': 'light', 'railway:signal:speed_limit_distant:speed': '80;90'}), expected={'class': 9016012, 'subclass': 1868832018}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.node(data, {'railway': 'signal', 'railway:signal:speed_limit_distant': 'DE-ESO:zs3v', 'railway:signal:speed_limit_distant:form': 'light', 'railway:signal:speed_limit_distant:speed': '87'}), expected={'class': 9016012, 'subclass': 1868832018}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.node(data, {'railway': 'signal', 'railway:signal:speed_limit_distant': 'DE-ESO:zs3v', 'railway:signal:speed_limit_distant:form': 'light', 'railway:signal:speed_limit_distant:speed': 'foo'}), expected={'class': 9016012, 'subclass': 1868832018}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.node(data, {'railway': 'signal', 'railway:signal:speed_limit_distant': 'DE-ESO:zs3v', 'railway:signal:speed_limit_distant:form': 'sign', 'railway:signal:speed_limit_distant:speed': '80;90'}), expected={'class': 9016012, 'subclass': 1868832018}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.node(data, {'railway': 'signal', 'railway:signal:speed_limit_distant': 'DE-ESO:zs3v', 'railway:signal:speed_limit_distant:form': 'sign', 'railway:signal:speed_limit_distant:speed': '05'}), expected={'class': 9016012, 'subclass': 1868832018}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.node(data, {'railway': 'signal', 'railway:signal:speed_limit_distant': 'DE-ESO:zs3v', 'railway:signal:speed_limit_distant:form': 'sign', 'railway:signal:speed_limit_distant:speed': '200'}), expected={'class': 9016012, 'subclass': 1868832018}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.node(data, {'railway': 'signal', 'railway:signal:speed_limit_distant': 'DE-ESO:zs3v', 'railway:signal:speed_limit_distant:form': 'sign', 'railway:signal:speed_limit_distant:speed': '5'}), expected={'class': 9016012, 'subclass': 1868832018}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.node(data, {'railway': 'signal', 'railway:signal:speed_limit_distant': 'DE-ESO:zs3v', 'railway:signal:speed_limit_distant:form': 'sign', 'railway:signal:speed_limit_distant:speed': '80'}), expected={'class': 9016012, 'subclass': 1868832018}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.node(data, {'railway': 'signal', 'railway:signal:speed_limit_distant': 'DE-ESO:zs3v', 'railway:signal:speed_limit_distant:form': 'sign', 'railway:signal:speed_limit_distant:speed': '85'}), expected={'class': 9016012, 'subclass': 1868832018}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.node(data, {'railway': 'signal', 'railway:signal:speed_limit_distant': 'DE-ESO:zs3v', 'railway:signal:speed_limit_distant:form': 'sign', 'railway:signal:speed_limit_distant:speed': '87'}), expected={'class': 9016012, 'subclass': 1868832018}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.node(data, {'railway': 'signal', 'railway:signal:speed_limit_distant': 'DE-ESO:zs3v', 'railway:signal:speed_limit_distant:form': 'sign', 'railway:signal:speed_limit_distant:speed': '?'}), expected={'class': 9016012, 'subclass': 1868832018}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.node(data, {'railway': 'signal', 'railway:signal:speed_limit_distant': 'DE-ESO:zs3v', 'railway:signal:speed_limit_distant:form': 'sign', 'railway:signal:speed_limit_distant:speed': 'foo'}), expected={'class': 9016012, 'subclass': 1868832018}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.node(data, {'railway': 'signal', 'railway:signal:speed_limit': 'DE-ESO:zs3', 'railway:signal:speed_limit:form': 'light', 'railway:signal:speed_limit:speed': '80;90'}), expected={'class': 9016013, 'subclass': 1804825947}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.node(data, {'railway': 'signal', 'railway:signal:speed_limit': 'DE-ESO:zs3', 'railway:signal:speed_limit:form': 'light', 'railway:signal:speed_limit:speed': '87'}), expected={'class': 9016013, 'subclass': 1804825947}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.node(data, {'railway': 'signal', 'railway:signal:speed_limit': 'DE-ESO:zs3', 'railway:signal:speed_limit:form': 'light', 'railway:signal:speed_limit:speed': 'foo'}), expected={'class': 9016013, 'subclass': 1804825947}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.node(data, {'railway': 'signal', 'railway:signal:speed_limit': 'DE-ESO:zs3', 'railway:signal:speed_limit:form': 'sign', 'railway:signal:speed_limit:speed': '80;90'}), expected={'class': 9016013, 'subclass': 1804825947}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.node(data, {'railway': 'signal', 'railway:signal:speed_limit': 'DE-ESO:zs3', 'railway:signal:speed_limit:form': 'sign', 'railway:signal:speed_limit:speed': '05'}), expected={'class': 9016013, 'subclass': 1804825947}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.node(data, {'railway': 'signal', 'railway:signal:speed_limit': 'DE-ESO:zs3', 'railway:signal:speed_limit:form': 'sign', 'railway:signal:speed_limit:speed': '200'}), expected={'class': 9016013, 'subclass': 1804825947}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.node(data, {'railway': 'signal', 'railway:signal:speed_limit': 'DE-ESO:zs3', 'railway:signal:speed_limit:form': 'sign', 'railway:signal:speed_limit:speed': '5'}), expected={'class': 9016013, 'subclass': 1804825947}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.node(data, {'railway': 'signal', 'railway:signal:speed_limit': 'DE-ESO:zs3', 'railway:signal:speed_limit:form': 'sign', 'railway:signal:speed_limit:speed': '80'}), expected={'class': 9016013, 'subclass': 1804825947}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.node(data, {'railway': 'signal', 'railway:signal:speed_limit': 'DE-ESO:zs3', 'railway:signal:speed_limit:form': 'sign', 'railway:signal:speed_limit:speed': '85'}), expected={'class': 9016013, 'subclass': 1804825947}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.node(data, {'railway': 'signal', 'railway:signal:speed_limit': 'DE-ESO:zs3', 'railway:signal:speed_limit:form': 'sign', 'railway:signal:speed_limit:speed': '87'}), expected={'class': 9016013, 'subclass': 1804825947}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.node(data, {'railway': 'signal', 'railway:signal:speed_limit': 'DE-ESO:zs3', 'railway:signal:speed_limit:form': 'sign', 'railway:signal:speed_limit:speed': '?'}), expected={'class': 9016013, 'subclass': 1804825947}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.node(data, {'railway': 'signal', 'railway:signal:speed_limit': 'DE-ESO:zs3', 'railway:signal:speed_limit:form': 'sign', 'railway:signal:speed_limit:speed': 'foo'}), expected={'class': 9016013, 'subclass': 1804825947}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.node(data, {'railway': 'signal', 'railway:signal:speed_limit:form': 'light', 'railway:signal:speed_limit_distant': 'DE-ESO:zs3v', 'railway:signal:speed_limit_distant:speed': '80'}), expected={'class': 9016014, 'subclass': 720472651}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.node(data, {'railway': 'signal', 'railway:signal:speed_limit:form': 'light', 'railway:signal:speed_limit_distant': 'DE-ESO:zs3v', 'railway:signal:speed_limit_distant:speed': '80;120'}), expected={'class': 9016014, 'subclass': 720472651}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.node(data, {'railway': 'signal', 'railway:signal:speed_limit:form': 'light', 'railway:signal:speed_limit_distant': 'DE-ESO:zs3v', 'railway:signal:speed_limit_distant:speed': '80;120;off;?'}), expected={'class': 9016014, 'subclass': 720472651}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.node(data, {'railway': 'signal', 'railway:signal:speed_limit:form': 'light', 'railway:signal:speed_limit_distant': 'DE-ESO:zs3v', 'railway:signal:speed_limit_distant:speed': '80;?'}), expected={'class': 9016014, 'subclass': 720472651}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.node(data, {'railway': 'signal', 'railway:signal:speed_limit:form': 'light', 'railway:signal:speed_limit_distant': 'DE-ESO:zs3v', 'railway:signal:speed_limit_distant:speed': '80;foo'}), expected={'class': 9016014, 'subclass': 720472651}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.node(data, {'railway': 'signal', 'railway:signal:speed_limit:form': 'light', 'railway:signal:speed_limit_distant': 'DE-ESO:zs3v', 'railway:signal:speed_limit_distant:speed': '80;off'}), expected={'class': 9016014, 'subclass': 720472651}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.node(data, {'railway': 'signal', 'railway:signal:speed_limit:form': 'light', 'railway:signal:speed_limit_distant': 'DE-ESO:zs3v', 'railway:signal:speed_limit_distant:speed': '?;80;off;120'}), expected={'class': 9016014, 'subclass': 720472651}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.node(data, {'railway': 'signal', 'railway:signal:speed_limit:form': 'light', 'railway:signal:speed_limit_distant': 'DE-ESO:zs3v', 'railway:signal:speed_limit_distant:speed': 'off;?'}), expected={'class': 9016014, 'subclass': 720472651}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.node(data, {'railway': 'signal', 'railway:signal:speed_limit:form': 'light', 'railway:signal:speed_limit_distant': 'DE-ESO:zs3v', 'railway:signal:speed_limit_distant:speed': '200'}), expected={'class': 9016014, 'subclass': 720472651}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.node(data, {'railway': 'signal', 'railway:signal:speed_limit:form': 'light', 'railway:signal:speed_limit_distant': 'DE-ESO:zs3v', 'railway:signal:speed_limit_distant:speed': '85'}), expected={'class': 9016014, 'subclass': 720472651}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.node(data, {'railway': 'signal', 'railway:signal:speed_limit:form': 'light', 'railway:signal:speed_limit_distant': 'DE-ESO:zs3v', 'railway:signal:speed_limit_distant:speed': 'foo'}), expected={'class': 9016014, 'subclass': 720472651}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.node(data, {'railway': 'signal', 'railway:signal:speed_limit': 'DE-ESO:zs3', 'railway:signal:speed_limit:form': 'light', 'railway:signal:speed_limit:speed': '80'}), expected={'class': 9016015, 'subclass': 1065351347}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.node(data, {'railway': 'signal', 'railway:signal:speed_limit': 'DE-ESO:zs3', 'railway:signal:speed_limit:form': 'light', 'railway:signal:speed_limit:speed': '80;120'}), expected={'class': 9016015, 'subclass': 1065351347}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.node(data, {'railway': 'signal', 'railway:signal:speed_limit': 'DE-ESO:zs3', 'railway:signal:speed_limit:form': 'light', 'railway:signal:speed_limit:speed': '80;120;off;?'}), expected={'class': 9016015, 'subclass': 1065351347}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.node(data, {'railway': 'signal', 'railway:signal:speed_limit': 'DE-ESO:zs3', 'railway:signal:speed_limit:form': 'light', 'railway:signal:speed_limit:speed': '80;?'}), expected={'class': 9016015, 'subclass': 1065351347}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.node(data, {'railway': 'signal', 'railway:signal:speed_limit': 'DE-ESO:zs3', 'railway:signal:speed_limit:form': 'light', 'railway:signal:speed_limit:speed': '80;foo'}), expected={'class': 9016015, 'subclass': 1065351347}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.node(data, {'railway': 'signal', 'railway:signal:speed_limit': 'DE-ESO:zs3', 'railway:signal:speed_limit:form': 'light', 'railway:signal:speed_limit:speed': '80;off'}), expected={'class': 9016015, 'subclass': 1065351347}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.node(data, {'railway': 'signal', 'railway:signal:speed_limit': 'DE-ESO:zs3', 'railway:signal:speed_limit:form': 'light', 'railway:signal:speed_limit:speed': '?;80;off;120'}), expected={'class': 9016015, 'subclass': 1065351347}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.node(data, {'railway': 'signal', 'railway:signal:speed_limit': 'DE-ESO:zs3', 'railway:signal:speed_limit:form': 'light', 'railway:signal:speed_limit:speed': 'off;?'}), expected={'class': 9016015, 'subclass': 1065351347}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.node(data, {'railway': 'signal', 'railway:signal:speed_limit': 'DE-ESO:zs3', 'railway:signal:speed_limit:form': 'light', 'railway:signal:speed_limit:speed': '200'}), expected={'class': 9016015, 'subclass': 1065351347}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.node(data, {'railway': 'signal', 'railway:signal:speed_limit': 'DE-ESO:zs3', 'railway:signal:speed_limit:form': 'light', 'railway:signal:speed_limit:speed': '85'}), expected={'class': 9016015, 'subclass': 1065351347}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.node(data, {'railway': 'signal', 'railway:signal:speed_limit': 'DE-ESO:zs3', 'railway:signal:speed_limit:form': 'light', 'railway:signal:speed_limit:speed': 'foo'}), expected={'class': 9016015, 'subclass': 1065351347}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.node(data, {'railway': 'signal', 'railway:signal:speed_limit': 'DE-ESO:db:zs1', 'railway:signal:speed_limit:form': 'light'}), expected={'class': 9016016, 'subclass': 1437297810}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.node(data, {'railway': 'signal', 'railway:signal:speed_limit': 'DE-ESO:db:zs10', 'railway:signal:speed_limit:form': 'light'}), expected={'class': 9016016, 'subclass': 1437297810}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.node(data, {'railway': 'signal', 'railway:signal:speed_limit': 'DE-ESO:db:zs10', 'railway:signal:speed_limit:form': 'sign'}), expected={'class': 9016016, 'subclass': 1437297810}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.way(data, {'name': 'Kursbuchstrecke 710.1', 'railway': 'light_rail'}, [0]), expected={'class': 9016017, 'subclass': 460679615}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.way(data, {'railway': 'light_rail', 'ref': 'Kursbuchstrecke 710.1'}, [0]), expected={'class': 9016017, 'subclass': 460679615}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.way(data, {'name': 'KBS 258', 'railway': 'rail'}, [0]), expected={'class': 9016017, 'subclass': 460679615}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.way(data, {'name': 'Frankenbahn', 'railway': 'rail'}, [0]), expected={'class': 9016017, 'subclass': 460679615}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.way(data, {'railway': 'light_rail', 'ref': 'Kursbuchstrecke 710.1'}, [0]), expected={'class': 9016018, 'subclass': 1307191883}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.way(data, {'railway': 'rail', 'ref': 'KBS 258'}, [0]), expected={'class': 9016018, 'subclass': 1307191883}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.way(data, {'railway': 'rail', 'ref': '7400'}, [0]), expected={'class': 9016018, 'subclass': 1307191883}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.way(data, {'railway': 'rail', 'ref': 'VzG 7400'}, [0]), expected={'class': 9016019, 'subclass': 1513071347}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.way(data, {'railway': 'rail', 'ref': '7400'}, [0]), expected={'class': 9016019, 'subclass': 1513071347}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.way(data, {'name': 'VzG 7400', 'railway': 'rail'}, [0]), expected={'class': 9016020, 'subclass': 498921024}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.way(data, {'name': '7400', 'railway': 'rail'}, [0]), expected={'class': 9016020, 'subclass': 498921024}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.way(data, {'railway': 'rail', 'ref': '7400'}, [0]), expected={'class': 9016021, 'subclass': 1211908367}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.way(data, {'railway': 'rail', 'ref': '7400-1'}, [0]), expected={'class': 9016021, 'subclass': 1211908367}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.way(data, {'name': '7400', 'railway': 'rail'}, [0]), expected={'class': 9016022, 'subclass': 1094567914}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.way(data, {'name': '750', 'railway': 'rail'}, [0]), expected={'class': 9016022, 'subclass': 1094567914}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.way(data, {'name': 'Hohenlohebahn', 'railway': 'rail'}, [0]), expected={'class': 9016022, 'subclass': 1094567914}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.way(data, {'railway': 'rail', 'ref': '7400'}, [0]), expected={'class': 9016022, 'subclass': 1094567914}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.way(data, {'name': '740.4', 'railway': 'rail'}, [0]), expected={'class': 9016023, 'subclass': 1319009137}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.way(data, {'name': '780', 'railway': 'rail'}, [0]), expected={'class': 9016023, 'subclass': 1319009137}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.way(data, {'name': '790.4--5', 'railway': 'rail'}, [0]), expected={'class': 9016023, 'subclass': 1319009137}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.way(data, {'name': '790.4-5', 'railway': 'rail'}, [0]), expected={'class': 9016023, 'subclass': 1319009137}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.way(data, {'name': '790.4..5', 'railway': 'rail'}, [0]), expected={'class': 9016023, 'subclass': 1319009137}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.way(data, {'name': '790.4.5', 'railway': 'rail'}, [0]), expected={'class': 9016023, 'subclass': 1319009137}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.way(data, {'name': '790.4a5', 'railway': 'rail'}, [0]), expected={'class': 9016023, 'subclass': 1319009137}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.way(data, {'name': '7400', 'railway': 'rail'}, [0]), expected={'class': 9016023, 'subclass': 1319009137}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.way(data, {'name': '7400a', 'railway': 'rail'}, [0]), expected={'class': 9016023, 'subclass': 1319009137}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.way(data, {'name': 'Hohenlohebahn', 'railway': 'rail'}, [0]), expected={'class': 9016023, 'subclass': 1319009137}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.way(data, {'name': '740.4', 'railway': 'rail'}, [0]), expected={'class': 9016024, 'subclass': 1536179499}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.way(data, {'name': '780', 'railway': 'rail'}, [0]), expected={'class': 9016024, 'subclass': 1536179499}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.way(data, {'name': '790.4--5', 'railway': 'rail'}, [0]), expected={'class': 9016024, 'subclass': 1536179499}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.way(data, {'name': '790.4-5', 'railway': 'rail'}, [0]), expected={'class': 9016024, 'subclass': 1536179499}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.way(data, {'name': '790.4..5', 'railway': 'rail'}, [0]), expected={'class': 9016024, 'subclass': 1536179499}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.way(data, {'name': '790.4.5', 'railway': 'rail'}, [0]), expected={'class': 9016024, 'subclass': 1536179499}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.way(data, {'name': '790.4a5', 'railway': 'rail'}, [0]), expected={'class': 9016024, 'subclass': 1536179499}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.way(data, {'name': '7400', 'railway': 'rail'}, [0]), expected={'class': 9016024, 'subclass': 1536179499}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.way(data, {'name': '7400a', 'railway': 'rail'}, [0]), expected={'class': 9016024, 'subclass': 1536179499}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.way(data, {'name': 'Hohenlohebahn', 'railway': 'rail'}, [0]), expected={'class': 9016024, 'subclass': 1536179499}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.way(data, {'railway': 'rail', 'ref': '740.4'}, [0]), expected={'class': 9016025, 'subclass': 1194218564}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.way(data, {'railway': 'rail', 'ref': '780'}, [0]), expected={'class': 9016025, 'subclass': 1194218564}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.way(data, {'railway': 'rail', 'ref': '790.4--5'}, [0]), expected={'class': 9016025, 'subclass': 1194218564}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.way(data, {'railway': 'rail', 'ref': '790.4-5'}, [0]), expected={'class': 9016025, 'subclass': 1194218564}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.way(data, {'railway': 'rail', 'ref': '790.4..5'}, [0]), expected={'class': 9016025, 'subclass': 1194218564}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.way(data, {'railway': 'rail', 'ref': '790.4.5'}, [0]), expected={'class': 9016025, 'subclass': 1194218564}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.way(data, {'railway': 'rail', 'ref': '790.4a5'}, [0]), expected={'class': 9016025, 'subclass': 1194218564}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.way(data, {'railway': 'rail', 'ref': '7400'}, [0]), expected={'class': 9016025, 'subclass': 1194218564}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.way(data, {'railway': 'rail', 'ref': '7400a'}, [0]), expected={'class': 9016025, 'subclass': 1194218564}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.way(data, {'railway': 'rail', 'ref': '740.4'}, [0]), expected={'class': 9016026, 'subclass': 2032079245}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.way(data, {'railway': 'rail', 'ref': '780'}, [0]), expected={'class': 9016026, 'subclass': 2032079245}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.way(data, {'railway': 'rail', 'ref': '790.4--5'}, [0]), expected={'class': 9016026, 'subclass': 2032079245}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.way(data, {'railway': 'rail', 'ref': '790.4-5'}, [0]), expected={'class': 9016026, 'subclass': 2032079245}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.way(data, {'railway': 'rail', 'ref': '790.4..5'}, [0]), expected={'class': 9016026, 'subclass': 2032079245}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.way(data, {'railway': 'rail', 'ref': '790.4.5'}, [0]), expected={'class': 9016026, 'subclass': 2032079245}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.way(data, {'railway': 'rail', 'ref': '790.4a5'}, [0]), expected={'class': 9016026, 'subclass': 2032079245}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.way(data, {'railway': 'rail', 'ref': '7400'}, [0]), expected={'class': 9016026, 'subclass': 2032079245}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.way(data, {'railway': 'rail', 'ref': '7400a'}, [0]), expected={'class': 9016026, 'subclass': 2032079245}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.way(data, {'railway': 'rail', 'workrules': 'BOStrab'}, [0]), expected={'class': 9016031, 'subclass': 1085911640}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.way(data, {'railway': 'rail', 'workrules': 'DE:BOStrab'}, [0]), expected={'class': 9016031, 'subclass': 1085911640}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.way(data, {'railway': 'rail', 'workrules': 'DE:EBO'}, [0]), expected={'class': 9016031, 'subclass': 1085911640}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.way(data, {'railway': 'rail', 'workrules': 'DE:ESBO'}, [0]), expected={'class': 9016031, 'subclass': 1085911640}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.way(data, {'railway': 'rail', 'workrules': 'EBO'}, [0]), expected={'class': 9016031, 'subclass': 1085911640}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.way(data, {'railway': 'rail', 'workrules': 'ESBO'}, [0]), expected={'class': 9016031, 'subclass': 1085911640}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.way(data, {'railway': 'rail'}, [0]), expected={'class': 9016031, 'subclass': 1085911640}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.way(data, {'railway': 'rail', 'workrules': 'BOA'}, [0]), expected={'class': 9016028, 'subclass': 219100574}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.way(data, {'railway': 'rail', 'workrules': 'DE:BOStrab'}, [0]), expected={'class': 9016028, 'subclass': 219100574}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.way(data, {'railway': 'rail'}, [0]), expected={'class': 9016028, 'subclass': 219100574}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.way(data, {'railway': 'rail', 'workrules': 'DE-BOStrab'}, [0]), expected={'class': 9016029, 'subclass': 2059785415}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.way(data, {'railway': 'rail', 'workrules': 'DE:BOStrab'}, [0]), expected={'class': 9016029, 'subclass': 2059785415}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.way(data, {'railway': 'rail', 'workrules': 'DE-EBO'}, [0]), expected={'class': 9016029, 'subclass': 2020708529}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.way(data, {'railway': 'rail', 'workrules': 'DE:EBO'}, [0]), expected={'class': 9016029, 'subclass': 2020708529}, disallowed_str_in_text = ['{', '}'])
