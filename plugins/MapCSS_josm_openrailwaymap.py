...
class MapCSS_josm_openrailwaymap(Plugin):
    ...
    def way(self, data, tags, *args):
        ...
        if u'railway' in keys:
            match = False
            try: match = match or ((mapcss._tag_capture(capture_tags, 0, tags, u'railway') and not mapcss._tag_capture(capture_tags, 1, tags, u'operator')))
            except mapcss.RuleAbort: pass
            if match:
        ...
        if u'railway' in keys:
            match = False
            try: match = match or ((mapcss._tag_capture(capture_tags, 0, tags, u'railway') and mapcss._tag_capture(capture_tags, 1, tags, u'railway') != u'platform' and not mapcss._tag_capture(capture_tags, 2, tags, u'workrules')))
            except mapcss.RuleAbort: pass
            if match:
