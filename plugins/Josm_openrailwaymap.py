...
class Test(TestPluginCommon):
    def test(self):
        ...
        self.check_not_err(n.node(data, {'railway': 'milestone', 'railway:position': '42.0'}), expected={'class': 9015028, 'subclass': 1237934683}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.node(data, {'railway': 'milestone'}), expected={'class': 9015028, 'subclass': 1237934683}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.node(data, {'railway': 'level_crossing', 'supervised': 'yes'}), expected={'class': 9015029, 'subclass': 321695123}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.node(data, {'railway': 'level_crossing'}), expected={'class': 9015029, 'subclass': 321695123}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.node(data, {'railway:signal:direction': 'forward'}), expected={'class': 9015030, 'subclass': 908641862}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.node(data, {'railway': 'level_crossing', 'railway:signal:position': 'right'}), expected={'class': 9015030, 'subclass': 908641862}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.node(data, {'railway': 'signal', 'railway:signal:position': 'right'}), expected={'class': 9015030, 'subclass': 908641862}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.node(data, {'railway': 'buffer_stop', 'railway:signal:minor': 'sh2'}), expected={'class': 9015030, 'subclass': 908641862}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.node(data, {'railway': 'derail', 'railway:signal:minor': 'sh'}), expected={'class': 9015030, 'subclass': 908641862}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.node(data, {'railway': 'signal', 'railway:signal:direction': 'forward'}), expected={'class': 9015030, 'subclass': 908641862}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.node(data, {'railway': 'signal', 'railway:signal:main:form': 'light', 'railway:signal:main:states': 'hp0;hp1'}), expected={'class': 9015031, 'subclass': 285269206}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.node(data, {'railway': 'signal', 'railway:signal:main:form': 'semaphore', 'railway:signal:main:states': 'hp0;hp1'}), expected={'class': 9015031, 'subclass': 285269206}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.node(data, {'railway': 'signal', 'railway:signal:main:form': 'sign', 'railway:signal:main:states': 'hp0;hp1'}), expected={'class': 9015031, 'subclass': 285269206}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.node(data, {'railway': 'signal', 'railway:signal:speed_limit:form': 'sign', 'railway:signal:speed_limit:speed': '80'}), expected={'class': 9015031, 'subclass': 285269206}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.node(data, {'railway': 'signal', 'railway:signal:speed_limit:form': 'sign', 'railway:signal:speed_limit:speed': '80;90'}), expected={'class': 9015031, 'subclass': 285269206}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.node(data, {'priority': 'yard', 'railway': 'buffer_stop'}), expected={'class': 9015014, 'subclass': 1264446053}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.node(data, {'railway': 'crossing'}), expected={'class': 9015032, 'subclass': 719449462}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.node(data, {'railway': 'flat_crossing'}), expected={'class': 9015032, 'subclass': 719449462}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.node(data, {'railway': 'railway_crossing'}), expected={'class': 9015032, 'subclass': 719449462}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.node(data, {'railway': 'signal', 'railway:signal:stop:caption': '70'}), expected={'class': 9015033, 'subclass': 1175712267}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.node(data, {'railway': 'signal', 'railway:signal:stop:caption': '70', 'railway:signal:stop:description': '70'}), expected={'class': 9015033, 'subclass': 1175712267}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.node(data, {'railway': 'signal', 'railway:signal:stop:description': '70'}), expected={'class': 9015033, 'subclass': 1175712267}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.node(data, {'railway': 'signal', 'railway:signal:stop:caption': '70'}), expected={'class': 9015034, 'subclass': 1820225369}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.node(data, {'railway': 'signal', 'railway:signal:stop:caption': '70', 'railway:signal:stop:description': '70'}), expected={'class': 9015034, 'subclass': 1820225369}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.node(data, {'railway': 'signal', 'railway:signal:stop:description': '70'}), expected={'class': 9015034, 'subclass': 1820225369}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.node(data, {'railway': 'signal', 'railway:signal:combined': 'DE-ESO:ks', 'railway:signal:main': 'DE-ESO:hp'}), expected={'class': 9015035, 'subclass': 371617473}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.node(data, {'railway': 'signal', 'railway:signal:combined': 'DE-ESO:ks', 'railway:signal:minor': 'DE-ESO:sh1'}), expected={'class': 9015035, 'subclass': 371617473}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.node(data, {'railway': 'signal', 'railway:signal:distant': 'DE-ESO:vr', 'railway:signal:main': 'DE-ESO:hp'}), expected={'class': 9015035, 'subclass': 371617473}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.node(data, {'railway': 'signal', 'railway:signal:combined': 'DE-ESO:ks', 'railway:signal:distant': 'DE-ESO:vr'}), expected={'class': 9015035, 'subclass': 570327409}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.node(data, {'railway': 'signal', 'railway:signal:combined': 'DE-ESO:ks', 'railway:signal:minor': 'DE-ESO:sh1'}), expected={'class': 9015035, 'subclass': 570327409}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.node(data, {'railway': 'signal', 'railway:signal:distant': 'DE-ESO:vr', 'railway:signal:main': 'DE-ESO:hp'}), expected={'class': 9015035, 'subclass': 570327409}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.node(data, {'railway': 'signal', 'railway:ref': 'N1', 'ref': 'N1'}), expected={'class': 9015036, 'subclass': 257553969}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.node(data, {'railway': 'signal', 'railway:ref': 'N1'}), expected={'class': 9015036, 'subclass': 257553969}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.node(data, {'railway': 'signal', 'ref': 'N1'}), expected={'class': 9015036, 'subclass': 257553969}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.node(data, {'railway': 'signal', 'railway:ref': 'N1', 'ref': 'N1'}), expected={'class': 9015036, 'subclass': 1443995005}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.node(data, {'railway': 'signal', 'railway:ref': 'N1'}), expected={'class': 9015036, 'subclass': 1443995005}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.node(data, {'railway': 'signal', 'ref': 'N1'}), expected={'class': 9015036, 'subclass': 1443995005}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.node(data, {'railway': 'signal', 'railway:signal:direction': 'forward'}), expected={'class': 9015037, 'subclass': 1288245325}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.node(data, {'railway': 'signal'}), expected={'class': 9015037, 'subclass': 1288245325}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.node(data, {'railway': 'signal', 'railway:signal:combined': 'DE-ESO:ks'}), expected={'class': 9015038, 'subclass': 946563032}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.node(data, {'railway': 'signal', 'railway:signal:combined': 'ks'}), expected={'class': 9015038, 'subclass': 946563032}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.node(data, {'railway': 'signal', 'railway:signal:distant': 'DE-ESO:ks'}), expected={'class': 9015038, 'subclass': 946563032}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.node(data, {'railway': 'signal', 'railway:signal:distant': 'vr'}), expected={'class': 9015038, 'subclass': 946563032}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.node(data, {'railway': 'signal', 'railway:signal:main': 'DE-ESO:ks'}), expected={'class': 9015038, 'subclass': 946563032}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.node(data, {'railway': 'signal', 'railway:signal:main': 'ks'}), expected={'class': 9015038, 'subclass': 946563032}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.node(data, {'railway': 'signal', 'railway:signal:route': 'DE-ESO:zs2'}), expected={'class': 9015038, 'subclass': 946563032}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.node(data, {'railway': 'signal', 'railway:signal:route': 'zs2'}), expected={'class': 9015038, 'subclass': 946563032}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.node(data, {'name': 'FF', 'railway': 'signal', 'ref': 'FF'}), expected={'class': 9015039, 'subclass': 1244137190}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.node(data, {'name': 'FF', 'railway': 'signal'}), expected={'class': 9015039, 'subclass': 1244137190}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.node(data, {'name': 'GG', 'railway': 'signal', 'ref': 'FF'}), expected={'class': 9015039, 'subclass': 1244137190}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.node(data, {'railway': 'signal', 'ref': 'FF'}), expected={'class': 9015039, 'subclass': 1244137190}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.node(data, {'name': '12', 'railway': 'switch', 'ref': '12'}), expected={'class': 9015039, 'subclass': 1244137190}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.node(data, {'name': '12', 'railway': 'switch'}), expected={'class': 9015039, 'subclass': 1244137190}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.node(data, {'name': '13', 'railway': 'switch', 'ref': '12'}), expected={'class': 9015039, 'subclass': 1244137190}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.node(data, {'railway': 'switch', 'ref': '12'}), expected={'class': 9015039, 'subclass': 1244137190}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.node(data, {'railway': 'switch', 'railway:switch': 'default', 'railway:switch:resetting': 'yes'}), expected={'class': 9015040, 'subclass': 967663151}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.node(data, {'railway': 'switch', 'railway:switch': 'default'}), expected={'class': 9015040, 'subclass': 967663151}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.node(data, {'railway': 'switch', 'railway:switch': 'resetting', 'ref': '2'}), expected={'class': 9015040, 'subclass': 967663151}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.node(data, {'railway': 'switch'}), expected={'class': 9015040, 'subclass': 967663151}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.node(data, {'name': 'foo', 'railway': 'crossover'}), expected={'class': 9015044, 'subclass': 1433036676}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.node(data, {'railway': 'crossover'}), expected={'class': 9015044, 'subclass': 1433036676}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.node(data, {'name': 'foo', 'railway': 'halt'}), expected={'class': 9015044, 'subclass': 1433036676}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.node(data, {'railway': 'halt'}), expected={'class': 9015044, 'subclass': 1433036676}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.node(data, {'name': 'foo', 'railway': 'junction'}), expected={'class': 9015044, 'subclass': 1433036676}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.node(data, {'railway': 'junction'}), expected={'class': 9015044, 'subclass': 1433036676}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.node(data, {'name': 'foo', 'railway': 'service_station'}), expected={'class': 9015044, 'subclass': 1433036676}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.node(data, {'railway': 'service_station'}), expected={'class': 9015044, 'subclass': 1433036676}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.node(data, {'name': 'foo', 'railway': 'site'}), expected={'class': 9015044, 'subclass': 1433036676}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.node(data, {'railway': 'site'}), expected={'class': 9015044, 'subclass': 1433036676}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.node(data, {'name': 'foo', 'railway': 'spur_junction'}), expected={'class': 9015044, 'subclass': 1433036676}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.node(data, {'railway': 'spur_junction'}), expected={'class': 9015044, 'subclass': 1433036676}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.node(data, {'name': 'foo', 'railway': 'station'}), expected={'class': 9015044, 'subclass': 1433036676}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.node(data, {'railway': 'station'}), expected={'class': 9015044, 'subclass': 1433036676}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.node(data, {'name': 'foo', 'railway': 'tram_stop'}), expected={'class': 9015044, 'subclass': 1433036676}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.node(data, {'railway': 'tram_stop'}), expected={'class': 9015044, 'subclass': 1433036676}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.node(data, {'name': 'foo', 'railway': 'yard'}), expected={'class': 9015044, 'subclass': 1433036676}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.node(data, {'railway': 'yard'}), expected={'class': 9015044, 'subclass': 1433036676}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.way(data, {'railway': 'rail', 'service': 'siding'}, [0]), expected={'class': 9015001, 'subclass': 1888453557}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.way(data, {'railway': 'rail', 'service': 'yard', 'usage': 'industrial'}, [0]), expected={'class': 9015001, 'subclass': 1888453557}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.way(data, {'railway': 'rail', 'service': 'siding', 'usage': 'main'}, [0]), expected={'class': 9015001, 'subclass': 1888453557}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.way(data, {'railway': 'rail', 'usage': 'main'}, [0]), expected={'class': 9015001, 'subclass': 1888453557}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.way(data, {'railway': 'rail', 'service': 'yard', 'usage': 'military'}, [0]), expected={'class': 9015001, 'subclass': 1888453557}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.way(data, {'railway': 'station'}, [0]), expected={'class': 9015002, 'subclass': 1498103253}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.way(data, {'railway': 'rail', 'railway:traffic_mode': 'passenger'}, [0]), expected={'class': 9015004, 'subclass': 1755442170}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.way(data, {'railway': 'rail', 'traffic_mode': 'passenger'}, [0]), expected={'class': 9015004, 'subclass': 1755442170}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.way(data, {'railway': 'rail'}, [0]), expected={'class': 9015004, 'subclass': 1755442170}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.way(data, {'railway': 'rail railway:traffic_mode'}, [0]), expected={'class': 9015005, 'subclass': 331669407}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.way(data, {'railway': 'rail', 'usage': 'branch'}, [0]), expected={'class': 9015005, 'subclass': 331669407}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.way(data, {'railway': 'rail', 'railway:traffic_mode': 'freight', 'usage': 'freight'}, [0]), expected={'class': 9015005, 'subclass': 331669407}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.way(data, {'railway': 'rail', 'usage': 'freight'}, [0]), expected={'class': 9015005, 'subclass': 331669407}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.way(data, {'railway': 'rail', 'usage': 'industrial'}, [0]), expected={'class': 9015005, 'subclass': 331669407}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.way(data, {'railway': 'rail', 'usage': 'main'}, [0]), expected={'class': 9015005, 'subclass': 331669407}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.way(data, {'railway': 'rail', 'railway:traffic_mode': 'freight', 'usage': 'freight'}, [0]), expected={'class': 9015005, 'subclass': 1212704987}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.way(data, {'railway': 'rail railway:traffic_mode'}, [0]), expected={'class': 9015005, 'subclass': 1212704987}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.way(data, {'railway': 'rail', 'usage': 'branch'}, [0]), expected={'class': 9015005, 'subclass': 1212704987}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.way(data, {'railway': 'rail', 'railway:traffic_mode': 'mixed', 'usage': 'freight'}, [0]), expected={'class': 9015005, 'subclass': 1212704987}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.way(data, {'railway': 'rail', 'railway:traffic_mode': 'passenger', 'usage': 'freight'}, [0]), expected={'class': 9015005, 'subclass': 1212704987}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.way(data, {'railway': 'rail', 'usage': 'industrial'}, [0]), expected={'class': 9015005, 'subclass': 1212704987}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.way(data, {'railway': 'rail', 'usage': 'main'}, [0]), expected={'class': 9015005, 'subclass': 1212704987}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.way(data, {'name': '14', 'railway': 'light_rail', 'railway:track_ref': '14'}, [0]), expected={'class': 9015007, 'subclass': 2091521035}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.way(data, {'name': 'Gleis 14b', 'railway': 'rail', 'railway:track_ref': '14b'}, [0]), expected={'class': 9015007, 'subclass': 2091521035}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.way(data, {'name': 'Gleis 14b', 'railway': 'rail'}, [0]), expected={'class': 9015007, 'subclass': 2091521035}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.way(data, {'name': '14b', 'railway': 'rail', 'railway:track_ref': '14b'}, [0]), expected={'class': 9015007, 'subclass': 2091521035}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.way(data, {'name': '3', 'railway': 'rail'}, [0]), expected={'class': 9015007, 'subclass': 2091521035}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.way(data, {'name': '4', 'railway': 'rail', 'railway:track_ref': '4'}, [0]), expected={'class': 9015007, 'subclass': 2091521035}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.way(data, {'name': '4a', 'railway': 'rail', 'railway:track_ref': '4a'}, [0]), expected={'class': 9015007, 'subclass': 2091521035}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.way(data, {'name': '14', 'railway': 'light_rail'}, [0]), expected={'class': 9015007, 'subclass': 85438379}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.way(data, {'name': '3', 'railway': 'platform'}, [0]), expected={'class': 9015007, 'subclass': 85438379}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.way(data, {'name': 'Gleis 14b', 'railway': 'rail'}, [0]), expected={'class': 9015007, 'subclass': 85438379}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.way(data, {'name': 'track 4b', 'railway': 'rail'}, [0]), expected={'class': 9015007, 'subclass': 85438379}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.way(data, {'name': '14b', 'railway': 'rail'}, [0]), expected={'class': 9015007, 'subclass': 85438379}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.way(data, {'name': '4', 'railway': 'rail'}, [0]), expected={'class': 9015007, 'subclass': 85438379}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.way(data, {'name': '4a', 'railway': 'rail'}, [0]), expected={'class': 9015007, 'subclass': 85438379}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.way(data, {'railway': 'light_rail', 'ref': '14', 'service': 'siding'}, [0]), expected={'class': 9015045, 'subclass': 194113748}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.way(data, {'railway': 'platform', 'ref': '3'}, [0]), expected={'class': 9015045, 'subclass': 194113748}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.way(data, {'railway': 'rail', 'ref': '1234'}, [0]), expected={'class': 9015045, 'subclass': 194113748}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.way(data, {'railway': 'rail', 'ref': '4a', 'service': 'crossover'}, [0]), expected={'class': 9015045, 'subclass': 194113748}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.way(data, {'railway': 'rail', 'railway:track_ref': '14b', 'service': 'siding'}, [0]), expected={'class': 9015045, 'subclass': 194113748}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.way(data, {'railway': 'rail', 'ref': '4', 'service': 'siding'}, [0]), expected={'class': 9015045, 'subclass': 194113748}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.way(data, {'railway': 'platform', 'railway:track_ref': '3', 'ref': '3'}, [0]), expected={'class': 9015008, 'subclass': 226422824}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.way(data, {'railway': 'platform', 'railway:track_ref': '3', 'ref': '4'}, [0]), expected={'class': 9015008, 'subclass': 226422824}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.way(data, {'railway': 'platform', 'railway:track_ref': '3'}, [0]), expected={'class': 9015008, 'subclass': 226422824}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.way(data, {'railway': 'rail', 'railway:track_ref': '3'}, [0]), expected={'class': 9015008, 'subclass': 226422824}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.way(data, {'railway': 'platform', 'railway:track_ref': '3', 'ref': '3'}, [0]), expected={'class': 9015008, 'subclass': 1676742857}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.way(data, {'railway': 'platform', 'railway:track_ref': '3', 'ref': '4'}, [0]), expected={'class': 9015008, 'subclass': 1676742857}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.way(data, {'railway': 'platform', 'railway:track_ref': '3'}, [0]), expected={'class': 9015008, 'subclass': 1676742857}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.way(data, {'railway': 'rail', 'railway:track_ref': '3'}, [0]), expected={'class': 9015008, 'subclass': 1676742857}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.way(data, {'name': 'Gleis 14b', 'railway': 'rail'}, [0]), expected={'class': 9015009, 'subclass': 1420092530}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.way(data, {'name': '14b', 'railway': 'rail'}, [0]), expected={'class': 9015009, 'subclass': 1420092530}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.way(data, {'railway': 'rail', 'ref': 'track 4b'}, [0]), expected={'class': 9015009, 'subclass': 1420092530}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.way(data, {'description': 'Gleis 14b', 'name': 'Gleis 14b', 'railway': 'platform'}, [0]), expected={'class': 9015010, 'subclass': 1156420508}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.way(data, {'name': 'Gleis 14b', 'railway': 'platform'}, [0]), expected={'class': 9015010, 'subclass': 1156420508}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.way(data, {'description': 'other', 'name': '14b', 'railway': 'platform'}, [0]), expected={'class': 9015010, 'subclass': 1156420508}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.way(data, {'name': '14b', 'railway': 'platform'}, [0]), expected={'class': 9015010, 'subclass': 1156420508}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.way(data, {'railway': 'platform', 'ref': 'track 4b'}, [0]), expected={'class': 9015010, 'subclass': 1156420508}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.way(data, {'railway': 'platform', 'ref': 'track 4b'}, [0]), expected={'class': 9015010, 'subclass': 1156420508}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.way(data, {'name': '14b', 'railway': 'rail'}, [0]), expected={'class': 9015010, 'subclass': 1156420508}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.way(data, {'description': 'other', 'name': 'Gleis 14b', 'railway': 'platform'}, [0]), expected={'class': 9015010, 'subclass': 1149450895}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.way(data, {'description': '14b', 'name': '14b', 'railway': 'platform'}, [0]), expected={'class': 9015010, 'subclass': 1149450895}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.way(data, {'name': '14b', 'railway': 'platform'}, [0]), expected={'class': 9015010, 'subclass': 1149450895}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.way(data, {'description': 'other', 'railway': 'platform', 'ref': 'track 4b'}, [0]), expected={'class': 9015010, 'subclass': 1149450895}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.way(data, {'electrified': 'contact_line', 'power:type': 'overhead', 'railway': 'rail'}, [0]), expected={'class': 9015011, 'subclass': 1012477221}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.way(data, {'electrified': 'something', 'power:type': 'overhead', 'railway': 'rail'}, [0]), expected={'class': 9015011, 'subclass': 1012477221}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.way(data, {'electrified': 'something', 'power:type': 'overhead', 'railway': 'rail'}, [0]), expected={'class': 9015011, 'subclass': 1909233042}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.way(data, {'electrified': 'yes', 'power:type': 'overhead', 'railway': 'rail'}, [0]), expected={'class': 9015011, 'subclass': 1909233042}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.way(data, {'power:type': 'overhead', 'railway': 'rail'}, [0]), expected={'class': 9015011, 'subclass': 1909233042}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.way(data, {'electrified': 'other', 'power:type': 'overhead', 'railway': 'rail'}, [0]), expected={'class': 9015012, 'subclass': 1465196539}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.way(data, {'electrified': 'yes', 'power:type': 'overhead', 'railway': 'rail'}, [0]), expected={'class': 9015012, 'subclass': 1465196539}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.way(data, {'electrified': 'yes', 'power:type': 'overhead', 'railway': 'rail'}, [0]), expected={'class': 9015013, 'subclass': 356393984}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.way(data, {'electrified': 'yes', 'power:type': 'something', 'railway': 'rail'}, [0]), expected={'class': 9015013, 'subclass': 356393984}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.way(data, {'electrified': 'yes', 'power:type': 'overhead', 'railway': 'rail'}, [0]), expected={'class': 9015013, 'subclass': 410100568}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.way(data, {'power:type': 'something', 'railway': 'rail'}, [0]), expected={'class': 9015013, 'subclass': 410100568}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.way(data, {'highway': 'primary', 'priority': 'primary'}, [0]), expected={'class': 9015014, 'subclass': 2122288452}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.way(data, {'priority': 'primary', 'railway': 'rail', 'service': 'siding'}, [0]), expected={'class': 9015014, 'subclass': 2122288452}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.way(data, {'priority': 'primary', 'railway': 'rail', 'usage': 'main'}, [0]), expected={'class': 9015014, 'subclass': 2122288452}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.way(data, {'priority': 'primary', 'railway': 'rail'}, [0]), expected={'class': 9015014, 'subclass': 2122288452}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.way(data, {'detail!': 'track', 'railway': 'rail', 'tracks': '1'}, [0]), expected={'class': 9015015, 'subclass': 986004687}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.way(data, {'detail': 'track', 'railway': 'rail', 'tracks': '1'}, [0]), expected={'class': 9015015, 'subclass': 986004687}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.way(data, {'detail': 'track', 'railway': 'rail', 'tracks': '2'}, [0]), expected={'class': 9015015, 'subclass': 986004687}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.way(data, {'railway': 'rail', 'tracks': '1'}, [0]), expected={'class': 9015016, 'subclass': 256757521}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.way(data, {'railway': 'rail', 'service': 'foo', 'tracks': '2'}, [0]), expected={'class': 9015016, 'subclass': 256757521}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.way(data, {'railway': 'rail', 'tracks': '2', 'usage': 'bar'}, [0]), expected={'class': 9015016, 'subclass': 256757521}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.way(data, {'railway': 'crossing', 'railway:position:exact': '2.4'}, [0]), expected={'class': 9015017, 'subclass': 2146160181}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.way(data, {'railway': 'level_crossing', 'railway:position:exact': '2.4'}, [0]), expected={'class': 9015017, 'subclass': 2146160181}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.way(data, {'radio': 'GSM', 'railway': 'rail'}, [0]), expected={'class': 9015018, 'subclass': 2078132492}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.way(data, {'radio': 'GSM-R', 'railway': 'rail', 'railway:radio': 'gsm'}, [0]), expected={'class': 9015018, 'subclass': 2078132492}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.way(data, {'radio': 'GSM-R', 'railway': 'rail', 'railway:radio': 'gsm-r'}, [0]), expected={'class': 9015018, 'subclass': 2078132492}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.way(data, {'radio': 'GSM-R', 'railway': 'rail'}, [0]), expected={'class': 9015018, 'subclass': 2078132492}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.way(data, {'radio': 'GSM', 'railway': 'rail'}, [0]), expected={'class': 9015019, 'subclass': 406318522}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.way(data, {'radio': 'GSM-R', 'railway': 'rail', 'railway:radio': 'gsm'}, [0]), expected={'class': 9015019, 'subclass': 406318522}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.way(data, {'radio': 'GSM-R', 'railway': 'rail', 'railway:radio': 'gsm-r'}, [0]), expected={'class': 9015019, 'subclass': 406318522}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.way(data, {'radio': 'GSM-R', 'railway': 'rail'}, [0]), expected={'class': 9015019, 'subclass': 406318522}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.way(data, {'name': 'Bartunnel', 'railway': 'light_rail', 'tunnel:name': 'Bartunnel'}, [0]), expected={'class': 9015020, 'subclass': 1651250819}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.way(data, {'name': 'Footunnel', 'railway': 'platform'}, [0]), expected={'class': 9015020, 'subclass': 1651250819}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.way(data, {'name': 'Footunnel', 'railway': 'rail'}, [0]), expected={'class': 9015020, 'subclass': 1651250819}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.way(data, {'railway': 'rail', 'tunnel:name': 'Baztunnel'}, [0]), expected={'class': 9015020, 'subclass': 1651250819}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.way(data, {'railway': 'light_rail', 'tunnel:wikipedia': 'Bartunnel', 'wikipedia': 'Bartunnel'}, [0]), expected={'class': 9015021, 'subclass': 1581548500}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.way(data, {'railway': 'platform', 'wikipedia': 'Footunnel'}, [0]), expected={'class': 9015021, 'subclass': 1581548500}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.way(data, {'railway': 'rail', 'tunnel:wikipedia': 'Baztunnel'}, [0]), expected={'class': 9015021, 'subclass': 1581548500}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.way(data, {'railway': 'rail', 'wikipedia': 'Footunnel'}, [0]), expected={'class': 9015021, 'subclass': 1581548500}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.way(data, {'bridge:name': 'Bar bridge', 'name': 'Bar bridge', 'railway': 'light_rail'}, [0]), expected={'class': 9015022, 'subclass': 359430532}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.way(data, {'name': 'Noltemeyerbrücke', 'railway': 'platform'}, [0]), expected={'class': 9015022, 'subclass': 359430532}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.way(data, {'bridge:name': 'Foo-Viadukt', 'railway': 'rail'}, [0]), expected={'class': 9015022, 'subclass': 359430532}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.way(data, {'name': 'Bay bridge', 'railway': 'rail'}, [0]), expected={'class': 9015022, 'subclass': 359430532}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.way(data, {'name': 'Baz viaduct', 'railway': 'rail'}, [0]), expected={'class': 9015022, 'subclass': 359430532}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.way(data, {'name': 'Foobrücke', 'railway': 'rail'}, [0]), expected={'class': 9015022, 'subclass': 359430532}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.way(data, {'bridge:wikipedia': 'Bar bridge', 'railway': 'light_rail', 'wikipedia': 'Bar bridge'}, [0]), expected={'class': 9015023, 'subclass': 1594751596}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.way(data, {'railway': 'platform', 'wikipedia': 'Foobrücke'}, [0]), expected={'class': 9015023, 'subclass': 1594751596}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.way(data, {'bridge:wikipedia': 'Foo-Viadukt', 'railway': 'rail'}, [0]), expected={'class': 9015023, 'subclass': 1594751596}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.way(data, {'railway': 'rail', 'wikipedia': 'Bay bridge'}, [0]), expected={'class': 9015023, 'subclass': 1594751596}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.way(data, {'railway': 'rail', 'wikipedia': 'Baz viaduct'}, [0]), expected={'class': 9015023, 'subclass': 1594751596}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.way(data, {'railway': 'rail', 'wikipedia': 'Foobrücke'}, [0]), expected={'class': 9015023, 'subclass': 1594751596}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.way(data, {'highway': 'tertiary', 'lanes': '3', 'railway': 'abandoned'}, [0]), expected={'class': 9015024, 'subclass': 245965100}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.way(data, {'lanes': '2', 'railway': 'rail'}, [0]), expected={'class': 9015024, 'subclass': 245965100}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.way(data, {'railway': 'rail', 'tracks': '1'}, [0]), expected={'class': 9015024, 'subclass': 245965100}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.way(data, {'highway': 'tertiary', 'lanes': '3', 'railway': 'razed'}, [0]), expected={'class': 9015024, 'subclass': 245965100}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.way(data, {'lanes': '2', 'railway': 'subway', 'tracks': '2'}, [0]), expected={'class': 9015024, 'subclass': 245965100}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.way(data, {'maxspeed': 'signals', 'railway': 'rail'}, [0]), expected={'class': 9015025, 'subclass': 650821308}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.way(data, {'maxspeed': '100', 'railway': 'subway'}, [0]), expected={'class': 9015025, 'subclass': 650821308}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.way(data, {'maxspeed': '161', 'mph:maxspeed': '50 mph', 'railway': 'rail'}, [0]), expected={'class': 9015026, 'subclass': 317587071}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.way(data, {'mph:maxspeed': '50 mph', 'railway': 'rail'}, [0]), expected={'class': 9015026, 'subclass': 317587071}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.way(data, {'mph:maxspeed': '50', 'railway': 'rail'}, [0]), expected={'class': 9015026, 'subclass': 317587071}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.way(data, {'maxspeed': '161', 'mph:maxspeed': '100', 'railway': 'rail'}, [0]), expected={'class': 9015026, 'subclass': 317587071}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.way(data, {'maxspeed': '161', 'mph:maxspeed': '50 mph', 'railway': 'rail'}, [0]), expected={'class': 9015026, 'subclass': 2074447149}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.way(data, {'mph:maxspeed': '50 mph', 'railway': 'rail'}, [0]), expected={'class': 9015026, 'subclass': 2074447149}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.way(data, {'mph:maxspeed': '50', 'railway': 'rail'}, [0]), expected={'class': 9015026, 'subclass': 2074447149}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.way(data, {'maxspeed': '161', 'mph:maxspeed': '100', 'railway': 'rail'}, [0]), expected={'class': 9015026, 'subclass': 2074447149}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.way(data, {'abandoned:railway': 'rail', 'railway': 'abandoned'}, [0]), expected={'class': 9015027, 'subclass': 160705788}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.way(data, {'railway': 'abandoned'}, [0]), expected={'class': 9015027, 'subclass': 160705788}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.way(data, {'construction:railway': 'rail', 'railway': 'construction'}, [0]), expected={'class': 9015027, 'subclass': 160705788}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.way(data, {'railway': 'construction'}, [0]), expected={'class': 9015027, 'subclass': 160705788}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.way(data, {'disused:railway': 'rail', 'railway': 'disused'}, [0]), expected={'class': 9015027, 'subclass': 160705788}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.way(data, {'railway': 'disused'}, [0]), expected={'class': 9015027, 'subclass': 160705788}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.way(data, {'proposed:railway': 'rail', 'railway': 'proposed'}, [0]), expected={'class': 9015027, 'subclass': 160705788}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.way(data, {'railway': 'proposed'}, [0]), expected={'class': 9015027, 'subclass': 160705788}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.way(data, {'railway': 'razed', 'razed:railway': 'rail'}, [0]), expected={'class': 9015027, 'subclass': 160705788}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.way(data, {'railway': 'razed'}, [0]), expected={'class': 9015027, 'subclass': 160705788}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.relation(data, {'railway': 'controlled_area'}, []), expected={'class': 9015041, 'subclass': 53808548}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.relation(data, {'railway': 'interlocking'}, []), expected={'class': 9015041, 'subclass': 53808548}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.relation(data, {'railway': 'interlocking', 'type': 'railway'}, []), expected={'class': 9015042, 'subclass': 1490437342}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.relation(data, {'railway': 'interlocking'}, []), expected={'class': 9015042, 'subclass': 1490437342}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.relation(data, {'railway': 'interlocking', 'type': 'public_transport'}, []), expected={'class': 9015043, 'subclass': 1419769139}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.relation(data, {'railway': 'interlocking', 'type': 'railway'}, []), expected={'class': 9015043, 'subclass': 1419769139}, disallowed_str_in_text = ['{', '}'])
