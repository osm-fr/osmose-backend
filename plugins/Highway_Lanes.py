...
class Highway_Lanes(Plugin):
    ...
    def init(self, logger):
        ...
        self.errors[1] = { "item": 3160, "level": 2, "tag": ["highway"], "desc": {"en": u"Bad lanes value", "fr": u"Mauvais valeur de lanes"} }
        self.errors[2] = { "item": 3160, "level": 2, "tag": ["highway"], "desc": {"en": u"Missing lanes tag or useless *:lanes", "fr": u"Tag lanes absent ou *:lanes inutile"} }
        self.errors[3] = { "item": 3160, "level": 2, "tag": ["highway"], "desc": {"en": u"Conflit between *:lanes and *:lanes:*", "fr": u"Conflit entre *:lanes et *:lanes:*"} }
        self.errors[4] = { "item": 3160, "level": 2, "tag": ["highway"], "desc": {"en": u"Bad lanes designation", "fr": u"Mauvais utilisation de lanes"} }
