...
class Josm_wikipedia(PluginMapCSS):
    ...
    def node(self, data, tags):
        ...
        if ('wikipedia' in keys):
            ...
            if not match:
                capture_tags = {}
                try: match = ((mapcss.regexp_test(mapcss._value_capture(capture_tags, 0, self.re_07f8e639), mapcss._tag_capture(capture_tags, 0, tags, 'wikipedia'))) and (not mapcss.regexp_test(mapcss._value_const_capture(capture_tags, 1, self.re_1f90813f, '^https?:\/\/'), mapcss._tag_capture(capture_tags, 1, tags, 'wikipedia'))) and (not mapcss.regexp_test(mapcss._value_const_capture(capture_tags, 2, self.re_67a81e56, '^(aa|ab|ace|ady|af|ak|als|alt|am|ami|an|ang|ar|arc|ary|arz|as|ast|atj|av|avk|awa|ay|az|azb|ba|ban|bar|bat-smg|bcl|be|be-tarask|be-x-old|bg|bh|bi|bjn|bm|bn|bo|bpy|br|bs|bug|bxr|ca|cbk-zam|cdo|ce|ceb|ch|cho|chr|chy|ckb|co|cr|crh|cs|csb|cu|cv|cy|da|dag|de|din|diq|dsb|dty|dv|dz|ee|el|eml|en|eo|es|et|eu|ext|fa|ff|fi|fiu-vro|fj|fo|fr|frp|frr|fur|fy|ga|gag|gan|gcr|gd|gl|glk|gn|gom|gor|got|gu|guw|gv|ha|hak|haw|he|hi|hif|ho|hr|hsb|ht|hu|hy|hyw|hz|ia|id|ie|ig|ii|ik|ilo|inh|io|is|it|iu|ja|jam|jbo|jv|ka|kaa|kab|kbd|kbp|kcg|kg|ki|kj|kk|kl|km|kn|ko|koi|kr|krc|ks|ksh|ku|kv|kw|ky|la|lad|lb|lbe|lez|lfn|lg|li|lij|lld|lmo|ln|lo|lrc|lt|ltg|lv|mad|mai|map-bms|mdf|mg|mh|mhr|mi|min|mk|ml|mn|mni|mnw|mo|mr|mrj|ms|mt|mus|mwl|my|myv|mzn|na|nah|nap|nds|nds-nl|ne|new|ng|nia|nl|nn|no|nov|nqo|nrm|nso|nv|ny|oc|olo|om|or|os|pa|pag|pam|pap|pcd|pdc|pfl|pi|pih|pl|pms|pnb|pnt|ps|pt|pwn|qu|rm|rmy|rn|ro|roa-rup|roa-tara|ru|rue|rw|sa|sah|sat|sc|scn|sco|sd|se|sg|sh|shi|shn|shy|si|simple|sk|skr|sl|sm|smn|sn|so|sq|sr|srn|ss|st|stq|su|sv|sw|szl|szy|ta|tay|tcy|te|tet|tg|th|ti|tk|tl|tn|to|tpi|tr|trv|ts|tt|tum|tw|ty|tyv|udm|ug|uk|ur|uz|ve|vec|vep|vi|vls|vo|wa|war|wo|wuu|xal|xh|xmf|yi|yo|yue|za|zea|zh|zh-classical|zh-min-nan|zh-yue|zu):'), mapcss._tag_capture(capture_tags, 2, tags, 'wikipedia'))))
                except mapcss.RuleAbort: pass
            if match:
                # throwWarning:tr("wikipedia tag has an unknown language prefix")
                # assertMatch:"node wikipedia=X-Y-Z:Foobar"
                # assertNoMatch:"node wikipedia=en:Foobar"
                err.append({'class': 9011002, 'subclass': 1826918481, 'text': mapcss.tr('wikipedia tag has an unknown language prefix')})
...
class Test(TestPluginCommon):
    def test(self):
        ...
        self.check_err(n.node(data, {'wikipedia': 'Foobar'}), expected={'class': 9011001, 'subclass': 1517450396}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.node(data, {'wikipedia': 'en-GB:Foobar'}), expected={'class': 9011001, 'subclass': 1517450396}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.node(data, {'wikipedia': 'en:Foobar'}), expected={'class': 9011001, 'subclass': 1517450396}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.node(data, {'wikipedia': 'X-Y-Z:Foobar'}), expected={'class': 9011002, 'subclass': 1826918481}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.node(data, {'wikipedia': 'en:Foobar'}), expected={'class': 9011002, 'subclass': 1826918481}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.node(data, {'wikipedia': 'en:OpenStreetMap'}), expected={'class': 9011003, 'subclass': 75691825}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.node(data, {'wikipedia': 'http://en.wikipedia.org/wiki/OpenStreetMap'}), expected={'class': 9011003, 'subclass': 75691825}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.node(data, {'wikipedia': 'abe-x-old:foo'}), expected={'class': 9011004, 'subclass': 616152609}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.node(data, {'wikipedia': 'be-x-old:foo'}), expected={'class': 9011004, 'subclass': 616152609}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.node(data, {'wikipedia': 'cz:foo'}), expected={'class': 9011005, 'subclass': 243392039}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.node(data, {'wikipedia': 'en:cz:foo'}), expected={'class': 9011005, 'subclass': 243392039}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.node(data, {'wikimedia_commons': 'File:Foo%27s'}), expected={'class': 9011006, 'subclass': 1999051286}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.node(data, {'wikimedia_commons': 'File:Foo'}), expected={'class': 9011006, 'subclass': 1999051286}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.node(data, {'wikipedia': 'en:Foo%27s'}), expected={'class': 9011006, 'subclass': 83644825}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.node(data, {'wikipedia': 'en:Foo'}), expected={'class': 9011006, 'subclass': 83644825}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.node(data, {'wikipedia:de': 'Foo%27s'}), expected={'class': 9011006, 'subclass': 556604422}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.node(data, {'wikipedia:de': 'Foo'}), expected={'class': 9011006, 'subclass': 556604422}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.node(data, {'wikipedia': 'en: foo'}), expected={'class': 9011007, 'subclass': 1273458928}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.node(data, {'wikipedia': 'en:foo'}), expected={'class': 9011007, 'subclass': 1273458928}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.node(data, {'wikipedia': 'en:foo'}), expected={'class': 9011008, 'subclass': 696665203}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.node(data, {'wikipedia': 'en:wiki/foo'}), expected={'class': 9011008, 'subclass': 696665203}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.node(data, {'wikipedia': 'en:Foo'}), expected={'class': 9011009, 'subclass': 1824269684}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.node(data, {'wikipedia': 'en:foo'}), expected={'class': 9011009, 'subclass': 1824269684}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.node(data, {'wikipedia': 'ru:Абв'}), expected={'class': 9011009, 'subclass': 1824269684}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.node(data, {'wikipedia': 'ru:абв'}), expected={'class': 9011009, 'subclass': 1824269684}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.node(data, {'wikipedia': 'en:foo bar'}), expected={'class': 9011010, 'subclass': 2024856824}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.node(data, {'wikipedia': 'en:foo_bar'}), expected={'class': 9011010, 'subclass': 2024856824}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.node(data, {'wikipedia': 'en:Bar'}), expected={'class': 9011011, 'subclass': 124114060}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.node(data, {'wikipedia': 'en:en:Foo'}), expected={'class': 9011011, 'subclass': 124114060}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.node(data, {'wikipedia': 'en:fr:Foo'}), expected={'class': 9011011, 'subclass': 124114060}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.node(data, {'wikidata': 'Q'}), expected={'class': 9011012, 'subclass': 1398622919}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.node(data, {'wikidata': 'Q0'}), expected={'class': 9011012, 'subclass': 1398622919}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.node(data, {'wikidata': 'Q0123'}), expected={'class': 9011012, 'subclass': 1398622919}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.node(data, {'wikidata': 'Q1'}), expected={'class': 9011012, 'subclass': 1398622919}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.node(data, {'wikidata': 'Q123'}), expected={'class': 9011012, 'subclass': 1398622919}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.node(data, {'wikidata': 'a'}), expected={'class': 9011012, 'subclass': 1398622919}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.node(data, {'wikipedia': 'a'}), expected={'class': 9011016, 'subclass': 346570414}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.node(data, {'wikipedia': 'de:Q'}), expected={'class': 9011016, 'subclass': 346570414}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.node(data, {'wikipedia': 'de:Q0'}), expected={'class': 9011016, 'subclass': 346570414}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.node(data, {'wikipedia': 'de:Q0123'}), expected={'class': 9011016, 'subclass': 346570414}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.node(data, {'wikipedia': 'de:Q1'}), expected={'class': 9011016, 'subclass': 346570414}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.node(data, {'wikipedia': 'de:Q123'}), expected={'class': 9011016, 'subclass': 346570414}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.node(data, {'wikipedia': 'de:a'}), expected={'class': 9011016, 'subclass': 346570414}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.node(data, {'wikipedia': 'en-GB:Q0123'}), expected={'class': 9011016, 'subclass': 346570414}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.node(data, {'wikipedia': 'en-GB:Q1'}), expected={'class': 9011016, 'subclass': 346570414}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.node(data, {'wikipedia': 'en-GB:Q123'}), expected={'class': 9011016, 'subclass': 346570414}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.node(data, {'wikipedia:en': 'a'}), expected={'class': 9011015, 'subclass': 153018468}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.node(data, {'wikipedia': 'Foo'}), expected={'class': 9011015, 'subclass': 153018468}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.node(data, {'wikipedia': 'a', 'wikipedia:en': 'b'}), expected={'class': 9011015, 'subclass': 153018468}, disallowed_str_in_text = ['{', '}'])
