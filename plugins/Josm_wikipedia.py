...
class Josm_wikipedia(Plugin):
    ...
    def node(self, data, tags):
        ...
        if (u'wikipedia' in keys):
            match = False
            try: match = match or ((mapcss._tag_capture(capture_tags, 0, tags, u'wikipedia') and not mapcss.regexp_test_(mapcss._value_capture(capture_tags, 1, self.re_07f8e639), mapcss._tag_capture(capture_tags, 1, tags, u'wikipedia'))))
        ...
        if (u'wikipedia' in keys):
            match = False
            try: match = match or ((mapcss.regexp_test_(mapcss._value_capture(capture_tags, 0, self.re_1f90813f), mapcss._tag_capture(capture_tags, 0, tags, u'wikipedia'))))
            except mapcss.RuleAbort: pass
            try: match = match or ((mapcss.regexp_test_(mapcss._value_capture(capture_tags, 0, self.re_091c4afa), mapcss._tag_capture(capture_tags, 0, tags, u'wikipedia'))))
            except mapcss.RuleAbort: pass
            if match:
        ...
        if (u'wikipedia' in keys):
            match = False
            try: match = match or ((mapcss.regexp_test_(mapcss._value_capture(capture_tags, 0, self.re_53b6f173), mapcss._tag_capture(capture_tags, 0, tags, u'wikipedia'))))
            except mapcss.RuleAbort: pass
            if match:
                ...
                err.append({'class': 9011004, 'subclass': 616152609, 'text': mapcss.tr(u'wikipedia \'\'{0}\'\' language is obsolete, use \'\'{1}\'\' instead', u'be-x-old', u'be-tarask'), 'fix': {
                    '+': dict([
        ...
        if (u'wikipedia' in keys):
            match = False
            try: match = match or ((mapcss.regexp_test_(mapcss._value_capture(capture_tags, 0, self.re_034ab801), mapcss._tag_capture(capture_tags, 0, tags, u'wikipedia'))))
            except mapcss.RuleAbort: pass
            if match:
                ...
                err.append({'class': 9011005, 'subclass': 243392039, 'text': mapcss.tr(u'wikipedia \'\'{0}\'\' language is invalid, use \'\'{1}\'\' instead', u'cz', u'cs'), 'fix': {
                    '+': dict([
        ...
        if (u'wikimedia_commons' in keys):
            match = False
            try: match = match or ((mapcss.regexp_test_(mapcss._value_capture(capture_tags, 0, self.re_210c6ccc), mapcss._tag_capture(capture_tags, 0, tags, u'wikimedia_commons'))))
            except mapcss.RuleAbort: pass
            if match:
                ...
                err.append({'class': 9011006, 'subclass': 1999051286, 'text': mapcss.tr(u'{0} tag should not have URL-encoded values like \'\'%27\'\'', mapcss._tag_uncapture(capture_tags, u'{0.key}')), 'fix': {
                    '+': dict([
        ...
        if (u'wikipedia' in keys):
            match = False
            try: match = match or ((mapcss.regexp_test_(mapcss._value_capture(capture_tags, 0, self.re_19995c46), mapcss._tag_capture(capture_tags, 0, tags, u'wikipedia'))))
            except mapcss.RuleAbort: pass
            if match:
                ...
                err.append({'class': 9011006, 'subclass': 83644825, 'text': mapcss.tr(u'{0} tag should not have URL-encoded values like \'\'%27\'\'', mapcss._tag_uncapture(capture_tags, u'{0.tag}')), 'fix': {
                    '+': dict([
        ...
        if (u'wikipedia' in keys):
            match = False
            try: match = match or ((mapcss.regexp_test_(mapcss._value_capture(capture_tags, 0, self.re_536e5b67), mapcss._tag_capture(capture_tags, 0, tags, u'wikipedia'))))
            except mapcss.RuleAbort: pass
            if match:
                ...
                # assertNoMatch:"node wikipedia=en:foo"
                err.append({'class': 9011007, 'subclass': 1273458928, 'text': mapcss.tr(u'wikipedia title should not start with a space after language code'), 'fix': {
                    '+': dict([
        ...
        if (u'wikipedia' in keys):
            match = False
            try: match = match or ((mapcss.regexp_test_(mapcss._value_capture(capture_tags, 0, self.re_67c3b565), mapcss._tag_capture(capture_tags, 0, tags, u'wikipedia'))))
            except mapcss.RuleAbort: pass
            if match:
                ...
                err.append({'class': 9011008, 'subclass': 696665203, 'text': mapcss.tr(u'wikipedia title should not have \'\'{0}\'\' prefix', u'wiki/'), 'fix': {
                    '+': dict([
        ...
        if (u'wikipedia' in keys):
            ...
            if match:
                ...
                err.append({'class': 9011009, 'subclass': 1824269684, 'text': mapcss.tr(u'wikipedia page title should have first letter capitalized'), 'fix': {
                    '+': dict([
        ...
        if (u'wikipedia' in keys):
            match = False
            try: match = match or ((mapcss.regexp_test_(mapcss._value_capture(capture_tags, 0, self.re_08b52119), mapcss._tag_capture(capture_tags, 0, tags, u'wikipedia')) and not mapcss.regexp_test_(mapcss._value_capture(capture_tags, 1, self.re_2d3d5d3d), mapcss._tag_capture(capture_tags, 1, tags, u'wikipedia'))))
            except mapcss.RuleAbort: pass
            if match:
                ...
                err.append({'class': 9011010, 'subclass': 2024856824, 'text': mapcss.tr(u'wikipedia page title should have spaces instead of underscores (\'\'_\'\'→\'\' \'\')'), 'fix': {
                    '+': dict([
        ...
        if (u'wikipedia' in keys):
            match = False
            try: match = match or ((mapcss.startswith(mapcss._tag_capture(capture_tags, 0, tags, u'wikipedia'), mapcss._value_capture(capture_tags, 0, u'da:da:'))))
            except mapcss.RuleAbort: pass
            try: match = match or ((mapcss.startswith(mapcss._tag_capture(capture_tags, 0, tags, u'wikipedia'), mapcss._value_capture(capture_tags, 0, u'da:dk:'))))
            except mapcss.RuleAbort: pass
            try: match = match or ((mapcss.startswith(mapcss._tag_capture(capture_tags, 0, tags, u'wikipedia'), mapcss._value_capture(capture_tags, 0, u'de:de:'))))
            except mapcss.RuleAbort: pass
            try: match = match or ((mapcss.startswith(mapcss._tag_capture(capture_tags, 0, tags, u'wikipedia'), mapcss._value_capture(capture_tags, 0, u'dk:dk:'))))
            except mapcss.RuleAbort: pass
            try: match = match or ((mapcss.startswith(mapcss._tag_capture(capture_tags, 0, tags, u'wikipedia'), mapcss._value_capture(capture_tags, 0, u'en:de:'))))
            except mapcss.RuleAbort: pass
            try: match = match or ((mapcss.startswith(mapcss._tag_capture(capture_tags, 0, tags, u'wikipedia'), mapcss._value_capture(capture_tags, 0, u'en:en:'))))
            except mapcss.RuleAbort: pass
            try: match = match or ((mapcss.startswith(mapcss._tag_capture(capture_tags, 0, tags, u'wikipedia'), mapcss._value_capture(capture_tags, 0, u'en:es:'))))
            except mapcss.RuleAbort: pass
            try: match = match or ((mapcss.startswith(mapcss._tag_capture(capture_tags, 0, tags, u'wikipedia'), mapcss._value_capture(capture_tags, 0, u'en:eu:'))))
            except mapcss.RuleAbort: pass
            try: match = match or ((mapcss.startswith(mapcss._tag_capture(capture_tags, 0, tags, u'wikipedia'), mapcss._value_capture(capture_tags, 0, u'en:fr:'))))
            except mapcss.RuleAbort: pass
            try: match = match or ((mapcss.startswith(mapcss._tag_capture(capture_tags, 0, tags, u'wikipedia'), mapcss._value_capture(capture_tags, 0, u'en:ja:'))))
            except mapcss.RuleAbort: pass
            try: match = match or ((mapcss.startswith(mapcss._tag_capture(capture_tags, 0, tags, u'wikipedia'), mapcss._value_capture(capture_tags, 0, u'en:pl:'))))
            except mapcss.RuleAbort: pass
            try: match = match or ((mapcss.startswith(mapcss._tag_capture(capture_tags, 0, tags, u'wikipedia'), mapcss._value_capture(capture_tags, 0, u'en:pt:'))))
            except mapcss.RuleAbort: pass
            try: match = match or ((mapcss.startswith(mapcss._tag_capture(capture_tags, 0, tags, u'wikipedia'), mapcss._value_capture(capture_tags, 0, u'en:zh:'))))
            except mapcss.RuleAbort: pass
            try: match = match or ((mapcss.startswith(mapcss._tag_capture(capture_tags, 0, tags, u'wikipedia'), mapcss._value_capture(capture_tags, 0, u'es:es:'))))
            except mapcss.RuleAbort: pass
            try: match = match or ((mapcss.startswith(mapcss._tag_capture(capture_tags, 0, tags, u'wikipedia'), mapcss._value_capture(capture_tags, 0, u'eu:eu:'))))
            except mapcss.RuleAbort: pass
            try: match = match or ((mapcss.startswith(mapcss._tag_capture(capture_tags, 0, tags, u'wikipedia'), mapcss._value_capture(capture_tags, 0, u'fr:fr:'))))
            except mapcss.RuleAbort: pass
            try: match = match or ((mapcss.startswith(mapcss._tag_capture(capture_tags, 0, tags, u'wikipedia'), mapcss._value_capture(capture_tags, 0, u'ja:ja:'))))
            except mapcss.RuleAbort: pass
            try: match = match or ((mapcss.startswith(mapcss._tag_capture(capture_tags, 0, tags, u'wikipedia'), mapcss._value_capture(capture_tags, 0, u'pl:en:'))))
            except mapcss.RuleAbort: pass
            try: match = match or ((mapcss.startswith(mapcss._tag_capture(capture_tags, 0, tags, u'wikipedia'), mapcss._value_capture(capture_tags, 0, u'pl:pl:'))))
            except mapcss.RuleAbort: pass
            try: match = match or ((mapcss.startswith(mapcss._tag_capture(capture_tags, 0, tags, u'wikipedia'), mapcss._value_capture(capture_tags, 0, u'pt:pt:'))))
            except mapcss.RuleAbort: pass
            try: match = match or ((mapcss.startswith(mapcss._tag_capture(capture_tags, 0, tags, u'wikipedia'), mapcss._value_capture(capture_tags, 0, u'ru:fr:'))))
            except mapcss.RuleAbort: pass
            try: match = match or ((mapcss.startswith(mapcss._tag_capture(capture_tags, 0, tags, u'wikipedia'), mapcss._value_capture(capture_tags, 0, u'ru:ru:'))))
            except mapcss.RuleAbort: pass
            try: match = match or ((mapcss.startswith(mapcss._tag_capture(capture_tags, 0, tags, u'wikipedia'), mapcss._value_capture(capture_tags, 0, u'zh:zh:'))))
            except mapcss.RuleAbort: pass
            if match:
                ...
                err.append({'class': 9011011, 'subclass': 124114060, 'text': mapcss.tr(u'wikipedia language seems to be duplicated, e.g. en:en:Foo'), 'fix': {
                    '+': dict([
        ...
        if (u'wikidata' in keys):
            match = False
            try: match = match or ((mapcss._tag_capture(capture_tags, 0, tags, u'wikidata') and not mapcss.regexp_test_(mapcss._value_capture(capture_tags, 1, self.re_4b567f18), mapcss._tag_capture(capture_tags, 1, tags, u'wikidata'))))
            except mapcss.RuleAbort: pass
            if match:
        ...
        if True:
            match = False
            try: match = match or ((not mapcss._tag_capture(capture_tags, 0, tags, u'wikipedia') and mapcss._tag_capture(capture_tags, 1, tags, self.re_79319bf9)))
            except mapcss.RuleAbort: pass
            if match:
