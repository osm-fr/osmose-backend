...
class Test(TestPluginCommon):
    def test(self):
        ...
        self.check_err(n.node(data, {'day_on': '0-12'}), expected={'class': 9002001, 'subclass': 294264920}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.node(data, {'name': 'FIXME'}), expected={'class': 9002005, 'subclass': 642340557}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.node(data, {'name': 'Fixme'}), expected={'class': 9002005, 'subclass': 642340557}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.node(data, {'name': 'fixme'}), expected={'class': 9002005, 'subclass': 642340557}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.node(data, {'name': 'valid name'}), expected={'class': 9002005, 'subclass': 642340557}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.node(data, {'f': 'b'}), expected={'class': 9002012, 'subclass': 79709106}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.node(data, {'fo': 'bar'}), expected={'class': 9002012, 'subclass': 79709106}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.node(data, {'kp': '5'}), expected={'class': 9002012, 'subclass': 79709106}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.node(data, {'pk': '7'}), expected={'class': 9002012, 'subclass': 79709106}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.node(data, {'emergency_telephone_code': '456', 'highway': 'emergency_access_point'}), expected={'class': 9002001, 'subclass': 1339208019}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.node(data, {'emergency_telephone_code': '456', 'highway': 'emergency_access_point', 'phone': '123'}), expected={'class': 9002001, 'subclass': 1339208019}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.node(data, {'highway': 'emergency_access_point', 'phone': '123'}), expected={'class': 9002001, 'subclass': 1339208019}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.node(data, {'phone': '123'}), expected={'class': 9002001, 'subclass': 1339208019}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.node(data, {'emergency_telephone_code': '123', 'highway': 'emergency_access_point'}), expected={'class': 9002001, 'subclass': 342466099}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.node(data, {'emergency_telephone_code': '123', 'highway': 'emergency_access_point', 'phone': '123'}), expected={'class': 9002001, 'subclass': 342466099}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.node(data, {'highway': 'emergency_access_point', 'phone': '123'}), expected={'class': 9002001, 'subclass': 342466099}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.node(data, {'emergency_telephone_code': '123', 'highway': 'emergency_access_point'}), expected={'class': 9002001, 'subclass': 663070970}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.node(data, {'emergency_telephone_code': '123', 'highway': 'emergency_access_point', 'phone': '123'}), expected={'class': 9002001, 'subclass': 663070970}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.node(data, {'highway': 'emergency_access_point', 'phone': '123'}), expected={'class': 9002001, 'subclass': 663070970}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.node(data, {'role': 'stop'}), expected={'class': 9002022, 'subclass': 2041296832}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.node(data, {'image': 'https://commons.wikimedia.org/wiki/File:2015-05-13_Basteibr%C3%BCcke-.jpg'}), expected={'class': 9002023, 'subclass': 2042174729}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.node(data, {'image': 'https://web.archive.org/web/20220623215400/https://westnordost.de/p/97331.jpg'}), expected={'class': 9002023, 'subclass': 2042174729}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.node(data, {'image': 'https://westnordost.de/p/17484.jpg'}), expected={'class': 9002023, 'subclass': 2042174729}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.way(data, {'barrier': 'fence'}, [0]), expected={'class': 9002001, 'subclass': 1107799632}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.way(data, {'barrier': 'wire_fence'}, [0]), expected={'class': 9002001, 'subclass': 1107799632}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.way(data, {'access': 'designated'}, [0]), expected={'class': 9002002, 'subclass': 2057594338}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.way(data, {'access': 'official'}, [0]), expected={'class': 9002003, 'subclass': 1909133836}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.way(data, {'fixme': 'yes'}, [0]), expected={'class': 9002004, 'subclass': 136657482}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.way(data, {'natural': 'land'}, [0]), expected={'class': 9002001, 'subclass': 94558529}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.way(data, {'color': 'red', 'colour': 'red'}, [0]), expected={'class': 9002001, 'subclass': 1850270072}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.way(data, {'color': 'red'}, [0]), expected={'class': 9002001, 'subclass': 1850270072}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.way(data, {'color': 'red', 'colour': 'green'}, [0]), expected={'class': 9002001, 'subclass': 1825345743}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.way(data, {'color': 'red', 'colour': 'red'}, [0]), expected={'class': 9002001, 'subclass': 1825345743}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.way(data, {'color': 'red', 'colour': 'green'}, [0]), expected={'class': 9002001, 'subclass': 1064658218}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.way(data, {'color': 'red', 'colour': 'red'}, [0]), expected={'class': 9002001, 'subclass': 1064658218}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.way(data, {'color': 'red'}, [0]), expected={'class': 9002001, 'subclass': 1632389707}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.way(data, {'cycleway:surface:color': 'grey'}, [0]), expected={'class': 9002001, 'subclass': 1632389707}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.way(data, {'roof:color': 'grey'}, [0]), expected={'class': 9002001, 'subclass': 1632389707}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.way(data, {'color:back': 'grey'}, [0]), expected={'class': 9002001, 'subclass': 1390370717}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.way(data, {'color': 'red'}, [0]), expected={'class': 9002001, 'subclass': 1390370717}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.way(data, {'route': 'ferry', 'to': 'Zuidschermer;Akersloot'}, [0]), expected={'class': 9002012, 'subclass': 1765060211}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.way(data, {'to': 'bar'}, [0]), expected={'class': 9002012, 'subclass': 1765060211}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.way(data, {'description_3': 'foo'}, [0]), expected={'class': 9002014, 'subclass': 2081989305}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.way(data, {'name_1': 'foo'}, [0]), expected={'class': 9002014, 'subclass': 2081989305}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.way(data, {'note_2': 'foo'}, [0]), expected={'class': 9002014, 'subclass': 2081989305}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.way(data, {'tiger:name_base_1': 'bar'}, [0]), expected={'class': 9002014, 'subclass': 2081989305}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.way(data, {'building': 'supermarket', 'building:type': 'church'}, [0]), expected={'class': 9002001, 'subclass': 1927794430}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.way(data, {'building': 'yes', 'building:type': 'church'}, [0]), expected={'class': 9002001, 'subclass': 1927794430}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.way(data, {'building:type': 'church'}, [0]), expected={'class': 9002001, 'subclass': 1927794430}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.way(data, {'building': 'supermarket', 'building:type': 'church'}, [0]), expected={'class': 9002001, 'subclass': 1133239698}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.way(data, {'building': 'yes', 'building:type': 'church'}, [0]), expected={'class': 9002001, 'subclass': 1133239698}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.way(data, {'building:type': 'church'}, [0]), expected={'class': 9002001, 'subclass': 1133239698}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.way(data, {'natural': 'shingle', 'water': 'river', 'waterway': 'riverbank'}, [0]), expected={'class': 9002001, 'subclass': 1604946271}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.way(data, {'natural': 'shingle', 'waterway': 'riverbank'}, [0]), expected={'class': 9002001, 'subclass': 1604946271}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.way(data, {'natural': 'water', 'water': 'lake', 'waterway': 'riverbank'}, [0]), expected={'class': 9002001, 'subclass': 1604946271}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.way(data, {'natural': 'water', 'water': 'river', 'waterway': 'riverbank'}, [0]), expected={'class': 9002001, 'subclass': 1604946271}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.way(data, {'natural': 'water', 'waterway': 'riverbank'}, [0]), expected={'class': 9002001, 'subclass': 1604946271}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.way(data, {'water': 'lake', 'waterway': 'riverbank'}, [0]), expected={'class': 9002001, 'subclass': 1604946271}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.way(data, {'water': 'river', 'waterway': 'riverbank'}, [0]), expected={'class': 9002001, 'subclass': 1604946271}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.way(data, {'waterway': 'riverbank'}, [0]), expected={'class': 9002001, 'subclass': 1604946271}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.way(data, {'natural': 'shingle', 'waterway': 'riverbank'}, [0]), expected={'class': 9002001, 'subclass': 301661430}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.way(data, {'natural': 'water', 'water': 'river', 'waterway': 'riverbank'}, [0]), expected={'class': 9002001, 'subclass': 301661430}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.way(data, {'natural': 'water', 'waterway': 'riverbank'}, [0]), expected={'class': 9002001, 'subclass': 301661430}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.way(data, {'water': 'lake', 'waterway': 'riverbank'}, [0]), expected={'class': 9002001, 'subclass': 301661430}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.way(data, {'water': 'river', 'waterway': 'riverbank'}, [0]), expected={'class': 9002001, 'subclass': 301661430}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.way(data, {'waterway': 'riverbank'}, [0]), expected={'class': 9002001, 'subclass': 301661430}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.way(data, {'cuisine': 'BBQ'}, [0]), expected={'class': 9002001, 'subclass': 1943338875}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.way(data, {'cuisine': 'bbq'}, [0]), expected={'class': 9002001, 'subclass': 1943338875}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.way(data, {'cuisine': 'bbq;pizza'}, [0]), expected={'class': 9002001, 'subclass': 1943338875}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.way(data, {'cuisine': 'korean_bbq'}, [0]), expected={'class': 9002001, 'subclass': 1943338875}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.way(data, {'cuisine': 'korean_bbq;bbq'}, [0]), expected={'class': 9002001, 'subclass': 1943338875}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.way(data, {'cuisine': 'pasta;bbq;pizza'}, [0]), expected={'class': 9002001, 'subclass': 1943338875}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.way(data, {'cuisine': 'pizza;Bbq'}, [0]), expected={'class': 9002001, 'subclass': 1943338875}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.way(data, {'cuisine': 'pizza;bbq'}, [0]), expected={'class': 9002001, 'subclass': 1943338875}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.way(data, {'cuisine': 'BBQ'}, [0]), expected={'class': 9002001, 'subclass': 1958782130}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.way(data, {'cuisine': 'bbq'}, [0]), expected={'class': 9002001, 'subclass': 1958782130}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.way(data, {'cuisine': 'bbq;pizza'}, [0]), expected={'class': 9002001, 'subclass': 1958782130}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.way(data, {'cuisine': 'korean_bbq'}, [0]), expected={'class': 9002001, 'subclass': 1958782130}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.way(data, {'cuisine': 'korean_bbq;bbq'}, [0]), expected={'class': 9002001, 'subclass': 1958782130}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.way(data, {'cuisine': 'pasta;bbq;pizza'}, [0]), expected={'class': 9002001, 'subclass': 1958782130}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.way(data, {'cuisine': 'pizza;Bbq'}, [0]), expected={'class': 9002001, 'subclass': 1958782130}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.way(data, {'cuisine': 'pizza;bbq'}, [0]), expected={'class': 9002001, 'subclass': 1958782130}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.way(data, {'FIXME': 'foo'}, [0]), expected={'class': 9002001, 'subclass': 592643943}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.way(data, {'Fixme': 'foo'}, [0]), expected={'class': 9002001, 'subclass': 592643943}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.way(data, {'fixme': 'foo'}, [0]), expected={'class': 9002001, 'subclass': 592643943}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.relation(data, {'fo': 'bar'}, []), expected={'class': 9002012, 'subclass': 518970721}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.relation(data, {'to': 'Berlin'}, []), expected={'class': 9002012, 'subclass': 518970721}, disallowed_str_in_text = ['{', '}'])
