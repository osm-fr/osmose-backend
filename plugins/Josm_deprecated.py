...
class Josm_deprecated(Plugin):
    ...
    def node(self, data, tags):
        ...
        if (u'barrier' in keys):
            ...
            if match:
                ...
                err.append({'class': 9002001, 'subclass': 1107799632, 'text': mapcss.tr(u'{0} is deprecated', mapcss._tag_uncapture(capture_tags, u'{0.tag}')), 'fix': {
                    '+': dict([
                    [u'barrier',u'fence'],
        ...
        if (u'barrier' in keys):
            ...
            if match:
                ...
                err.append({'class': 9002001, 'subclass': 1412230714, 'text': mapcss.tr(u'{0} is deprecated', mapcss._tag_uncapture(capture_tags, u'{0.tag}')), 'fix': {
                    '+': dict([
                    [u'barrier',u'fence'],
                    [u'fence_type',u'wood']])
                }})
        ...
        if (u'highway' in keys):
            ...
            if match:
                ...
                # fixAdd:"ford=yes"
                # fixRemove:"highway"
                err.append({'class': 9002001, 'subclass': 1317841090, 'text': mapcss.tr(u'{0} is deprecated', mapcss._tag_uncapture(capture_tags, u'{0.tag}')), 'fix': {
                    '+': dict([
                    [u'ford',u'yes']]),
                    '-': ([
                    u'highway'])
        ...
        if (u'highway' in keys):
            ...
            if match:
                ...
                # fixRemove:"highway"
                err.append({'class': 9002001, 'subclass': 1435678043, 'text': mapcss.tr(u'{0} is deprecated', mapcss._tag_uncapture(capture_tags, u'{0.tag}')), 'fix': {
                    '+': dict([
                    [u'barrier',u'stile']]),
                    '-': ([
                    u'highway'])
        ...
        if (u'highway' in keys):
            ...
            if match:
                ...
                err.append({'class': 9002001, 'subclass': 20631498, 'text': mapcss.tr(u'{0} is deprecated', mapcss._tag_uncapture(capture_tags, u'{0.tag}')), 'fix': {
                    '+': dict([
                    [u'highway',u'road'],
                    [u'surface',u'unpaved']])
                }})
        ...
        if (u'natural' in keys):
            ...
            if match:
                ...
                err.append({'class': 9002001, 'subclass': 1459865523, 'text': mapcss.tr(u'{0} is deprecated', mapcss._tag_uncapture(capture_tags, u'{0.tag}')), 'fix': {
                    '+': dict([
                    [u'natural',u'wetland'],
                    [u'wetland',u'marsh']])
                }})
        ...
        if (u'power_source' in keys):
            match = False
            try: match = match or ((mapcss._tag_capture(capture_tags, 0, tags, u'power_source')))
            except mapcss.RuleAbort: pass
            if match:
                # group:tr("deprecated tagging")
        ...
        if (u'power_rating' in keys):
            match = False
            try: match = match or ((mapcss._tag_capture(capture_tags, 0, tags, u'power_rating')))
            except mapcss.RuleAbort: pass
            if match:
                # group:tr("deprecated tagging")
                # throwWarning:tr("{0} is deprecated","{0.key}")
        ...
        if (u'shop' in keys):
            ...
            if match:
                ...
                err.append({'class': 9002001, 'subclass': 596668979, 'text': mapcss.tr(u'{0} is deprecated', mapcss._tag_uncapture(capture_tags, u'{0.tag}')), 'fix': {
                    '+': dict([
                    [u'shop',u'antiques']])
                }})
        ...
        if (u'shop' in keys):
            ...
            if match:
                ...
                # fixAdd:"shop=bag"
                err.append({'class': 9002001, 'subclass': 1709003584, 'text': mapcss.tr(u'{0} is deprecated', mapcss._tag_uncapture(capture_tags, u'{0.tag}')), 'fix': {
                    '+': dict([
                    [u'shop',u'bag']])
                }})
        ...
        if (u'shop' in keys):
            ...
            if match:
                ...
                # fixAdd:"shop=pet"
                err.append({'class': 9002001, 'subclass': 290270098, 'text': mapcss.tr(u'{0} is deprecated', mapcss._tag_uncapture(capture_tags, u'{0.tag}')), 'fix': {
                    '+': dict([
                    [u'shop',u'pet']])
                }})
        ...
        if (u'shop' in keys):
            ...
            if match:
                ...
                err.append({'class': 9002001, 'subclass': 350722657, 'text': mapcss.tr(u'{0} is deprecated', mapcss._tag_uncapture(capture_tags, u'{0.tag}')), 'fix': {
                    '+': dict([
        ...
        if (u'bicycle_parking' in keys):
            ...
            if match:
                ...
                err.append({'class': 9002001, 'subclass': 718874663, 'text': mapcss.tr(u'{0} is deprecated', mapcss._tag_uncapture(capture_tags, u'{0.tag}')), 'fix': {
                    '+': dict([
        ...
        if (u'amenity' in keys):
            ...
            if match:
                ...
                err.append({'class': 9002001, 'subclass': 1108230656, 'text': mapcss.tr(u'{0} is deprecated', mapcss._tag_uncapture(capture_tags, u'{0.tag}')), 'fix': {
                    '+': dict([
                    [u'emergency',u'phone']]),
                    '-': ([
                    u'amenity'])
        ...
        if (u'sport' in keys):
            ...
            if match:
                ...
                err.append({'class': 9002001, 'subclass': 1768681881, 'text': mapcss.tr(u'{0} is deprecated', mapcss._tag_uncapture(capture_tags, u'{0.tag}')), 'fix': {
                    '+': dict([
        ...
        if (u'power' in keys):
            ...
            if match:
                ...
                err.append({'class': 9002001, 'subclass': 1423074682, 'text': mapcss.tr(u'{0} is deprecated', mapcss._tag_uncapture(capture_tags, u'{0.tag}')), 'fix': {
                    '+': dict([
        ...
        if (u'generator:method' in keys):
            ...
            if match:
                ...
                err.append({'class': 9002001, 'subclass': 248819368, 'text': mapcss.tr(u'{0} is deprecated', mapcss._tag_uncapture(capture_tags, u'{0.tag}')), 'fix': {
                    '+': dict([
        ...
        if (u'generator:method' in keys):
            ...
            if match:
                ...
                err.append({'class': 9002001, 'subclass': 93454158, 'text': mapcss.tr(u'{0} is deprecated', mapcss._tag_uncapture(capture_tags, u'{0.tag}')), 'fix': {
                    '+': dict([
        ...
        if (u'generator:method' in keys):
            ...
            if match:
                ...
                # suggestAlternative:"generator:method=water-pumped-storage"
                # fixAdd:"generator:method=water-pumped-storage"
                err.append({'class': 9002001, 'subclass': 2115673716, 'text': mapcss.tr(u'{0} is deprecated', mapcss._tag_uncapture(capture_tags, u'{0.tag}')), 'fix': {
                    '+': dict([
                    [u'generator:method',u'water-pumped-storage']])
                }})
        ...
        if (u'board_type' in keys):
            ...
            if match:
                ...
                err.append({'class': 9002001, 'subclass': 1150949316, 'text': mapcss.tr(u'{0} is deprecated', mapcss._tag_uncapture(capture_tags, u'{0.tag}')), 'fix': {
                    '-': ([
                    u'board_type'])
                }})
        ...
        if (u'man_made' in keys):
            ...
            if match:
                ...
                err.append({'class': 9002001, 'subclass': 700465123, 'text': mapcss.tr(u'{0} is deprecated', mapcss._tag_uncapture(capture_tags, u'{0.tag}')), 'fix': {
                    '+': dict([
        ...
        if (u'measurement' in keys):
            ...
            if match:
                ...
                err.append({'class': 9002001, 'subclass': 634647702, 'text': mapcss.tr(u'{0} is deprecated', mapcss._tag_uncapture(capture_tags, u'{0.tag}')), 'fix': {
                    '+': dict([
        ...
        if (u'measurement' in keys):
            ...
            if match:
                ...
                err.append({'class': 9002001, 'subclass': 336627227, 'text': mapcss.tr(u'{0} is deprecated', mapcss._tag_uncapture(capture_tags, u'{0.tag}')), 'fix': {
                    '+': dict([
        ...
        if (u'measurement' in keys):
            ...
            if match:
                ...
                err.append({'class': 9002001, 'subclass': 1402131289, 'text': mapcss.tr(u'{0} is deprecated', mapcss._tag_uncapture(capture_tags, u'{0.tag}')), 'fix': {
                    '+': dict([
        ...
        if (u'monitoring:river_level' in keys):
            match = False
            try: match = match or ((mapcss._tag_capture(capture_tags, 0, tags, u'monitoring:river_level')))
            except mapcss.RuleAbort: pass
            if match:
                # group:tr("deprecated tagging")
                # throwWarning:tr("{0} is deprecated","{0.key}")
                ...
                err.append({'class': 9002001, 'subclass': 264907924, 'text': mapcss.tr(u'{0} is deprecated', mapcss._tag_uncapture(capture_tags, u'{0.key}')), 'fix': {
                    '+': dict([
        ...
        if (u'stay' in keys):
            match = False
            try: match = match or ((mapcss._tag_capture(capture_tags, 0, tags, u'stay')))
            except mapcss.RuleAbort: pass
            if match:
                # group:tr("deprecated tagging")
                # throwWarning:tr("{0} is deprecated","{0.key}")
                ...
                err.append({'class': 9002001, 'subclass': 787370129, 'text': mapcss.tr(u'{0} is deprecated', mapcss._tag_uncapture(capture_tags, u'{0.key}')), 'fix': {
                    '+': dict([
        ...
        if (u'emergency' in keys):
            ...
            if match:
                ...
                err.append({'class': 9002001, 'subclass': 707111885, 'text': mapcss.tr(u'{0} is deprecated', mapcss._tag_uncapture(capture_tags, u'{0.tag}')), 'fix': {
                    '+': dict([
        ...
        if (u'date_off' in keys) or (u'date_on' in keys) or (u'day_off' in keys) or (u'day_on' in keys) or (u'hour_off' in keys) or (u'hour_on' in keys):
            match = False
            try: match = match or ((mapcss._tag_capture(capture_tags, 0, tags, u'day_on') and not mapcss._tag_capture(capture_tags, 1, tags, u'restriction')))
            except mapcss.RuleAbort: pass
            try: match = match or ((mapcss._tag_capture(capture_tags, 0, tags, u'day_off') and not mapcss._tag_capture(capture_tags, 1, tags, u'restriction')))
            except mapcss.RuleAbort: pass
            try: match = match or ((mapcss._tag_capture(capture_tags, 0, tags, u'date_on') and not mapcss._tag_capture(capture_tags, 1, tags, u'restriction')))
            except mapcss.RuleAbort: pass
            try: match = match or ((mapcss._tag_capture(capture_tags, 0, tags, u'date_off') and not mapcss._tag_capture(capture_tags, 1, tags, u'restriction')))
            except mapcss.RuleAbort: pass
            try: match = match or ((mapcss._tag_capture(capture_tags, 0, tags, u'hour_on') and not mapcss._tag_capture(capture_tags, 1, tags, u'restriction')))
            except mapcss.RuleAbort: pass
            try: match = match or ((mapcss._tag_capture(capture_tags, 0, tags, u'hour_off') and not mapcss._tag_capture(capture_tags, 1, tags, u'restriction')))
            except mapcss.RuleAbort: pass
            if match:
                # group:tr("deprecated tagging")
                # throwWarning:tr("{0} is deprecated","{0.key}")
        ...
        if (u'name' in keys):
            ...
            if match:
                ...
                err.append({'class': 9002005, 'subclass': 642340557, 'text': mapcss.tr(u'Wrong usage of {0} tag. Remove {1}, because it is clear that the name is missing even without an additional tag.', mapcss._tag_uncapture(capture_tags, u'{0.key}'), mapcss._tag_uncapture(capture_tags, u'{0.tag}')), 'fix': {
                    '-': ([
                    u'name'])
                }})
        ...
        if (u'type' in keys):
            ...
            if match:
                ...
                # fixRemove:"{0.key}"
                err.append({'class': 9002001, 'subclass': 293968062, 'text': mapcss.tr(u'{0} is deprecated', mapcss._tag_uncapture(capture_tags, u'{0.tag}')), 'fix': {
                    '+': dict([
        ...
        if (u'type' in keys) or (u'wood' in keys):
            ...
            if match:
                ...
                # fixRemove:"{0.key}"
                err.append({'class': 9002001, 'subclass': 50517650, 'text': mapcss.tr(u'{0} is deprecated', mapcss._tag_uncapture(capture_tags, u'{0.tag}')), 'fix': {
                    '+': dict([
        ...
        if (u'wood' in keys):
            ...
            if match:
                ...
                # fixRemove:"wood"
                err.append({'class': 9002001, 'subclass': 235914603, 'text': mapcss.tr(u'{0} is deprecated', mapcss._tag_uncapture(capture_tags, u'{0.tag}')), 'fix': {
                    '+': dict([
                    [u'leaf_type',u'mixed']]),
                    '-': ([
                    u'wood'])
        ...
        if (u'type' in keys) or (u'wood' in keys):
            ...
            if match:
                ...
                # fixRemove:"{0.key}"
                err.append({'class': 9002001, 'subclass': 747964532, 'text': mapcss.tr(u'{0} is deprecated', mapcss._tag_uncapture(capture_tags, u'{0.tag}')), 'fix': {
                    '+': dict([
        ...
        if (u'type' in keys):
            ...
            if match:
                ...
                # fixRemove:"type"
                err.append({'class': 9002001, 'subclass': 591116099, 'text': mapcss.tr(u'{0} is deprecated', mapcss._tag_uncapture(capture_tags, u'{0.tag}')), 'fix': {
                    '+': dict([
        ...
        if (u'bridge' in keys):
            ...
            if match:
                ...
                # fixAdd:"bridge=yes"
                err.append({'class': 9002001, 'subclass': 1157046268, 'text': mapcss.tr(u'{0} is deprecated', mapcss._tag_uncapture(capture_tags, u'{0.tag}')), 'fix': {
                    '+': dict([
        ...
        if True:
            match = False
            try: match = match or ((mapcss._tag_capture(capture_tags, 0, tags, self.re_5ee0acf2)))
            except mapcss.RuleAbort: pass
            if match:
                # group:tr("deprecated tagging")
        ...
        if (u'parking' in keys):
            ...
            if match:
                ...
                # fixRemove:"parking"
                err.append({'class': 9002001, 'subclass': 1893516041, 'text': mapcss.tr(u'{0} is deprecated', mapcss._tag_uncapture(capture_tags, u'{0.tag}')), 'fix': {
                    '+': dict([
                    [u'amenity',u'parking'],
                    [u'park_ride',u'yes']]),
                    '-': ([
        ...
        if (u'place_name' in keys):
            match = False
            try: match = match or ((mapcss._tag_capture(capture_tags, 0, tags, u'place_name') and not mapcss._tag_capture(capture_tags, 1, tags, u'name')))
            except mapcss.RuleAbort: pass
            if match:
                # throwWarning:tr("{0} should be replaced with {1}","{0.key}","{1.key}")
                # fixChangeKey:"place_name => name"
                err.append({'class': 9002008, 'subclass': 1089331760, 'text': mapcss.tr(u'{0} should be replaced with {1}', mapcss._tag_uncapture(capture_tags, u'{0.key}'), mapcss._tag_uncapture(capture_tags, u'{1.key}')), 'fix': {
                    '+': dict([
        ...
        if (u'place' in keys and u'place_name' in keys):
            ...
            if match:
                ...
                # fixRemove:"{1.key}"
                err.append({'class': 9002009, 'subclass': 1116761280, 'text': mapcss.tr(u'{0} = {1}; remove {0}', mapcss._tag_uncapture(capture_tags, u'{1.key}'), mapcss._tag_uncapture(capture_tags, u'{1.value}')), 'fix': {
                    '-': ([
        ...
        if (u'waterway' in keys):
            ...
            if match:
                ...
                err.append({'class': 9002001, 'subclass': 103347605, 'text': mapcss.tr(u'{0} is deprecated', mapcss._tag_uncapture(capture_tags, u'{0.tag}')), 'fix': {
                    '+': dict([
        ...
        if (u'waterway' in keys):
            ...
            if match:
                ...
                # fixChangeKey:"waterway => amenity"
                err.append({'class': 9002001, 'subclass': 1963461348, 'text': mapcss.tr(u'{0} is deprecated', mapcss._tag_uncapture(capture_tags, u'{0.tag}')), 'fix': {
                    '+': dict([
                    [u'amenity', mapcss.tag(tags, u'waterway')]]),
                    '-': ([
                    u'waterway'])
        ...
        if (u'waterway' in keys):
            ...
            if match:
                ...
                # fixAdd:"mooring=yes"
                # fixRemove:"waterway"
                err.append({'class': 9002001, 'subclass': 81358738, 'text': mapcss.tr(u'{0} is deprecated', mapcss._tag_uncapture(capture_tags, u'{0.tag}')), 'fix': {
                    '+': dict([
                    [u'mooring',u'yes']]),
                    '-': ([
                    u'waterway'])
        ...
        if (u'building:part' in keys and u'levels' in keys) or (u'building' in keys and u'levels' in keys):
            match = False
            ...
            if match:
                ...
                err.append({'class': 9002001, 'subclass': 293177436, 'text': mapcss.tr(u'{0} is deprecated', mapcss._tag_uncapture(capture_tags, u'{1.key}')), 'fix': {
                    '+': dict([
        ...
        if (u'protected_class' in keys):
            match = False
            try: match = match or ((mapcss._tag_capture(capture_tags, 0, tags, u'protected_class')))
            except mapcss.RuleAbort: pass
            if match:
                # group:tr("deprecated tagging")
                # throwWarning:tr("{0} is deprecated","{0.key}")
                ...
                err.append({'class': 9002001, 'subclass': 716999373, 'text': mapcss.tr(u'{0} is deprecated', mapcss._tag_uncapture(capture_tags, u'{0.key}')), 'fix': {
                    '+': dict([
        ...
        if (u'drinkable' in keys):
            match = False
            try: match = match or ((mapcss._tag_capture(capture_tags, 0, tags, u'drinkable')))
            except mapcss.RuleAbort: pass
            if match:
                # group:tr("deprecated tagging")
                # throwWarning:tr("{0} is deprecated","{0.key}")
        ...
        if (u'color' in keys):
            match = False
            try: match = match or ((mapcss._tag_capture(capture_tags, 0, tags, u'color') and not mapcss._tag_capture(capture_tags, 1, tags, u'colour')))
            except mapcss.RuleAbort: pass
            if match:
                # group:tr("deprecated tagging")
                # throwWarning:tr("{0} is deprecated","{0.key}")
                ...
                err.append({'class': 9002001, 'subclass': 1850270072, 'text': mapcss.tr(u'{0} is deprecated', mapcss._tag_uncapture(capture_tags, u'{0.key}')), 'fix': {
                    '+': dict([
        ...
        if (u'color' in keys and u'colour' in keys):
            ...
            if match:
                ...
                # fixRemove:"color"
                set_samecolor = True
                err.append({'class': 9002001, 'subclass': 1825345743, 'text': mapcss.tr(u'{0} together with {1}', mapcss._tag_uncapture(capture_tags, u'{0.key}'), mapcss._tag_uncapture(capture_tags, u'{1.key}')), 'fix': {
                    '-': ([
                    u'color'])
                }})
        ...
        if (u'color' in keys and u'colour' in keys):
            match = False
            try: match = match or ((not set_samecolor and mapcss._tag_capture(capture_tags, 0, tags, u'color') and mapcss._tag_capture(capture_tags, 1, tags, u'colour')))
            except mapcss.RuleAbort: pass
            if match:
                # group:tr("deprecated tagging")
        ...
        if True:
            match = False
            try: match = match or ((mapcss._tag_capture(capture_tags, 0, tags, self.re_554de4c7) and not mapcss._tag_capture(capture_tags, 1, tags, u'building:color') and not mapcss._tag_capture(capture_tags, 2, tags, u'roof:color')))
            except mapcss.RuleAbort: pass
            if match:
                # group:tr("deprecated tagging")
                # throwWarning:tr("{0} is deprecated","{0.key}")
        ...
        if True:
            match = False
            try: match = match or ((mapcss._tag_capture(capture_tags, 0, tags, self.re_0c5b5730)))
            except mapcss.RuleAbort: pass
            if match:
                # group:tr("deprecated tagging")
                # throwWarning:tr("{0} is deprecated","{0.key}")
        ...
        if True:
            match = False
            try: match = match or ((mapcss._tag_capture(capture_tags, 0, tags, self.re_620f4d52)))
            except mapcss.RuleAbort: pass
            if match:
        ...
        if True:
            match = False
            try: match = match or ((mapcss._tag_capture(capture_tags, 0, tags, self.re_27210286)))
            except mapcss.RuleAbort: pass
            try: match = match or ((mapcss._tag_capture(capture_tags, 0, tags, self.re_34c15d62)))
            except mapcss.RuleAbort: pass
            if match:
        ...
        if (u'sport' in keys):
            ...
            if match:
                ...
                err.append({'class': 9002001, 'subclass': 1522897824, 'text': mapcss.tr(u'{0} is deprecated', mapcss._tag_uncapture(capture_tags, u'{0.tag}')), 'fix': {
                    '+': dict([
                    [u'sport',u'billiards']])
                }})
        ...
        if (u'payment:ep_cash' in keys) or (u'payment:ep_chipknip' in keys) or (u'payment:ep_proton' in keys) or (u'payment:ep_quick' in keys):
            match = False
            try: match = match or ((mapcss._tag_capture(capture_tags, 0, tags, u'payment:ep_quick')))
            except mapcss.RuleAbort: pass
            try: match = match or ((mapcss._tag_capture(capture_tags, 0, tags, u'payment:ep_cash')))
            except mapcss.RuleAbort: pass
            try: match = match or ((mapcss._tag_capture(capture_tags, 0, tags, u'payment:ep_proton')))
            except mapcss.RuleAbort: pass
            try: match = match or ((mapcss._tag_capture(capture_tags, 0, tags, u'payment:ep_chipknip')))
            except mapcss.RuleAbort: pass
            if match:
                # group:tr("deprecated tagging")
                # throwWarning:tr("{0} is deprecated","{0.key}")
                # fixRemove:"{0.key}"
                err.append({'class': 9002001, 'subclass': 332575437, 'text': mapcss.tr(u'{0} is deprecated', mapcss._tag_uncapture(capture_tags, u'{0.key}')), 'fix': {
                    '-': ([
                    mapcss._tag_uncapture(capture_tags, u'{0.key}')])
                }})
        ...
        if (u'highway' in keys and u'kp' in keys) or (u'kp' in keys and u'railway' in keys) or (u'kp' in keys and u'waterway' in keys):
            ...
            if match:
                ...
                err.append({'class': 9002001, 'subclass': 1078799228, 'text': mapcss.tr(u'{0} is deprecated', mapcss._tag_uncapture(capture_tags, u'{0.key}')), 'fix': {
                    '+': dict([
        ...
        if (u'highway' in keys and u'pk' in keys) or (u'pk' in keys and u'railway' in keys) or (u'pk' in keys and u'waterway' in keys):
            ...
            if match:
                ...
                err.append({'class': 9002001, 'subclass': 719029418, 'text': mapcss.tr(u'{0} is deprecated', mapcss._tag_uncapture(capture_tags, u'{0.key}')), 'fix': {
                    '+': dict([
        ...
        if (u'postcode' in keys):
            match = False
            try: match = match or ((mapcss._tag_capture(capture_tags, 0, tags, u'postcode')))
            except mapcss.RuleAbort: pass
            if match:
                # group:tr("deprecated tagging")
                # throwWarning:tr("{0} is deprecated","{0.key}")
        ...
        if (u'water' in keys):
            ...
            if match:
                ...
                # fixRemove:"water"
                err.append({'class': 9002001, 'subclass': 813530321, 'text': mapcss.tr(u'{0} is deprecated', mapcss._tag_uncapture(capture_tags, u'{0.tag}')), 'fix': {
                    '+': dict([
        ...
        if (u'pipeline' in keys and u'type' in keys):
            ...
            if match:
                ...
                err.append({'class': 9002001, 'subclass': 1878458659, 'text': mapcss.tr(u'{0} is deprecated', mapcss._tag_uncapture(capture_tags, u'{0.key}')), 'fix': {
                    '+': dict([
        ...
        if (u'seamark' in keys and u'seamark:type' in keys):
            ...
            if match:
                ...
                # fixRemove:"seamark"
                err.append({'class': 9002001, 'subclass': 1224401740, 'text': mapcss.tr(u'{0} is deprecated', mapcss._tag_uncapture(capture_tags, u'{0.tag}')), 'fix': {
                    '-': ([
                    u'seamark'])
                }})
        ...
        if (u'landuse' in keys):
            ...
            if match:
                ...
                # fixRemove:"landuse"
                err.append({'class': 9002001, 'subclass': 824801072, 'text': mapcss.tr(u'{0} is deprecated', mapcss._tag_uncapture(capture_tags, u'{0.tag}')), 'fix': {
                    '+': dict([
        ...
        if (u'amenity' in keys):
            ...
            if match:
                ...
                err.append({'class': 9002001, 'subclass': 1331930630, 'text': mapcss.tr(u'{0} is deprecated', mapcss._tag_uncapture(capture_tags, u'{0.tag}')), 'fix': {
                    '+': dict([
        ...
        if (u'shop' in keys):
            ...
            if match:
                ...
                # fixAdd:"shop=seafood"
                err.append({'class': 9002001, 'subclass': 1376789416, 'text': mapcss.tr(u'{0} is deprecated', mapcss._tag_uncapture(capture_tags, u'{0.tag}')), 'fix': {
                    '+': dict([
                    [u'shop',u'seafood']])
                }})
        ...
        if (u'shop' in keys):
            ...
            if match:
                ...
                err.append({'class': 9002001, 'subclass': 2075099676, 'text': mapcss.tr(u'{0} is deprecated', mapcss._tag_uncapture(capture_tags, u'{0.tag}')), 'fix': {
                    '+': dict([
                    [u'shop',u'perfumery']])
                }})
        ...
        if (u'amenity' in keys):
            ...
            if match:
                ...
                err.append({'class': 9002001, 'subclass': 1514920202, 'text': mapcss.tr(u'{0} is deprecated', mapcss._tag_uncapture(capture_tags, u'{0.tag}')), 'fix': {
                    '+': dict([
        ...
        if (u'shop' in keys):
            ...
            if match:
                ...
                err.append({'class': 9002001, 'subclass': 1675828779, 'text': mapcss.tr(u'{0} is deprecated', mapcss._tag_uncapture(capture_tags, u'{0.tag}')), 'fix': {
                    '+': dict([
                    [u'shop',u'car_parts']])
                }})
        ...
        if (u'amenity' in keys):
            ...
            if match:
                ...
                # fixChangeKey:"amenity => shop"
                err.append({'class': 9002001, 'subclass': 1681273585, 'text': mapcss.tr(u'{0} is deprecated', mapcss._tag_uncapture(capture_tags, u'{0.tag}')), 'fix': {
                    '+': dict([
                    [u'shop', mapcss.tag(tags, u'amenity')]]),
                    '-': ([
                    u'amenity'])
        ...
        if (u'amenity' in keys and u'type' in keys):
            ...
            if match:
                ...
                err.append({'class': 9002001, 'subclass': 413401822, 'text': mapcss.tr(u'{0} is deprecated for {1}', mapcss._tag_uncapture(capture_tags, u'{1.key}'), mapcss._tag_uncapture(capture_tags, u'{0.tag}')), 'fix': {
                    '+': dict([
        ...
        if (u'power' in keys):
            ...
            if match:
                ...
                # fixRemove:"power"
                err.append({'class': 9002001, 'subclass': 1007567078, 'text': mapcss.tr(u'{0} is deprecated', mapcss._tag_uncapture(capture_tags, u'{0.tag}')), 'fix': {
                    '+': dict([
        ...
        if (u'location' in keys and u'power' in keys):
            match = False
            try: match = match or ((mapcss._tag_capture(capture_tags, 0, tags, u'power') and mapcss._tag_capture(capture_tags, 1, tags, u'location') == mapcss._value_capture(capture_tags, 1, u'kiosk')))
            except mapcss.RuleAbort: pass
            if match:
                # group:tr("deprecated tagging")
                ...
                err.append({'class': 9002001, 'subclass': 182905067, 'text': mapcss.tr(u'{0} is deprecated', mapcss._tag_uncapture(capture_tags, u'{1.tag}')), 'fix': {
                    '+': dict([
                    [u'man_made',u'street_cabinet'],
        ...
        if (u'amenity' in keys):
            ...
            if match:
                ...
                err.append({'class': 9002001, 'subclass': 2091877281, 'text': mapcss.tr(u'{0} is deprecated', mapcss._tag_uncapture(capture_tags, u'{0.tag}')), 'fix': {
                    '+': dict([
        ...
        if (u'amenity' in keys):
            ...
            if match:
                ...
                err.append({'class': 9002001, 'subclass': 728429076, 'text': mapcss.tr(u'{0} is deprecated', mapcss._tag_uncapture(capture_tags, u'{0.tag}')), 'fix': {
                    '+': dict([
                    [u'tourism',u'artwork']]),
                    '-': ([
                    u'amenity'])
        ...
        if (u'amenity' in keys):
            ...
            if match:
                ...
                err.append({'class': 9002001, 'subclass': 690512681, 'text': mapcss.tr(u'{0} is deprecated', mapcss._tag_uncapture(capture_tags, u'{0.tag}')), 'fix': {
                    '+': dict([
        ...
        if (u'man_made' in keys):
            ...
            if match:
                ...
                err.append({'class': 9002001, 'subclass': 1008752382, 'text': mapcss.tr(u'{0} is deprecated', mapcss._tag_uncapture(capture_tags, u'{0.tag}')), 'fix': {
                    '+': dict([
        ...
        if (u'amenity' in keys):
            ...
            if match:
                ...
                # fixRemove:"amenity"
                # fixAdd:"leisure=park"
                err.append({'class': 9002001, 'subclass': 2085280194, 'text': mapcss.tr(u'{0} is deprecated', mapcss._tag_uncapture(capture_tags, u'{0.tag}')), 'fix': {
                    '+': dict([
                    [u'leisure',u'park']]),
                    '-': ([
                    u'amenity'])
        ...
        if (u'amenity' in keys):
            ...
            if match:
                ...
                err.append({'class': 9002001, 'subclass': 1341786818, 'text': mapcss.tr(u'{0} is deprecated', mapcss._tag_uncapture(capture_tags, u'{0.tag}')), 'fix': {
                    '+': dict([
                    [u'tourism',u'hotel']]),
                    '-': ([
                    u'amenity'])
        ...
        if (u'shop' in keys):
            ...
            if match:
                ...
                # fixRemove:"shop"
                err.append({'class': 9002001, 'subclass': 532391183, 'text': mapcss.tr(u'{0} is deprecated', mapcss._tag_uncapture(capture_tags, u'{0.tag}')), 'fix': {
                    '+': dict([
        ...
        if (u'shop' in keys):
            ...
            if match:
                ...
                # fixAdd:"shop=art"
                err.append({'class': 9002001, 'subclass': 1319611546, 'text': mapcss.tr(u'{0} is deprecated', mapcss._tag_uncapture(capture_tags, u'{0.tag}')), 'fix': {
                    '+': dict([
                    [u'shop',u'art']])
                }})
        ...
        if (u'office' in keys):
            ...
            if match:
                ...
                err.append({'class': 9002001, 'subclass': 1340846055, 'text': mapcss.tr(u'{0} is deprecated', mapcss._tag_uncapture(capture_tags, u'{0.tag}')), 'fix': {
                    '+': dict([
        ...
        if (u'amenity' in keys):
            ...
            if match:
                ...
                err.append({'class': 9002001, 'subclass': 2012807801, 'text': mapcss.tr(u'{0} is deprecated', mapcss._tag_uncapture(capture_tags, u'{0.tag}')), 'fix': {
                    '+': dict([
        ...
        if (u'vending' in keys):
            ...
            if match:
                ...
                err.append({'class': 9002001, 'subclass': 1133820292, 'text': mapcss.tr(u'{0} is deprecated', mapcss._tag_uncapture(capture_tags, u'{0.tag}')), 'fix': {
                    '+': dict([
        ...
        if (u'service' in keys):
            ...
            if match:
                ...
                err.append({'class': 9002001, 'subclass': 283545650, 'text': mapcss.tr(u'{0} is deprecated', mapcss._tag_uncapture(capture_tags, u'{0.tag}')), 'fix': {
                    '+': dict([
        ...
        if (u'name:botanical' in keys):
            match = False
            try: match = match or ((mapcss._tag_capture(capture_tags, 0, tags, u'name:botanical')))
            except mapcss.RuleAbort: pass
            if match:
                # group:tr("deprecated tagging")
                # throwWarning:tr("{0} is deprecated","{0.key}")
        ...
        if (u'pole' in keys):
            ...
            if match:
                ...
                # fixRemove:"pole"
                err.append({'class': 9002001, 'subclass': 647400518, 'text': mapcss.tr(u'{0} is deprecated', mapcss._tag_uncapture(capture_tags, u'{0.tag}')), 'fix': {
                    '+': dict([
        ...
        if (u'tower' in keys):
            ...
            if match:
                ...
                # fixAdd:"location:transition=yes"
                # fixRemove:"tower"
                err.append({'class': 9002001, 'subclass': 1616290060, 'text': mapcss.tr(u'{0} is deprecated', mapcss._tag_uncapture(capture_tags, u'{0.tag}')), 'fix': {
                    '+': dict([
                    [u'location:transition',u'yes']]),
                    '-': ([
                    u'tower'])
        ...
        if (u'shop' in keys):
            ...
            if match:
                ...
                # fixAdd:"shop=gift"
                err.append({'class': 9002001, 'subclass': 1794702946, 'text': mapcss.tr(u'{0} is deprecated', mapcss._tag_uncapture(capture_tags, u'{0.tag}')), 'fix': {
                    '+': dict([
                    [u'shop',u'gift']])
                }})
        ...
        if (u'vending' in keys):
            ...
            if match:
                ...
                err.append({'class': 9002001, 'subclass': 1077411296, 'text': mapcss.tr(u'{0} is deprecated', mapcss._tag_uncapture(capture_tags, u'{0.tag}')), 'fix': {
                    '+': dict([
        ...
        if (u'amenity' in keys and u'vending' in keys):
            ...
            if match:
                ...
                # fixRemove:"vending"
                err.append({'class': 9002001, 'subclass': 1387510120, 'text': mapcss.tr(u'{0} is deprecated', mapcss._tag_uncapture(capture_tags, u'{0.tag}')), 'fix': {
                    '+': dict([
        ...
        if (u'highway' in keys and u'phone' in keys):
            ...
            if match:
                ...
                err.append({'class': 9002001, 'subclass': 1339208019, 'text': mapcss.tr(u'{0} is deprecated for {1}', mapcss._tag_uncapture(capture_tags, u'{1.key}'), mapcss._tag_uncapture(capture_tags, u'{0.tag}')), 'fix': {
                    '+': dict([
        ...
        if (u'highway' in keys and u'phone' in keys):
            ...
            if match:
                ...
                err.append({'class': 9002001, 'subclass': 342466099, 'text': mapcss.tr(u'{0} is deprecated for {1}', mapcss._tag_uncapture(capture_tags, u'{1.key}'), mapcss._tag_uncapture(capture_tags, u'{0.tag}')), 'fix': {
                    '-': ([
                    u'phone'])
                }})
        ...
        if (u'amenity' in keys and u'lock' in keys):
            ...
            if match:
                ...
                err.append({'class': 9002001, 'subclass': 1939599742, 'text': mapcss.tr(u'{0} is deprecated for {1}', mapcss._tag_uncapture(capture_tags, u'{1.key}'), mapcss._tag_uncapture(capture_tags, u'{0.tag}')), 'fix': {
                    '+': dict([
        ...
        if (u'advertising' in keys and u'amenity' in keys):
            ...
            if match:
                ...
                # suggestAlternative:"advertising=*"
                # fixRemove:"amenity"
                err.append({'class': 9002001, 'subclass': 1538706366, 'text': mapcss.tr(u'{0} is deprecated', mapcss._tag_uncapture(capture_tags, u'{0.tag}')), 'fix': {
                    '-': ([
                    u'amenity'])
                }})
        ...
        if (u'location' in keys and u'power' in keys and u'transformer' in keys):
            match = False
            try: match = match or ((mapcss._tag_capture(capture_tags, 0, tags, u'power') == mapcss._value_capture(capture_tags, 0, u'transformer') and mapcss._tag_capture(capture_tags, 1, tags, u'location') == mapcss._value_capture(capture_tags, 1, u'pole') and mapcss._tag_capture(capture_tags, 2, tags, u'transformer')))
            except mapcss.RuleAbort: pass
            if match:
                # group:tr("deprecated tagging")
                # throwWarning:tr("{0} together with {1}","{0.tag}","{1.tag}")
                # fixChangeKey:"location => power"
                err.append({'class': 9002001, 'subclass': 161456790, 'text': mapcss.tr(u'{0} together with {1}', mapcss._tag_uncapture(capture_tags, u'{0.tag}'), mapcss._tag_uncapture(capture_tags, u'{1.tag}')), 'fix': {
                    '+': dict([
        ...
        if (u'location' in keys and u'power' in keys):
            match = False
            try: match = match or ((mapcss._tag_capture(capture_tags, 0, tags, u'power') == mapcss._value_capture(capture_tags, 0, u'transformer') and mapcss._tag_capture(capture_tags, 1, tags, u'location') == mapcss._value_capture(capture_tags, 1, u'pole') and not mapcss._tag_capture(capture_tags, 2, tags, u'transformer')))
            except mapcss.RuleAbort: pass
            if match:
                # group:tr("deprecated tagging")
                # throwWarning:tr("{0} together with {1}","{0.tag}","{1.tag}")
                ...
                err.append({'class': 9002001, 'subclass': 1830605870, 'text': mapcss.tr(u'{0} together with {1}', mapcss._tag_uncapture(capture_tags, u'{0.tag}'), mapcss._tag_uncapture(capture_tags, u'{1.tag}')), 'fix': {
                    '+': dict([
                    [u'power', mapcss.tag(tags, u'location')],
                    [u'transformer',u'yes']]),
                    '-': ([
        ...
        if (u'amenity' in keys) or (u'leisure' in keys) or (u'tourism' in keys):
            match = False
            try: match = match or ((mapcss._tag_capture(capture_tags, 0, tags, u'tourism') == mapcss._value_capture(capture_tags, 0, u'picnic_table')))
            except mapcss.RuleAbort: pass
            try: match = match or ((mapcss._tag_capture(capture_tags, 0, tags, u'amenity') == mapcss._value_capture(capture_tags, 0, u'picnic_table')))
            except mapcss.RuleAbort: pass
            try: match = match or ((mapcss._tag_capture(capture_tags, 0, tags, u'leisure') == mapcss._value_capture(capture_tags, 0, u'picnic')))
            except mapcss.RuleAbort: pass
            try: match = match or ((mapcss._tag_capture(capture_tags, 0, tags, u'leisure') == mapcss._value_capture(capture_tags, 0, u'picnic_site')))
            except mapcss.RuleAbort: pass
            if match:
                # group:tr("deprecated tagging")
                # throwWarning:tr("{0} is deprecated","{0.tag}")
        ...
        if (u'amenity' in keys):
            match = False
            try: match = match or ((mapcss._tag_capture(capture_tags, 0, tags, u'amenity') == mapcss._value_capture(capture_tags, 0, u'toilet')))
            except mapcss.RuleAbort: pass
            if match:
                ...
                err.append({'class': 9002018, 'subclass': 440018606, 'text': mapcss.tr(u'{0}', mapcss._tag_uncapture(capture_tags, u'{0.tag}')), 'fix': {
                    '+': dict([
                    [u'amenity',u'toilets']])
                }})
    ...
    def way(self, data, tags, nds):
        ...
        if (u'class' in keys):
            match = False
            try: match = match or ((mapcss._tag_capture(capture_tags, 0, tags, u'class')))
            except mapcss.RuleAbort: pass
            if match:
                # group:tr("deprecated tagging")
                # throwWarning:tr("{0} is deprecated","{0.key}")
        ...
        if (u'oneway' in keys):
            match = False
            try: match = match or ((mapcss._tag_capture(capture_tags, 0, tags, u'oneway') == mapcss._value_capture(capture_tags, 0, 1) and not mapcss._tag_capture(capture_tags, 1, tags, u'waterway')))
            except mapcss.RuleAbort: pass
            if match:
                # group:tr("deprecated tagging")
                # throwWarning:tr("{0} is deprecated","{0.tag}")
                ...
                # fixAdd:"oneway=yes"
                err.append({'class': 9002001, 'subclass': 430545008, 'text': mapcss.tr(u'{0} is deprecated', mapcss._tag_uncapture(capture_tags, u'{0.tag}')), 'fix': {
                    '+': dict([
                    [u'oneway',u'yes']])
                }})
        ...
        if (u'man_made' in keys and u'type' in keys):
            ...
            if match:
                ...
                # suggestAlternative:"substance"
                # fixChangeKey:"type => substance"
                err.append({'class': 9002001, 'subclass': 877981524, 'text': mapcss.tr(u'{0} is deprecated', mapcss._tag_uncapture(capture_tags, u'{0.key}')), 'fix': {
                    '+': dict([
                    [u'substance', mapcss.tag(tags, u'type')]]),
                    '-': ([
                    u'type'])
        ...
        if (u'barrier' in keys and u'type' in keys) or (u'barrier' in keys and u'type' in keys and u'wall' in keys):
            ...
            if match:
                ...
                err.append({'class': 9002001, 'subclass': 1513752031, 'text': mapcss.tr(u'{0} is deprecated', mapcss._tag_uncapture(capture_tags, u'{1.tag}')), 'fix': {
                    '+': dict([
        ...
        if (u'railway' in keys and u'service' in keys) or (u'highway' in keys and u'service' in keys) or (u'service' in keys and u'waterway' in keys):
            match = False
        ...
        if (u'highway' in keys and u'phone' in keys):
            ...
            if match:
                ...
                # suggestAlternative:"emergency_telephone_code"
                # fixChangeKey:"phone => emergency_telephone_code"
                err.append({'class': 9002001, 'subclass': 904792316, 'text': mapcss.tr(u'{0} is deprecated for {1}', mapcss._tag_uncapture(capture_tags, u'{1.key}'), mapcss._tag_uncapture(capture_tags, u'{0.tag}')), 'fix': {
                    '+': dict([
                    [u'emergency_telephone_code', mapcss.tag(tags, u'phone')]]),
                    '-': ([
                    u'phone'])
        ...
        if (u'highway' in keys and u'phone' in keys):
            ...
            if match:
                ...
                # suggestAlternative:"emergency_telephone_code"
                # fixRemove:"phone"
                err.append({'class': 9002001, 'subclass': 3132845, 'text': mapcss.tr(u'{0} is deprecated for {1}', mapcss._tag_uncapture(capture_tags, u'{1.key}'), mapcss._tag_uncapture(capture_tags, u'{0.tag}')), 'fix': {
                    '-': ([
                    u'phone'])
                }})
        ...
        if (u'tracktype' in keys):
            ...
            if match:
                ...
                err.append({'class': 9002018, 'subclass': 823078782, 'text': mapcss.tr(u'{0}', mapcss._tag_uncapture(capture_tags, u'{0.tag}')), 'fix': {
                    '+': dict([
        ...
        if (u'tracktype' in keys):
            ...
            if match:
                ...
                err.append({'class': 9002018, 'subclass': 652259155, 'text': mapcss.tr(u'{0}', mapcss._tag_uncapture(capture_tags, u'{0.tag}')), 'fix': {
                    '+': dict([
        ...
        if (u'tracktype' in keys):
            ...
            if match:
                ...
                err.append({'class': 9002018, 'subclass': 1624412111, 'text': mapcss.tr(u'{0}', mapcss._tag_uncapture(capture_tags, u'{0.tag}')), 'fix': {
                    '+': dict([
        ...
        if (u'tracktype' in keys):
            ...
            if match:
                ...
                err.append({'class': 9002018, 'subclass': 808384986, 'text': mapcss.tr(u'{0}', mapcss._tag_uncapture(capture_tags, u'{0.tag}')), 'fix': {
                    '+': dict([
        ...
        if (u'tracktype' in keys):
            ...
            if match:
                ...
                err.append({'class': 9002018, 'subclass': 1050276122, 'text': mapcss.tr(u'{0}', mapcss._tag_uncapture(capture_tags, u'{0.tag}')), 'fix': {
                    '+': dict([
        ...
        if (u'direction' in keys) or (u'direction' in keys and u'incline' in keys):
            ...
            if match:
                ...
                err.append({'class': 9002001, 'subclass': 1707030473, 'text': mapcss.tr(u'{0} is deprecated', mapcss._tag_uncapture(capture_tags, u'{0.tag}')), 'fix': {
                    '+': dict([
        ...
        if (u'building' in keys):
            match = False
            try: match = match or ((mapcss._tag_capture(capture_tags, 0, tags, u'building') == mapcss._value_capture(capture_tags, 0, u'y')))
            except mapcss.RuleAbort: pass
            try: match = match or ((mapcss._tag_capture(capture_tags, 0, tags, u'building') == mapcss._value_capture(capture_tags, 0, 1)))
            except mapcss.RuleAbort: pass
            if match:
                # group:tr("misspelled value")
                # throwError:tr("{0}","{0.tag}")
                ...
                # fixAdd:"building=yes"
                err.append({'class': 9002018, 'subclass': 58273074, 'text': mapcss.tr(u'{0}', mapcss._tag_uncapture(capture_tags, u'{0.tag}')), 'fix': {
                    '+': dict([
                    [u'building',u'yes']])
                }})
        ...
        if (u'water' in keys):
            match = False
            try: match = match or ((mapcss._tag_capture(capture_tags, 0, tags, u'water') == mapcss._value_capture(capture_tags, 0, u'salt')))
            except mapcss.RuleAbort: pass
            try: match = match or ((mapcss._tag_capture(capture_tags, 0, tags, u'water') == mapcss._value_capture(capture_tags, 0, u'salt_pool')))
            except mapcss.RuleAbort: pass
            try: match = match or ((mapcss._tag_capture(capture_tags, 0, tags, u'water') == mapcss._value_capture(capture_tags, 0, u'salt_panne')))
            except mapcss.RuleAbort: pass
            try: match = match or ((mapcss._tag_capture(capture_tags, 0, tags, u'water') == mapcss._value_capture(capture_tags, 0, u'salt_pond')))
            except mapcss.RuleAbort: pass
            if match:
                # group:tr("deprecated tagging")
                # throwWarning:tr("{0} is deprecated","{0.tag}")
        ...
        if (u'water' in keys):
            match = False
            try: match = match or ((mapcss._tag_capture(capture_tags, 0, tags, u'water') == mapcss._value_capture(capture_tags, 0, u'tidal')))
            except mapcss.RuleAbort: pass
            if match:
                # group:tr("deprecated tagging")
                # throwWarning:tr("{0} is deprecated","{0.tag}")
                ...
                # fixAdd:"tidal=yes"
                # fixRemove:"water"
                err.append({'class': 9002001, 'subclass': 1201030806, 'text': mapcss.tr(u'{0} is deprecated', mapcss._tag_uncapture(capture_tags, u'{0.tag}')), 'fix': {
                    '+': dict([
                    [u'tidal',u'yes']]),
                    '-': ([
                    u'water'])
        ...
        if (u'power' in keys):
            match = False
            try: match = match or ((mapcss._tag_capture(capture_tags, 0, tags, u'power') == mapcss._value_capture(capture_tags, 0, u'busbar')))
            except mapcss.RuleAbort: pass
            if match:
                # group:tr("deprecated tagging")
                # throwWarning:tr("{0} is deprecated","{0.tag}")
                ...
                # fixAdd:"line=busbar"
                # fixAdd:"power=line"
                err.append({'class': 9002001, 'subclass': 2001565557, 'text': mapcss.tr(u'{0} is deprecated', mapcss._tag_uncapture(capture_tags, u'{0.tag}')), 'fix': {
                    '+': dict([
                    [u'line',u'busbar'],
                    [u'power',u'line']])
                }})
    ...
    def relation(self, data, tags, members):
        ...
        if True:
            ...
            try: match = match or ((mapcss._tag_capture(capture_tags, 0, tags, self.re_34c15d62) and not mapcss._tag_capture(capture_tags, 1, tags, u'to')))
            except mapcss.RuleAbort: pass
            if match:
                # throwWarning:tr("uncommon short key")
