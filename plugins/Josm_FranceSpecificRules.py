...
class Josm_FranceSpecificRules(PluginMapCSS):
    ...
    def node(self, data, tags):
        ...
        if ('ref:FR:FANTOIR' in keys) or ('ref:FR:FANTOIR:left' in keys) or ('ref:FR:FANTOIR:right' in keys):
            ...
            if not match:
                capture_tags = {}
                try: match = ((mapcss._tag_capture(capture_tags, 0, tags, 'ref:FR:FANTOIR')) and (not mapcss.regexp_test(mapcss._value_const_capture(capture_tags, 1, self.re_7f0c6b73, '^(((((((0[1-9]|1[0-9]|2A|2B|2[1-9]|[3-8][0-9]|9[0-5])([0-9]{3}))|((971(0[1-9]|[1-3][0-9]))|(972(0[1-9]|[1-3][0-9]))|(973(0[1-9]|[1-6][0-9]))|(974(0[1-9]|[1-2][0-9]))|(976(0[1-9]|1[0-7]))))([0-9]|[A-Z])([0-9]{3}))([ABCDEFGHJKLMNPRSTUVWXYZ]|))(|;(((((0[1-9]|1[0-9]|2A|2B|2[1-9]|[3-8][0-9]|9[0-5])([0-9]{3}))|((971(0[1-9]|[1-3][0-9]))|(972(0[1-9]|[1-3][0-9]))|(973(0[1-9]|[1-6][0-9]))|(974(0[1-9]|[1-2][0-9]))|(976(0[1-9]|1[0-7]))))([0-9]|[A-Z])([0-9]{3}))([ABCDEFGHJKLMNPRSTUVWXYZ]|))+))|no)$'), mapcss._tag_capture(capture_tags, 1, tags, 'ref:FR:FANTOIR'))) and (mapcss.inside(self.father.config.options, 'FR')))
                except mapcss.RuleAbort: pass
            if not match:
                capture_tags = {}
                try: match = ((mapcss._tag_capture(capture_tags, 0, tags, 'ref:FR:FANTOIR:left')) and (not mapcss.regexp_test(mapcss._value_const_capture(capture_tags, 1, self.re_7f0c6b73, '^(((((((0[1-9]|1[0-9]|2A|2B|2[1-9]|[3-8][0-9]|9[0-5])([0-9]{3}))|((971(0[1-9]|[1-3][0-9]))|(972(0[1-9]|[1-3][0-9]))|(973(0[1-9]|[1-6][0-9]))|(974(0[1-9]|[1-2][0-9]))|(976(0[1-9]|1[0-7]))))([0-9]|[A-Z])([0-9]{3}))([ABCDEFGHJKLMNPRSTUVWXYZ]|))(|;(((((0[1-9]|1[0-9]|2A|2B|2[1-9]|[3-8][0-9]|9[0-5])([0-9]{3}))|((971(0[1-9]|[1-3][0-9]))|(972(0[1-9]|[1-3][0-9]))|(973(0[1-9]|[1-6][0-9]))|(974(0[1-9]|[1-2][0-9]))|(976(0[1-9]|1[0-7]))))([0-9]|[A-Z])([0-9]{3}))([ABCDEFGHJKLMNPRSTUVWXYZ]|))+))|no)$'), mapcss._tag_capture(capture_tags, 1, tags, 'ref:FR:FANTOIR:left'))) and (mapcss.inside(self.father.config.options, 'FR')))
                except mapcss.RuleAbort: pass
            if not match:
                capture_tags = {}
                try: match = ((mapcss._tag_capture(capture_tags, 0, tags, 'ref:FR:FANTOIR:right')) and (not mapcss.regexp_test(mapcss._value_const_capture(capture_tags, 1, self.re_7f0c6b73, '^(((((((0[1-9]|1[0-9]|2A|2B|2[1-9]|[3-8][0-9]|9[0-5])([0-9]{3}))|((971(0[1-9]|[1-3][0-9]))|(972(0[1-9]|[1-3][0-9]))|(973(0[1-9]|[1-6][0-9]))|(974(0[1-9]|[1-2][0-9]))|(976(0[1-9]|1[0-7]))))([0-9]|[A-Z])([0-9]{3}))([ABCDEFGHJKLMNPRSTUVWXYZ]|))(|;(((((0[1-9]|1[0-9]|2A|2B|2[1-9]|[3-8][0-9]|9[0-5])([0-9]{3}))|((971(0[1-9]|[1-3][0-9]))|(972(0[1-9]|[1-3][0-9]))|(973(0[1-9]|[1-6][0-9]))|(974(0[1-9]|[1-2][0-9]))|(976(0[1-9]|1[0-7]))))([0-9]|[A-Z])([0-9]{3}))([ABCDEFGHJKLMNPRSTUVWXYZ]|))+))|no)$'), mapcss._tag_capture(capture_tags, 1, tags, 'ref:FR:FANTOIR:right'))) and (mapcss.inside(self.father.config.options, 'FR')))
                except mapcss.RuleAbort: pass
            if match:
    ...
    def way(self, data, tags, nds):
        ...
        if ('ref:FR:FANTOIR' in keys) or ('ref:FR:FANTOIR:left' in keys) or ('ref:FR:FANTOIR:right' in keys):
            ...
            if match:
                ...
                # -osmoseAssertNoMatchWithContext:list("way highway=residential name=impasse ref:FR:FANTOIR:left=no ref:FR:FANTOIR:right=75106S581;67317B012Y","inside=FR")
...
class Test(TestPluginMapcss):
    def test(self):
        ...
        with with_options(n, {'country': 'FR'}):
            self.check_not_err(n.way(data, {'highway': 'residential', 'name': 'impasse', 'ref:FR:FANTOIR:left': 'no', 'ref:FR:FANTOIR:right': '75106S581;67317B012Y'}, [0]), expected={'class': 9019005, 'subclass': 0})
        with with_options(n, {'country': 'FR'}):
