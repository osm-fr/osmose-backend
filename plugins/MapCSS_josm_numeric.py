...
class MapCSS_josm_numeric(Plugin):
    ...
    def init(self, logger):
        ...
        self.errors[9006005] = {'item': 9006, 'level': 3, 'tag': ["tag", "value"], 'desc': mapcss.tr(u'{0}: meters is default; period is separator; if units, put space then unit', capture_tags, u'maxwidth')}
        self.errors[9006006] = {'item': 9006, 'level': 3, 'tag': ["tag", "value"], 'desc': mapcss.tr(u'{0}: tonne is default; period is separator; if units, put space then unit', capture_tags, u'maxweight')}
        self.errors[9006007] = {'item': 9006, 'level': 3, 'tag': ["tag", "value"], 'desc': mapcss.tr(u'{0}: kilometers is default; period is separator; if units, put space then unit', capture_tags, u'distance')}
        ...
        self.errors[9006010] = {'item': 9006, 'level': 3, 'tag': ["tag", "value"], 'desc': mapcss.tr(u'unusual value of {0}', capture_tags, u'{1.key}')}
        ...
        self.errors[9006012] = {'item': 9006, 'level': 3, 'tag': ["tag", "value"], 'desc': mapcss.tr(u'unusual {0} format', capture_tags, u'maxspeed')}
        ...
        self.errors[9006014] = {'item': 9006, 'level': 3, 'tag': ["tag", "value"], 'desc': mapcss.tr(u'unusual {0} specification', capture_tags, u'frequency')}
        self.errors[9006015] = {'item': 9006, 'level': 3, 'tag': ["tag", "value"], 'desc': mapcss.tr(u'unusual train track gauge; use mm with no separator', capture_tags)}
        self.errors[9006016] = {'item': 9006, 'level': 3, 'tag': ["tag", "value"], 'desc': mapcss.tr(u'unusual incline; use percentages/degrees or up/down', capture_tags)}
