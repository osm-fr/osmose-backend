...
class MapCSS_josm_wikipedia(Plugin):
    ...
    def node(self, data, tags, *args):
        ...
        if u'wikipedia' in keys:
            match = False
            try: match = match or ((mapcss._tag_capture(capture_tags, 0, tags, u'wikipedia') and not mapcss.regexp_test_(self.re_07f8e639, mapcss._tag_capture(capture_tags, 1, tags, u'wikipedia'))))
        ...
        if u'wikipedia' in keys:
            match = False
            try: match = match or ((mapcss.regexp_test_(self.re_07f8e639, mapcss._tag_capture(capture_tags, 0, tags, u'wikipedia')) and not mapcss.regexp_test_(self.re_1f90813f, mapcss._tag_capture(capture_tags, 1, tags, u'wikipedia')) and not mapcss.regexp_test_(self.re_6313f817, mapcss._tag_capture(capture_tags, 2, tags, u'wikipedia'))))
            except mapcss.RuleAbort: pass
            if match:
        ...
        if u'wikipedia' in keys:
            match = False
            try: match = match or ((mapcss.regexp_test_(self.re_1f90813f, mapcss._tag_capture(capture_tags, 0, tags, u'wikipedia'))))
            except mapcss.RuleAbort: pass
            try: match = match or ((mapcss.regexp_test_(self.re_091c4afa, mapcss._tag_capture(capture_tags, 0, tags, u'wikipedia'))))
            except mapcss.RuleAbort: pass
            if match:
        ...
        if u'wikipedia' in keys:
            match = False
            try: match = match or ((mapcss.regexp_test_(self.re_53b6f173, mapcss._tag_capture(capture_tags, 0, tags, u'wikipedia'))))
            except mapcss.RuleAbort: pass
            if match:
        ...
        if u'wikipedia' in keys:
            match = False
            try: match = match or ((mapcss.regexp_test_(self.re_034ab801, mapcss._tag_capture(capture_tags, 0, tags, u'wikipedia'))))
            except mapcss.RuleAbort: pass
            if match:
        ...
        if u'wikimedia_commons' in keys:
            match = False
            try: match = match or ((mapcss.regexp_test_(self.re_210c6ccc, mapcss._tag_capture(capture_tags, 0, tags, u'wikimedia_commons'))))
            except mapcss.RuleAbort: pass
            if match:
        ...
        if u'wikipedia' in keys:
            match = False
            try: match = match or ((mapcss.regexp_test_(self.re_19995c46, mapcss._tag_capture(capture_tags, 0, tags, u'wikipedia'))))
            except mapcss.RuleAbort: pass
            if match:
        ...
        if u'wikipedia' in keys:
            match = False
            try: match = match or ((mapcss.regexp_test_(self.re_536e5b67, mapcss._tag_capture(capture_tags, 0, tags, u'wikipedia'))))
            except mapcss.RuleAbort: pass
            if match:
        ...
        if u'wikipedia' in keys:
            match = False
            try: match = match or ((mapcss.regexp_test_(self.re_67c3b565, mapcss._tag_capture(capture_tags, 0, tags, u'wikipedia'))))
            except mapcss.RuleAbort: pass
            if match:
        ...
        if u'wikipedia' in keys:
            match = False
            try: match = match or ((mapcss.regexp_test_(self.re_5940ff7c, mapcss._tag_capture(capture_tags, 0, tags, u'wikipedia')) and not mapcss.regexp_test_(self.re_1ac7f364, mapcss._tag_capture(capture_tags, 1, tags, u'wikipedia')) and not mapcss.regexp_test_(self.re_2d3d5d3d, mapcss._tag_capture(capture_tags, 2, tags, u'wikipedia'))))
            except mapcss.RuleAbort: pass
            if match:
        ...
        if u'wikipedia' in keys:
            match = False
            try: match = match or ((mapcss.regexp_test_(self.re_08b52119, mapcss._tag_capture(capture_tags, 0, tags, u'wikipedia')) and not mapcss.regexp_test_(self.re_2d3d5d3d, mapcss._tag_capture(capture_tags, 1, tags, u'wikipedia'))))
            except mapcss.RuleAbort: pass
            if match:
        ...
        if u'wikipedia' in keys:
            match = False
            try: match = match or ((mapcss.startswith(mapcss._tag_capture(capture_tags, 0, tags, u'wikipedia'), u'da:da:')))
            except mapcss.RuleAbort: pass
            try: match = match or ((mapcss.startswith(mapcss._tag_capture(capture_tags, 0, tags, u'wikipedia'), u'da:dk:')))
            except mapcss.RuleAbort: pass
            try: match = match or ((mapcss.startswith(mapcss._tag_capture(capture_tags, 0, tags, u'wikipedia'), u'de:de:')))
            except mapcss.RuleAbort: pass
            try: match = match or ((mapcss.startswith(mapcss._tag_capture(capture_tags, 0, tags, u'wikipedia'), u'dk:dk:')))
            except mapcss.RuleAbort: pass
            try: match = match or ((mapcss.startswith(mapcss._tag_capture(capture_tags, 0, tags, u'wikipedia'), u'en:de:')))
            except mapcss.RuleAbort: pass
            try: match = match or ((mapcss.startswith(mapcss._tag_capture(capture_tags, 0, tags, u'wikipedia'), u'en:en:')))
            except mapcss.RuleAbort: pass
            try: match = match or ((mapcss.startswith(mapcss._tag_capture(capture_tags, 0, tags, u'wikipedia'), u'en:es:')))
            except mapcss.RuleAbort: pass
            try: match = match or ((mapcss.startswith(mapcss._tag_capture(capture_tags, 0, tags, u'wikipedia'), u'en:eu:')))
            except mapcss.RuleAbort: pass
            try: match = match or ((mapcss.startswith(mapcss._tag_capture(capture_tags, 0, tags, u'wikipedia'), u'en:fr:')))
            except mapcss.RuleAbort: pass
            try: match = match or ((mapcss.startswith(mapcss._tag_capture(capture_tags, 0, tags, u'wikipedia'), u'en:ja:')))
            except mapcss.RuleAbort: pass
            try: match = match or ((mapcss.startswith(mapcss._tag_capture(capture_tags, 0, tags, u'wikipedia'), u'en:pl:')))
            except mapcss.RuleAbort: pass
            try: match = match or ((mapcss.startswith(mapcss._tag_capture(capture_tags, 0, tags, u'wikipedia'), u'en:pt:')))
            except mapcss.RuleAbort: pass
            try: match = match or ((mapcss.startswith(mapcss._tag_capture(capture_tags, 0, tags, u'wikipedia'), u'en:zh:')))
            except mapcss.RuleAbort: pass
            try: match = match or ((mapcss.startswith(mapcss._tag_capture(capture_tags, 0, tags, u'wikipedia'), u'es:es:')))
            except mapcss.RuleAbort: pass
            try: match = match or ((mapcss.startswith(mapcss._tag_capture(capture_tags, 0, tags, u'wikipedia'), u'eu:eu:')))
            except mapcss.RuleAbort: pass
            try: match = match or ((mapcss.startswith(mapcss._tag_capture(capture_tags, 0, tags, u'wikipedia'), u'fr:fr:')))
            except mapcss.RuleAbort: pass
            try: match = match or ((mapcss.startswith(mapcss._tag_capture(capture_tags, 0, tags, u'wikipedia'), u'ja:ja:')))
            except mapcss.RuleAbort: pass
            try: match = match or ((mapcss.startswith(mapcss._tag_capture(capture_tags, 0, tags, u'wikipedia'), u'pl:en:')))
            except mapcss.RuleAbort: pass
            try: match = match or ((mapcss.startswith(mapcss._tag_capture(capture_tags, 0, tags, u'wikipedia'), u'pl:pl:')))
            except mapcss.RuleAbort: pass
            try: match = match or ((mapcss.startswith(mapcss._tag_capture(capture_tags, 0, tags, u'wikipedia'), u'pt:pt:')))
            except mapcss.RuleAbort: pass
            try: match = match or ((mapcss.startswith(mapcss._tag_capture(capture_tags, 0, tags, u'wikipedia'), u'ru:fr:')))
            except mapcss.RuleAbort: pass
            try: match = match or ((mapcss.startswith(mapcss._tag_capture(capture_tags, 0, tags, u'wikipedia'), u'ru:ru:')))
            except mapcss.RuleAbort: pass
            try: match = match or ((mapcss.startswith(mapcss._tag_capture(capture_tags, 0, tags, u'wikipedia'), u'zh:zh:')))
            except mapcss.RuleAbort: pass
            if match:
        ...
        if u'wikidata' in keys:
            match = False
            try: match = match or ((mapcss._tag_capture(capture_tags, 0, tags, u'wikidata') and not mapcss.regexp_test_(self.re_4b567f18, mapcss._tag_capture(capture_tags, 1, tags, u'wikidata'))))
            except mapcss.RuleAbort: pass
            if match:
        ...
        if u'wikipedia' in keys:
            match = False
            try: match = match or ((mapcss._tag_capture(capture_tags, 0, tags, u'wikipedia') and not mapcss._tag_capture(capture_tags, 1, tags, u'wikidata')))
            except mapcss.RuleAbort: pass
            if match:
