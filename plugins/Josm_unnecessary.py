...
class Josm_unnecessary(PluginMapCSS):
    ...
    def init(self, logger):
        ...
        self.re_003d7c7f = re.compile(r'^gpxx:')
    ...
    def node(self, data, tags):
        ...
        # *[name][name=~/^(?i)(chapel|chapelle|kapelle)$/][tag("building")=="chapel"||tag("amenity")=="place_of_worship"]
        # *[name][name=~/^(?i)(silo)$/][man_made!=silo]
        # *[name][name=~/^(?i)(school|école|Школа)$/][amenity!=school]
        ...
        if ('amenity' in keys and 'building' in keys and 'name' in keys) or ('building' in keys and 'name' in keys) or ('name' in keys):
            ...
            if match:
                # group:tr("descriptive name")
                # throwWarning:tr("{0}","{0.tag}")
                err.append({'class': 9010003, 'subclass': 2140357823, 'text': mapcss.tr('{0}', mapcss._tag_uncapture(capture_tags, '{0.tag}'))})
        ...
        if True:
            ...
            if match:
                ...
                err.append({'class': 9010001, 'subclass': 690304391, 'text': mapcss.tr('{0} should not be uploaded', mapcss._tag_uncapture(capture_tags, '{0.key}')), 'allow_fix_override': True, 'fix': {
                    '-': ([
                    mapcss._tag_uncapture(capture_tags, '{0.key}')])
                }})
...
class Test(TestPluginCommon):
    def test(self):
        ...
        self.check_not_err(n.node(data, {'gnis:Class': 'Populated Place', 'place': 'locality'}), expected={'class': 9010001, 'subclass': 1667787383}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.node(data, {'gnis:Class': 'Populated Place', 'place': 'village'}), expected={'class': 9010001, 'subclass': 1667787383}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.node(data, {'amenity': 'parking', 'name': 'Megaparking'}), expected={'class': 9010003, 'subclass': 773913345}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.node(data, {'leisure': 'playground', 'name': 'PLaYGrOUNd'}), expected={'class': 9010003, 'subclass': 773913345}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.node(data, {'amenity': 'parking', 'name': 'Parking'}), expected={'class': 9010003, 'subclass': 773913345}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.node(data, {'amenity': 'parking', 'name': 'Parking_with_suffix'}), expected={'class': 9010003, 'subclass': 773913345}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.node(data, {'amenity': 'parking', 'name': 'parking'}), expected={'class': 9010003, 'subclass': 773913345}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.node(data, {'name': 'shop', 'shop': 'no'}), expected={'class': 9010003, 'subclass': 773913345}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.node(data, {'name': 'shop', 'shop': 'whatever'}), expected={'class': 9010003, 'subclass': 773913345}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.node(data, {'gpx:time': '2018-01-01T12:00:00Z'}), expected={'class': 9010001, 'subclass': 690304391}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.node(data, {'gpxd:color': '#FF0000'}), expected={'class': 9010001, 'subclass': 690304391}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.node(data, {'source': 'gpx:foo'}), expected={'class': 9010001, 'subclass': 690304391}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.way(data, {'bridge': 'no'}, [0]), expected={'class': 9010001, 'subclass': 1306695721}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.way(data, {'access': 'no', 'highway': 'proposed'}, [0]), expected={'class': 9010001, 'subclass': 1306695721}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.way(data, {'layer': '0'}, [0]), expected={'class': 9010001, 'subclass': 1306695721}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.way(data, {'emergency': 'designated'}, [0]), expected={'class': 9010002, 'subclass': 325672362}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.way(data, {'emergency': 'permissive'}, [0]), expected={'class': 9010002, 'subclass': 325672362}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.way(data, {'amenity': 'grave_yard', 'name': 'Cmentarz'}, [0]), expected={'class': 9010003, 'subclass': 773913345}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.way(data, {'building': 'house', 'name': 'Rumah'}, [0]), expected={'class': 9010003, 'subclass': 773913345}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.way(data, {'building': 'yes', 'name': 'Rumah'}, [0]), expected={'class': 9010003, 'subclass': 773913345}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.way(data, {'building': 'silo', 'name': 'Silo'}, [0]), expected={'class': 9010003, 'subclass': 773913345}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.way(data, {'building': 'silo', 'man_made': 'silo', 'name': 'Silo'}, [0]), expected={'class': 9010003, 'subclass': 773913345}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.way(data, {'building': 'house', 'name': 'building'}, [0]), expected={'class': 9010003, 'subclass': 773913345}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.way(data, {'building': 'yes', 'name': 'building'}, [0]), expected={'class': 9010003, 'subclass': 773913345}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.way(data, {'amenity': 'grave_yard', 'name': 'cemetery'}, [0]), expected={'class': 9010003, 'subclass': 773913345}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.way(data, {'building': 'house', 'name': 'house'}, [0]), expected={'class': 9010003, 'subclass': 773913345}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.way(data, {'building': 'yes', 'name': 'house'}, [0]), expected={'class': 9010003, 'subclass': 773913345}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.way(data, {'amenity': 'grave_yard', 'name': 'kiosk'}, [0]), expected={'class': 9010003, 'subclass': 773913345}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.way(data, {'building': 'yes', 'name': 'kiosk', 'shop': 'kiosk'}, [0]), expected={'class': 9010003, 'subclass': 773913345}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.way(data, {'building': 'yes', 'name': 'kiosk'}, [0]), expected={'class': 9010003, 'subclass': 773913345}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.way(data, {'name': 'parking'}, [0]), expected={'class': 9010003, 'subclass': 773913345}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.way(data, {'leisure': 'playground', 'name': 'shop'}, [0]), expected={'class': 9010003, 'subclass': 773913345}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.way(data, {'man_made': 'silo', 'name': 'silo'}, [0]), expected={'class': 9010003, 'subclass': 773913345}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.way(data, {'building': 'house', 'name': 'Rumah'}, [0]), expected={'class': 9010003, 'subclass': 2140357823}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.way(data, {'building': 'yes', 'name': 'Rumah'}, [0]), expected={'class': 9010003, 'subclass': 2140357823}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.way(data, {'building': 'silo', 'name': 'Silo'}, [0]), expected={'class': 9010003, 'subclass': 2140357823}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.way(data, {'building': 'house', 'name': 'building'}, [0]), expected={'class': 9010003, 'subclass': 2140357823}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.way(data, {'building': 'yes', 'name': 'building'}, [0]), expected={'class': 9010003, 'subclass': 2140357823}, disallowed_str_in_text = ['{', '}'])
        self.check_not_err(n.way(data, {'building': 'house', 'name': 'house'}, [0]), expected={'class': 9010003, 'subclass': 2140357823}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.way(data, {'building': 'yes', 'name': 'house'}, [0]), expected={'class': 9010003, 'subclass': 2140357823}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.relation(data, {'leisure': 'playground', 'name': 'PLAYGROUND', 'type': 'multipolygon'}, []), expected={'class': 9010003, 'subclass': 773913345}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.relation(data, {'amenity': 'parking', 'name': 'Parking', 'type': 'multipolygon'}, []), expected={'class': 9010003, 'subclass': 773913345}, disallowed_str_in_text = ['{', '}'])
        self.check_err(n.relation(data, {'amenity': 'parking', 'name': 'parking', 'type': 'multipolygon'}, []), expected={'class': 9010003, 'subclass': 773913345}, disallowed_str_in_text = ['{', '}'])
