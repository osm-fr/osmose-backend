...
class TagRemove_NameIsRef(Plugin):
    ...
    def init(self, logger):
        ...
        self.errors[904] = { "item": 4040, "level": 1, "tag": ["name", "highway", "ref", "fix:chair"], "desc": {"en": u"Highway reference in name tag", "fr": u"Référence d'une route dans le champ name"} }
