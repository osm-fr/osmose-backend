...
class Analyser_Merge_Pharmacy_IT(Analyser_Merge):
    def __init__(self, config, logger = None):
        ...
        self.missing_osm      = self.def_class(item = 7150, id = 12, level = 3, tags = ['merge', 'highway'],
        ...
        self.update_official  = self.def_class(item = 8212, id = 14, level = 3, tags = ['merge', 'highway'],
