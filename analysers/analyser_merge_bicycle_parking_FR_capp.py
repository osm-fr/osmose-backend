...
class Analyser_Merge_Bicycle_Parking_FR_CAPP(Analyser_Merge):
    ...
    def __init__(self, config, logger = None):
        self.missing_official = {"item":"8150", "class": 11, "level": 3, "tag": ["merge", "parking"], "desc": T_(u"CAPP bicycle parking not integrated") }
        self.possible_merge   = {"item":"8151", "class": 13, "level": 3, "tag": ["merge", "parking"], "desc": T_(u"CAPP bicycle parking integration suggestion") }
