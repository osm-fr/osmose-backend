...
class Analyser_Merge_Parapharmacy_IT(Analyser_Merge_Point):
    def __init__(self, config, logger = None):
        ...
        self.def_class_possible_merge(item = 8211, id = 23, level = 3, tags = ['merge', 'amenity', 'fix:picture', 'fix:chair'],
            title = T_('Pharmacy integration suggestion'))
        self.def_class_update_official(item = 8212, id = 24, level = 3, tags = ['merge', 'amenity', 'fix:survey', 'fix:chair'],
