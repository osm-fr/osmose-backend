...
class Analyser_Merge_Parapharmacy_IT(Analyser_Merge):
    def __init__(self, config, logger = None):
        ...
        self.init(
            ...
            CSV(Source(attribution = u'Ministero della Salute', fileUrl = u'http://www.dati.salute.gov.it/imgs/C_17_dataset_7_download_itemDownload0_upFile.CSV'),
            ...
            Mapping(
                ...
                generate = Generate(
                    ...
                    mapping2 = {'operator': lambda res: italian_strings.normalize(res['DENOMINAZIONESITOLOGISTICO'])},
