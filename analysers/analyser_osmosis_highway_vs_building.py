...
class Analyser_Osmosis_Highway_VS_Building(Analyser_Osmosis):
    ...
    def __init__(self, config, logger = None):
        ...
        self.classs_change[1] = {"item":"1070", "level": 2, "tag": ["highway", "building", "geom"], "desc":{"fr": u"Intersection entre une voie et un bâtiment", "en": u"Highway intersecting building", "es": u"Camino intersecta con edificio"} }
        self.classs_change[2] = {"item":"1070", "level": 2, "tag": ["tree", "building", "geom"], "desc":{"fr": u"Intersection entre un arbre et un bâtiment", "en": u"Tree intersecting building", "es": u"Intersección entre un árbol y un edificio"} }
        self.classs_change[3] = {"item":"1070", "level": 2, "tag": ["highway", "tree", "geom"], "desc":{"fr": u"Arbre très proche d'une voie", "en": u"Tree and highway too close", "es": u"Árbol y camino demasiado cerca"} }
        self.classs_change[4] = {"item":"1070", "level": 2, "tag": ["highway", "waterway", "geom"], "desc":{"fr": u"Intersection entre une voie et de l'eau", "en": u"Highway intersecting water", "es": u"Intersección entre camino y vía de agua"} }
