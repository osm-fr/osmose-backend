...
class Analyser_Osmosis_Cycleway_track(Analyser_Osmosis):
    ...
    def __init__(self, config, logger = None):
        ...
        self.classs[1] = {"item":"1180", "level": 2, "tag": ["geom", "highway", "cycleway"], "desc":{"fr": u"Voie cyclable en double, highway=*+cycleway=track en parallèle à highway=cycleway", "en": u"Twice cycle tracks, highway=*+cycleway=track a side of highway=cycleway", "es": u"Carril de bicicletas doble,highway=*+cycleway=track al lado de highway=cycleway"} }
