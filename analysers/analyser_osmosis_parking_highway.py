...
class Analyser_Osmosis_Parking_highway(Analyser_Osmosis):
    ...
    def __init__(self, config, logger = None):
        ...
        self.classs[1] = {"item":"3161", "level": 1, "tag": ["highway", "fix:chair"], "desc": T_(u"Missing access to highway") }
        self.classs[2] = {"item":"3161", "level": 3, "tag": ["highway", "fix:chair"], "desc": T_(u"Missing access to highway") }
