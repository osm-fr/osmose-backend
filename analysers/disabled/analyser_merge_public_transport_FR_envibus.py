...
class Analyser_Merge_Public_Transport_FR_envibus(Analyser_Merge_Point):
    def __init__(self, config, logger = None):
        ...
        self.init(
            ...
            GTFS(Source(attribution = "Communauté d'Agglomération Sophia Antipolis", millesime = "10/2022",
