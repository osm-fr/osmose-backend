...
from .Analyser_Merge import Analyser_Merge_Point, GTFS, Load, Conflate, Select, Mapping, Source


class Analyser_Merge_Public_Transport_FR_rpb(Analyser_Merge_Point):
    def __init__(self, config, logger = None):
        ...
        self.init(
            ...
            GTFS(Source(attribution = "Régie Palm Bus", millesime = "10/2021",
