...
class Analyser_Merge_Sport_FR_Aquitaine_Equestrian(Analyser_Merge_Point):
    def __init__(self, config, logger = None):
        Analyser_Merge_Point.__init__(self, config, logger)
        self.def_class_missing_official(item = 8170, id = 1001, level = 3, tags = ['merge', 'sport', 'fix:survey', 'fix:imagery'],
