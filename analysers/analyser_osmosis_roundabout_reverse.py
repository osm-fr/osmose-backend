...
class Analyser_Osmosis_Roundabout_Reverse(Analyser_Osmosis):
    ...
    def __init__(self, config, logger = None):
        ...
        self.classs_change[1] = {"item":"1050", "level": 1, "tag": ["highway", "roundabout", "fix:chair"], "desc":{"fr": u"Rond-point à l'envers", "en": u"Reverse roundabout", "es": u"Rotonda invertida"} } # FIXME "menu":"rond-point à l'envers", "menu":"reverse roundabout"
