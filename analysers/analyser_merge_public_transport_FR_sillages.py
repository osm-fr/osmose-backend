...
class Analyser_Merge_Public_Transport_FR_sillages(Analyser_Merge):
    ...
    def __init__(self, config, logger = None):
        ...
        self.init(
            ...
            GTFS(Source(attribution = "Communauté d'Agglomération du Pays de Grasse", millesime = "02/2021",
                        fileUrl = "https://trouver.datasud.fr/dataset/763f7e83-0115-4e6a-ab79-f31e129cead9/resource/434177f6-00bf-4360-b4ef-8bf07ed2389d/download/20210101_gtfs_sillagesurbain.zip")),
