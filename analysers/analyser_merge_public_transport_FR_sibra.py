...
class Analyser_Merge_Public_Transport_FR_sibra(Analyser_Merge):
    def __init__(self, config, logger = None):
        ...
        place = "SIBRA"
        self.def_class_missing_official(item = 8040, id = 101, level = 3, tags = ['merge', 'public transport'],
            title = T_('{0} stop not integrated', place))
        self.def_class_possible_merge(item = 8041, id = 103, level = 3, tags = ['merge', 'public transport'],
