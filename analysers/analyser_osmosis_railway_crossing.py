...
class Analyser_Osmosis_Railway_Crossing(Analyser_Osmosis):
    ...
    def __init__(self, config, logger = None):
        ...
        self.classs[1] = {"item":"7090", "level": 2, "tag": ["railway", "highway"], "desc":{"fr": u"Manque de voie au passage à niveau", "en": u"Missing way on crossing", "es": u"Falta de paso a nivel en un cruce"} }
