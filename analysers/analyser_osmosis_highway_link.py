...
class Analyser_Osmosis_Highway_Link(Analyser_Osmosis):
    ...
    def __init__(self, config, logger = None):
        ...
        self.classs[1] = {"item":"1110", "level": 1, "tag": ["highway"], "desc":{"fr": u"Highway *_link non correspondant", "en": u"Bad *_link highway"} }
        self.classs_change[2] = {"item":"1110", "level": 1, "tag": ["highway"], "desc":{"fr": u"Highway trop long pour un *_link", "en": u"Highway too long for a *_link"} }
