...
class Analyser_Osmosis_Duplicated_Geotag(Analyser_Osmosis):
    ...
    def __init__(self, config, logger = None):
        ...
        self.classs[2] = {"item":"1230", "level": 2, "tag": ["geom", "fix:chair"], "desc":{"fr":u"Géométrie dupliqué mais tags différents", "en":"Duplicated geometry but different tags", "es": u"Geometría duplicada pero con tags diferentes"} }
