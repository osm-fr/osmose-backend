...
class Analyser_Osmosis_Useless(Analyser_Osmosis):
    ...
    def __init__(self, config, logger = None):
        ...
        self.classs_change[1] = {"item":"1140", "level": 3, "tag": ["fix:chair"], "desc":{"fr": u"Nœud sans tag ou rôle", "en": u"Missing tag or role on node", "es": u"Falts tag o role en el nodo"} }
        self.classs_change[2] = {"item":"1140", "level": 3, "tag": ["fix:chair"], "desc":{"fr": u"Way sans tag ou rôle", "en": u"Missing tag or role on way", "es": u"Falta tag o rol en la vía"} }
        self.classs_change[3] = {"item":"1140", "level": 3, "tag": ["fix:chair"], "desc":{"fr": u"Relation sans tag ou rôle", "en": u"Missing tag or role on relation", "es": u"Falta tag o rol en la relación"} }
