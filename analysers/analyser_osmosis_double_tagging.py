...
class Analyser_Osmosis_Double_Tagging(Analyser_Osmosis):
    ...
    def __init__(self, config, logger = None):
        ...
        self.classs_change[1] = {"item":"4080", "level": 1, "tag": ["tag", "fix:chair"], "desc":{"fr": u"Objet marqué deux fois comme nœud, way ou relation", "en": u"Object tagged twice as node, way or relation", "es": u"Objeto etiquetado dos veces como nodo, vía o relación"} }
