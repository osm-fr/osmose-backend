...
class Analyser_Osmosis_Geodesie(Analyser_Osmosis):
    ...
    def __init__(self, config, logger = None):
        ...
        self.classs_change[1] = {"item":"7010", "level": 3, "tag": ["building"], "desc":{"fr": u"Repère géodésique sans bâtiment", "en": u"Geodesic mark without building", "es": u"Marca geodésica sin construir"} }
