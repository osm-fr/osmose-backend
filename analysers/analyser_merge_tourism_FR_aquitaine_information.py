        ...
        Analyser_Merge.__init__(self, config, logger,
            ...
            Mapping(
                ...
                generate = Generate(
                    ...
                    mapping2 = {"phone": "TEL"},
                    text = lambda tags, fields: {"en": u', '.join(filter(lambda x: x and x != 'None', [fields["NOMOFFRE"], fields["AD1"], fields["AD1SUITE"], fields["AD2"], fields["AD3"], fields["CP"], fields["COMMUNE"]]))} )))
