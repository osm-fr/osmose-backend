...
class Analyser_Osmosis_Relation_Restriction(Analyser_Osmosis):
    ...
    def __init__(self, config, logger = None):
        ...
        self.classs_change[1] = {"item": 3180, "level": 2, "tag": ["relation", "restriction", "fix:survey"], "desc":{"fr": u"Relation restriction, nombre de membres incorrect", "en": u"Restriction relation, wrong number of members", "es": u"Restricción de relación, número de miembros incorrecto"} }
