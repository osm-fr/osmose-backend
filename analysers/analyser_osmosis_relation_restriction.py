...
class Analyser_Osmosis_Relation_Restriction(Analyser_Osmosis):
    ...
    def __init__(self, config, logger = None):
        ...
        self.classs_change[1] = {"item": 3180, "level": 2, "tag": ["relation", "restriction"], "desc":{"fr": u"Relation restriction, nombre de membres incorrect", "en": u"Restriction relation, number of members incorrect"} }
        self.classs_change[2] = {"item": 3180, "level": 2, "tag": ["relation", "restriction"], "desc":{"fr": u"Relation restriction, membre de mauvais type", "en": u"Restriction relation, Bad member type"} }
        self.classs_change[3] = {"item": 3180, "level": 2, "tag": ["relation", "restriction"], "desc":{"fr": u"Chemin de la relation restriction non connexe", "en": u"Unconnected restriction relation ways"} }
        self.classs_change[4] = {"item": 3180, "level": 2, "tag": ["relation", "restriction"], "desc":{"fr": u"Relation restriction, mauvais sens de sens unique sur le membre from", "en": u"Restriction relation, bad oneway direction on from member"} }
        self.classs_change[5] = {"item": 3180, "level": 2, "tag": ["relation", "restriction"], "desc":{"fr": u"La restriction ne correspond pas à la topologie", "en": u"Restriction doesn't match topology"} }
