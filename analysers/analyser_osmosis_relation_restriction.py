...
class Analyser_Osmosis_Relation_Restriction(Analyser_Osmosis):
    ...
    def __init__(self, config, logger = None):
        ...
        self.classs_change[1] = {"item": 3180, "level": 2, "tag": ["relation", "restriction"], "desc":{"fr": u"Relation restriction, nombre de membres incorrect", "en": u"Restriction relation, number of members incorrect", "es": u"Restricción de relación, número de miembros incorrecto"} }
        self.classs_change[2] = {"item": 3180, "level": 2, "tag": ["relation", "restriction"], "desc":{"fr": u"Relation restriction, membre de mauvais type", "en": u"Restriction relation, Bad member type", "es": u"Restricción de relación, tipo de miembros incorrecto"} }
        self.classs_change[3] = {"item": 3180, "level": 2, "tag": ["relation", "restriction"], "desc":{"fr": u"Chemin de la relation restriction non connexe", "en": u"Unconnected restriction relation ways", "es": u"Vías de restricción de relación inconexas"} }
        self.classs_change[4] = {"item": 3180, "level": 2, "tag": ["relation", "restriction"], "desc":{"fr": u"Relation restriction, mauvais sens de sens unique sur le membre from", "en": u"Restriction relation, bad oneway direction on from member", "es": u"Restricción de relación, dirección en un sentido incorrecta de un miembro"} }
        self.classs_change[5] = {"item": 3180, "level": 2, "tag": ["relation", "restriction"], "desc":{"fr": u"La restriction ne correspond pas à la topologie", "en": u"Restriction doesn't match topology", "es": u"La restricción no concuerda con la tipología"} }
