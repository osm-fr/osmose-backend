...
class Analyser_Osmosis_Relation_Multipolygon(Analyser_Osmosis):
    ...
    def __init__(self, config, logger = None):
        ...
        self.classs_change[1] = {"item":"1170", "level": 3, "tag": ["relation", "geom", "fix:chair"], "desc":{"fr": u"Polygone intérieur doublé", "en": u"Double inner polygon", "es": u"Doble polígono interior"} }
        self.classs_change[2] = {"item":"1170", "level": 2, "tag": ["relation", "multipolygon", "fix:chair"], "desc":{"fr": u"Nature du multipolygon inconsistante avec la nature de ces membres", "en": u"Inconsistant multipolygon nature with members nature", "es": u"Naturaleza de polígono inconsistente con la naturaleza de los miembros"} }
        self.classs_change[3] = {"item":"1170", "level": 2, "tag": ["relation", "multipolygon", "fix:chair"], "desc":{"fr": u"Nature des membres du multipolygon inconsistant", "en": u"Inconsistant multipolygon member nature", "es": u"Naturaleza de los miembros del multipolígono inconsistentes"} }
        self.classs_change[4] = {"item":"1170", "level": 1, "tag": ["relation", "geom", "fix:chair"], "desc":{"fr": u"Devrait être un polygone ou faire partie d'un multipolygon", "en": u"Should be polygon or part of multipolygon", "es": u"Debe ser un polígono o parte de un multipolígono"} }
