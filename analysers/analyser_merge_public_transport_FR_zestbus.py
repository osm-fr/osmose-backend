...
class Analyser_Merge_Public_Transport_FR_zestbus(Analyser_Merge):
    ...
    def __init__(self, config, logger = None):
        ...
        self.init(
            ...
            GTFS(Source(attribution = "Keolis Menton Riviera", millesime = "12/2022",
                        fileUrl = "https://www.data.gouv.fr/fr/datasets/r/72609821-2459-47fb-a63b-3dbbc0d96c92")),
