...
class Analyser_Osmosis_Node_Like_Way(Analyser_Osmosis):
    ...
    def __init__(self, config, logger = None):
        ...
        self.classs_change[1] = {"item":"4090", "level": 1, "tag": ["tag", "fix:chair"], "desc":{"en": u"Way node tagged like way", "es": u"Camino de nodos etiquetados como camino", "fr": u"Nœud de chemin étiqueté comme le chemin"} }
