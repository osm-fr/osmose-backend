...
class Analyser_Merge_Hydrant_Point_CH(Analyser_Merge):
    ...
    def __init__(self, config, logger = None):
        self.missing_official = {"item":"8090", "class": 1, "level": 3, "tag": ["merge", "hydrant"], "desc":{"en":u"Hydrant not integrated", "fr":u"Borne hydrante non intégrée", "es": u"Boca de terminal no integrada"} }
        self.possible_merge   = {"item":"8091", "class": 3, "level": 3, "tag": ["merge", "hydrant"], "desc":{"en":u"Hydrant, integration suggestion", "fr":u"Borne hydrante, proposition d'intégration", "es": u"Boca de terminal, propuesta de integración"} }
