...
class Analyser_Osmosis_Broken_Highway_Level_Continuity(Analyser_Osmosis):
    ...
    def __init__(self, config, logger = None):
        ...
        self.classs[1] = {"item":"1120", "level": 1, "tag": ["highway", "fix:chair"], "desc":{"fr": u"Continuité rompue du niveau de voie", "en": u"Broken highway level continuity", "es": u"Rota la continuidad de nivel de la vía"} }
        self.classs[2] = {"item":"1120", "level": 2, "tag": ["highway", "fix:chair"], "desc":{"fr": u"Continuité rompue du niveau de voie", "en": u"Broken highway level continuity", "es": u"Rota la continuidad de nivel de la vía"} }
        self.classs[3] = {"item":"1120", "level": 2, "tag": ["highway", "fix:chair"], "desc":{"fr": u"Continuité rompue du niveau de voie", "en": u"Broken highway level continuity", "es": u"Rota la continuidad de nivel de la vía"} }
