...
class Analyser_Osmosis_Broken_Highway_Level_Continuity(Analyser_Osmosis):
    ...
    def __init__(self, config, logger = None):
        ...
        self.classs[1] = {"item":"1120", "level": 1, "tag": ["highway"], "desc":{"fr":"Continuité rompue du niveau de voie", "en":"Broken highway level continuity"} }
        self.classs[2] = {"item":"1120", "level": 2, "tag": ["highway"], "desc":{"fr":"Continuité rompue du niveau de voie", "en":"Broken highway level continuity"} }
        self.classs[3] = {"item":"1120", "level": 2, "tag": ["highway"], "desc":{"fr":"Continuité rompue du niveau de voie", "en":"Broken highway level continuity"} }
