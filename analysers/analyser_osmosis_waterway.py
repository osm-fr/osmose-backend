...
class Analyser_Osmosis_Waterway(Analyser_Osmosis):
    ...
    def __init__(self, config, logger = None):
        ...
        self.classs_change[1] = {"item":"1220", "level": 3, "tag": ["waterway", "fix:imagery"], "desc":{"fr": u"Riverbank sans river à l'intérieur", "en": u"Riverbank without river", "es": u"Orilla de río sin río"} }
