...
class SubAnalyser_Merge_Shop_FR(SubAnalyser_Merge_Dynamic):
    def __init__(self, config, error_file, logger, classs, title, selectTags, generateTags):
        ...
        self.missing_osm      = {"item":"7200", "class": classss+2, "level": 3, "tag": ["merge"], "desc": T_(u"%s without ref:FR:SIRET or invalid", title) }
            ...
            Mapping(
                ...
                generate = Generate(
                    ...
                    mapping1 = {
                        ...
                        "short_name": "SIGLE",
                        "start_date": lambda fields: "-".join([fields["DDEBACT"][0:4], fields["DDEBACT"][4:6], fields["DDEBACT"][6:8]])},
