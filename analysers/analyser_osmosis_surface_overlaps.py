...
class Analyser_Osmosis_Surface_Overlaps(Analyser_Osmosis):
    ...
    def __init__(self, config, logger = None):
        ...
        self.classs[1] = {"item":"1150", "level": 3, "tag": ["landuse", "geom", "fix:imagery"], "desc":{"fr": u"Intersection entre surfaces", "en": u"Area intersection", "es": u"Intersección entre superficies"} }
