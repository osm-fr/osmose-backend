...
class Analyser_Osmosis_Boundary_Administrative(Analyser_Osmosis):
    ...
    def __init__(self, config, logger = None):
        ...
        self.classs[100] = {"item":"6070", "level": 3, "tag": ["boundary", "geom"], "desc":{"fr": u"Repère géodésique hors de sa commune"} }
        self.classs[101] = {"item":"6070", "level": 1, "tag": ["boundary", "place"], "desc":{"fr": u"Nœud place hors de sa commune"} }
        self.classs[2] = {"item":"6060", "level": 1, "tag": ["boundary", "geom"], "desc":{"fr": u"Intersection entre commune"} }
        self.classs_change[3] = {"item":"6060", "level": 2, "tag": ["boundary", "geom"], "desc":{"fr": u"Fragment de frontière isolé", "en": u"Boundary bit alone"} }
