...
class Analyser_Osmosis_Boundary_Administrative(Analyser_Osmosis):
    ...
    def __init__(self, config, logger = None):
        ...
        self.classs[101] = {"item":"6070", "level": 1, "tag": ["boundary", "place", "fix:chair"], "desc":{"en": u"Node place out of boundary", "fr": u"Nœud place hors de sa commune", "es": u"Situación de nodo fuera de lo común"} }
        self.classs[2] = {"item":"6060", "level": 1, "tag": ["boundary", "geom", "fix:chair"], "desc":{"en": u"Boundary intersection", "fr": u"Intersection entre commune", "es": u"Intersección común"} }
