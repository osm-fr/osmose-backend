...
class Analyser_Osmosis_Boundary_Administrative(Analyser_Osmosis):
    ...
    def __init__(self, config, logger = None):
        ...
        self.classs[100] = {"item":"6070", "level": 3, "tag": ["boundary", "geom", "fix:chair"], "desc":{"en": u"Survey point out of boundary", "fr": u"Repère géodésique hors de sa commune", "es": u"Señal geodésica fuera de lo común"} }
        self.classs[101] = {"item":"6070", "level": 1, "tag": ["boundary", "place", "fix:chair"], "desc":{"en": u"\"place\" node  out of boundary", "fr": u"Nœud \"place\" hors de sa commune", "es": u"Situación de nodo fuera de lo común"} }
        self.classs[2] = {"item":"6060", "level": 1, "tag": ["boundary", "geom", "fix:chair"], "desc":{"en": u"Boundary intersection", "fr": u"Intersection entre communes", "es": u"Intersección común"} }
        self.classs_change[3] = {"item":"6060", "level": 2, "tag": ["boundary", "geom", "fix:chair"], "desc":{"fr": u"Fragment de frontière isolé", "en": u"Lone boundary fragment", "es": u"Fragmento de frontera aislado"} }
