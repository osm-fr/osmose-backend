...
class Analyser_Osmosis_Tunnel_Bridge(Analyser_Osmosis):
    ...
    def __init__(self, config, logger = None):
        ...
        self.classs_change[1] = {"item": 7012, "level": 3, "tag": ["tag", "highway"], "desc":{"fr": u"Type de pont à qualifier", "en": u"Bridge type", "es": u"Clasificar el tipo de puente"} }
        #self.classs_change[2] = {"item": 7130, "level": 3, "tag": ["tag", "highway", "maxheight"], "desc": {"en": u"Mising maxheight tag", "fr": u"Manque le tag maxheight", "es": u"Tag maxheight ausente"} }
        self.classs_change[3] = {"item": 7130, "level": 3, "tag": ["tag", "highway", "layer"], "desc": {"en": u"Missing layer tag around bridge", "es": u"Falta el tag layer alrededor del puente", "fr": u"Manque le tag layer aux alentours du pont"} }
