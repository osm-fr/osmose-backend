...
class Analyser_Osmosis_Roundabout(Analyser_Osmosis):
    ...
    def __init__(self, config, logger = None):
        ...
        self.classs_change[1] = {"item":"2010", "level": 1, "tag": ["highway", "roundabout", "fix:imagery"], "desc":{"fr": u"Manque junction=roundabout", "en": u"Missing junction=roundabout", "es": u"Falta junction=roundabout"} }
