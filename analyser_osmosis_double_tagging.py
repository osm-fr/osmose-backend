...
class Analyser_Osmosis_Double_Tagging(Analyser_Osmosis):
    ...
    def __init__(self, config, logger = None):
        ...
        self.classs_change[1] = {"item":"4080", "level": 1, "tag": ["tag"], "desc":{"fr":"Objet marqué deux fois comme nœud, way ou relation", "en":"Object tagged twice as node, way or relation"} }
